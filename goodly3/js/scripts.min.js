...
$(document).ready(function(){$(".scroll-link").on("click",function(e){e.preventDefault();var o=$(this).attr("href"),c=$(o).offset().top;$("html, body").animate({scrollTop:c},900)});new Swiper(".recommendations-slider",{slidesPerView:"auto",spaceBetween:14,centeredSlides:!0,initialSlide:3,pagination:{el:".swiper-pagination",clickable:!0}});$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()})});