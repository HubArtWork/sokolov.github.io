...
var galleryThumbs=new Swiper(".mySwiper",{spaceBetween:50,slidesPerView:"auto",direction:"vertical",watchSlidesVisibility:!0,watchSlidesProgress:!0,slideToClickedSlide:!0,loopedSlides:50,loop:!0}),galleryMain=new Swiper(".mySwiper2",{spaceBetween:10,watchSlidesVisibility:!0,watchSlidesProgress:!0,loop:!0,navigation:{nextEl:".advantage .swiper-button-next",prevEl:".advantage .swiper-button-prev"},effect:"fade",fadeEffect:{crossFade:!0},thumbs:{swiper:swiper}});galleryMain.on("slideChangeTransitionStart",function(){galleryThumbs.slideTo(galleryMain.activeIndex)}),galleryThumbs.on("transitionStart",function(){galleryMain.slideTo(galleryThumbs.activeIndex)});var swiper=new Swiper(".action-slider",{slidesPerView:"auto",freeMode:!0,loop:!0,speed:5e3,autoplay:{enabled:!0,delay:1}}),swiper=new Swiper(".articles-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,watchSlidesVisibility:!0}),mainSidebar=new Swiper(".mainSidebar-slider",{slidesPerView:4,direction:"vertical",slideToClickedSlide:!0,spaceBetween:5}),mainProduct=new Swiper(".mainProduct-slider",{spaceBetween:10,thumbs:{swiper:mainSidebar},breakpoints:{10:{slidesPerView:"auto",spaceBetween:36,freeMode:!0},1200:{slidesPerView:1,spaceBetween:10,freeMode:!1}}}),swiper=new Swiper(".certificates-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,spaceBetween:4,navigation:{nextEl:".card-certificates .swiper-button-next",prevEl:".card-certificates .swiper-button-prev"}}),swiper=new Swiper(".gallery-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,spaceBetween:4,navigation:{nextEl:".card-gallery .swiper-button-next",prevEl:".card-gallery .swiper-button-prev"}}),swiper=new Swiper(".main-story__wrapper",{slidesPerView:8,freeMode:!0,watchSlidesVisibility:!0,mousewheel:!0,watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:"auto"},600:{slidesPerView:5},650:{slidesPerView:6},769:{slidesPerView:5},970:{slidesPerView:6},1100:{slidesPerView:8}}}),swiper=new Swiper(".categories-wrapper",{slidesPerView:"auto",freeMode:!0,mousewheel:!0,watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),swiper=new Swiper(".news-slider",{slidesPerView:1,watchOverflow:!0,pagination:{el:".swiper-pagination",clickable:!0}});$(document).ready(function(){$(".header-bar,.header-close").on("click",function(){$(".header").toggleClass("header-active")}),$(".header-link").on("click",function(e){e.preventDefault(),$(this).toggleClass("active").next(".header-mob-list").slideToggle()}),$(".menu-block-wrap").css("max-height",$(".menu-wrap").height()),$(".menu-txt").on("click",function(e){e.preventDefault(),$(".menu").hasClass("active")?($(".menu-list").css("opacity","0"),$(".menu").removeClass("active active-open")):($(".menu-block-wrap").css("max-height",$(".menu-wrap").height()),$(".menu").addClass("active"),$(".menu-list").css("opacity","1"),setTimeout(function(){$(".menu").addClass("active-open")},500))}),$(".menu .search-ico, .header .search-ico, .search-close").on("click",function(e){e.preventDefault(),$(".search").hasClass("active")?($(".search .main-search-row, .search .search-tit ,.search .menu-list").css("opacity","0"),$(".search").removeClass("active"),$(".menu").removeClass("active-search")):($(".search .main-search-row, .search .search-tit ,.search .menu-list").css("opacity","1"),$(".search").addClass("active"),$(".menu").addClass("active-search"))}),$(".catalog-mob").on("click",function(e){e.preventDefault(),$(this).parents(".catalog-top").toggleClass("active")}),$(".catalog-drop-top").on("click",function(e){e.preventDefault(),$(this).parents(".catalog-drop").toggleClass("active")}),$(document).on("click",function(e){var i=$(".catalog-top");i.is(e.target)||0!==i.has(e.target).length||$(".catalog-top").removeClass("active")}),$(document).on("click",function(e){var i=$(".catalog-drop");i.is(e.target)||0!==i.has(e.target).length||$(".catalog-drop").removeClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}})});