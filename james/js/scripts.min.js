...
function menuOpen(e){"click"==e.type&&(header.classList.toggle("header-active"),body.classList.toggle("scroll-hidden"))}if(document.getElementsByClassName("products-slider").length)var swiper=new Swiper(".products-slider",{slidesPerView:"auto",freeMode:!0,spaceBetween:35,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{spaceBetween:15},769:{spaceBetween:35}}});if(document.getElementsByClassName("info-slider").length)var swiper=new Swiper(".info-slider",{slidesPerView:"auto",loop:!0,freeMode:!0,grabCursor:!0,loop:!0,autoplay:{delay:1,disableOnInteraction:!0},freeMode:!0,speed:5e3});if(document.getElementsByClassName("info-slider2").length)var swiper=new Swiper(".info-slider2",{slidesPerView:"auto",loop:!0,freeMode:!0,grabCursor:!0,loop:!0,autoplay:{delay:1,disableOnInteraction:!0,reverseDirection:!0},freeMode:!0,speed:5e3});if(document.getElementsByClassName("recent-slider").length)var swiper=new Swiper(".recent-slider",{slidesPerView:"auto",freeMode:!0,spaceBetween:15,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}});if(document.getElementsByClassName("projects-slider").length)var swiper=new Swiper(".projects-slider",{slidesPerView:"auto",freeMode:!0,spaceBetween:35,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{spaceBetween:15},769:{spaceBetween:35}}});if(document.getElementsByClassName("shop-slider").length)var swiper=new Swiper(".shop-slider",{slidesPerView:1,initialSlide:2,spaceBetween:35,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{spaceBetween:15},769:{spaceBetween:35}}});if(document.getElementsByClassName("shop-products").length)var swiper=new Swiper(".shop-products",{slidesPerView:"auto",freeMode:!0,spaceBetween:35,breakpoints:{10:{spaceBetween:15},769:{spaceBetween:35}}});if(document.getElementsByClassName("music-slider").length)var swiper=new Swiper(".music-slider",{slidesPerView:"auto",freeMode:!0,spaceBetween:35,breakpoints:{10:{spaceBetween:15},769:{spaceBetween:35}}});if(document.getElementsByClassName("mySwiper").length)var swiper=new Swiper(".mySwiper",{spaceBetween:30,slidesPerView:"auto",freeMode:!0,watchSlidesProgress:!0,breakpoints:{10:{spaceBetween:15},769:{spaceBetween:30}}}),swiper2=new Swiper(".mySwiper2",{spaceBetween:10,thumbs:{swiper:swiper}});if(document.getElementsByClassName("header-bar").length){var bar=document.querySelector(".header-bar"),header=document.querySelector(".header"),body=document.querySelector("HTML");bar.addEventListener("click",menuOpen)}if(document.getElementsByClassName("course-accordion").length){var acc=document.getElementsByClassName("course-accordion"),i;for(i=0;i<acc.length;i++)acc[i].onclick=function(){var e=this.nextElementSibling,s=document.getElementsByClassName("course-panel"),t=(document.getElementsByClassName("course-accordion"),document.getElementsByClassName("course-accordion active"));if(e.style.maxHeight)e.style.maxHeight=null,this.classList.remove("active");else{for(var r=0;r<t.length;r++)t[r].classList.remove("active");for(var i=0;i<s.length;i++)this.classList.remove("active"),s[i].style.maxHeight=null;e.style.maxHeight=e.scrollHeight+"px",this.classList.add("active")}}}