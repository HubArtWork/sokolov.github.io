...
var swiper=new Swiper(".main-slider",{slidesPerView:1,watchOverflow:!0,loop:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}}),swiper=new Swiper(".similar-slider",{slidesPerView:4,watchSlidesVisibility:!0,watchOverflow:!0,loop:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},scrollbar:{el:".swiper-scrollbar",hide:!1},breakpoints:{10:{slidesPerView:"auto",watchSlidesVisibility:!1},1401:{slidesPerView:4}}}),swiper=new Swiper(".gallery-slider",{watchOverflow:!0,slidesPerView:"auto",slidesPerColumn:2,loop:!0,scrollbar:{el:".swiper-scrollbar",hide:!1}}),swiper=new Swiper(".testimonials-slider",{slidesPerView:"auto",watchOverflow:!0,pagination:{el:".swiper-pagination",clickable:!0},scrollbar:{el:".swiper-scrollbar",hide:!1}}),swiper=new Swiper(".news-slider",{slidesPerView:3,watchOverflow:!0,watchSlidesVisibility:!0,loop:!0,pagination:{el:".swiper-pagination",clickable:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},scrollbar:{el:".swiper-scrollbar",hide:!1},breakpoints:{10:{slidesPerView:"auto",watchSlidesVisibility:!1,loop:!1},1201:{slidesPerView:3}}});$(document).ready(function(){0!=$("#range-1").length&&$("#range-1").slider({range:!0,min:1900,max:2021,step:1,values:[1950,2021],slide:function(e,a){var i=a.values[0],t=a.values[1];$(this).parents(".fromTo").find(".fromTo-1").val(i),$(this).parents(".fromTo").find(".fromTo-2").val(t)}}),0!=$("#range-2").length&&$("#range-2").slider({range:!0,min:0,max:1e5,step:500,values:[0,1e5],slide:function(e,a){var i=a.values[0],t=a.values[1];$(this).parents(".fromTo").find(".fromTo-1").val(i),$(this).parents(".fromTo").find(".fromTo-2").val(t)}}),$(".catalog-mob,.catalog-bg").on("click",function(){$(".catalog").toggleClass("active")});var e=$(".arrow-top");$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(e).addClass("arrow-active"):$(e).removeClass("arrow-active")}),$(e).on("click",function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(".header-menu, .main-info").on("click","a",function(e){e.preventDefault();var a=$(this).attr("href"),i=$(a).offset().top;$("html, body").animate({scrollTop:i},900),$(".header").removeClass("header-active")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var a=$(e.target).attr("href");$(a).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".select").on("click",function(e){if(!$(this).hasClass("select-hid"))if($(this).hasClass("active")){var a=e.target,i=$(this).find(".select-text"),t=$(this).find(".select-value");"LI"==a.tagName?($(i).text($(a).text()),$(t).val($(a).text())):"A"==a.tagName&&(e.preventDefault(),$(i).html($(a).html()),$(t).val($(a).text())),$(this).removeClass("active")}else $(".select").removeClass("active"),$(this).addClass("active")}),$(document).on("click",function(e){var a=$(".select");a.is(e.target)||0!==a.has(e.target).length||$(".select").removeClass("active")}),$(".input-tel").mask("+7 (999) 999-99-99"),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}}),$(document).mouseleave(function(){$("#modal-trigger").fancybox().trigger("click")})});