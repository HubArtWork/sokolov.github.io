...
AOS.init(),AOS.refresh(),0!=$("#main-text").length&&new TypeIt("#main-text",{strings:"управления производством",speed:140,waitUntilVisible:!0}).delete(24).type("управления бизнесом").go();var swiper1=new Swiper(".cost-slider",{slidesPerView:3,watchSlidesVisibility:!0,allowTouchMove:!1,pagination:{el:".cost .swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1,autoHeight:!0},600:{slidesPerView:1},700:{slidesPerView:2},768:{slidesPerView:2,autoHeight:!1},1100:{slidesPerView:3}}});$(window).innerWidth()<768&&swiper1.destroy(!0,!0);var swiper=new Swiper(".testimonials-slider",{slidesPerView:3,watchSlidesVisibility:!0,pagination:{el:".testimonials .swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1,autoHeight:!0},600:{slidesPerView:1},650:{slidesPerView:2},768:{slidesPerView:2,autoHeight:!1},1100:{slidesPerView:3}}});if(0!=$("#scene").length)var scene=document.getElementById("scene"),parallax=new Parallax(scene);$(document).ready(function(){function e(e){e+="",x=e.split("."),x1=x[0],x2=x.length>1?"."+x[1]:"";for(var t=/(\d+)(\d{3})/;t.test(x1);)x1=x1.replace(t,"$1 $2");return x1+x2}function t(){var t=0;$(".cost-first .checkbox input").is(":checked")&&(t=parseInt($("#costSubPCC").text()));var a=parseInt($("#numberOfUsers").text()),i=parseInt($("#numberOfMonths").text()),n=parseInt($("#costSubFix").text()),s=parseInt($("#costSubUser").text()),o=Math.floor(((s*a+t)*i+n)/i);$(".cost-first .cost-num").html(e(o)+" ₽<br> в месяц")}function a(){var t=0;$(".cost-second .checkbox input").is(":checked")&&(t=parseInt($("#costEntPCC").text()));var a=parseInt($("#numberOfUsers2").text()),i=parseInt($("#costEntFix").text()),n=parseInt($("#costEntUser").text()),s=Math.floor(i+n*a+t);$(".cost-second .cost-num").html(e(s)+" ₽")}window.addEventListener("load",AOS.refresh),setTimeout(function(){0!=$("video").length&&($("video").get(0).play(),$("video").length>2&&($("video").get(1).play(),$("video").get(2).play()))},1e3),$(window).on("scroll",function(){$(".header").removeClass("header-active"),$(window).scrollTop()>2?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed")}),$(".pagePagination").on("click","a",function(e){e.preventDefault();var t=$(this).attr("href"),a=$(t).offset().top;$("html, body").animate({scrollTop:a-$(".header").outerHeight()},900)}),$("*").is(".pagePagination")&&$(window).scroll(function(){$(".section-scroll").each(function(e,t){var a=$(t).offset().top-100,i=a+$(t).height(),n=$(window).scrollTop(),s=$(t).attr("id");n>a&&n<i&&($(".pagePagination li a.active").removeClass("active"),$('.pagePagination li a[href="#'+s+'"]').addClass("active"),"about"==s||"advantages"==s||"functionality"==s||"personalAccount"==s||"testimonials"==s?$(".pagePagination").addClass("pagePagination-dark"):$(".pagePagination").removeClass("pagePagination-dark"))})}),$(".header-bar, .header-link").on("click",function(e){e.preventDefault(),$(".header").toggleClass("header-active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(e.target).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".accordeon-active").find(".accordeon-block").slideDown(),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}}),$(".cost-slide .primary-btn, .cost-slide .second-btn").on("click",function(){var e=$(this).parents(".cost-wrap").find(".cost-title").text();$("#modal-input").val(e),console.log($("#modal-input").val())}),0!=$("#range-1").length&&$("#range-1").slider({min:3,max:30,step:1,value:6,range:"min",slide:function(e,a){var i=a.value;$(this).parents(".cost-range").find(".cost-range__num").text(i),t()}}),0!=$("#range-2").length&&$("#range-2").slider({min:12,max:60,step:12,value:12,range:"min",slide:function(e,a){var i=a.value;$(this).parents(".cost-range").find(".cost-range__num").text(i),t()}}),0!=$("#range-3").length&&$("#range-3").slider({min:6,max:60,step:1,value:12,range:"min",slide:function(e,t){var i=t.value;$(this).parents(".cost-range").find(".cost-range__num").text(i),a()}}),$(".cost-first .checkbox input").change(function(){t()}),$(".cost-second .checkbox input").change(function(){a()}),$(".cookie .primary-btn").on("click",function(e){e.preventDefault(),$(".cookie").remove()}),$(".tariffs-mob li a").on("click",function(e){e.preventDefault();var t=$(this).attr("data-tariffs");$(".tariffs").removeClass("tariffs1 tariffs2 tariffs3").addClass(t)}),$(".drop").on("click",function(e){if(e.preventDefault(),$(this).hasClass("active")){var t=e.target,a=$(this).find(".drop-top"),i=$(this).parents(".input-block__wrap").find("input");if("IMG"==t.tagName||"I"==t.tagName||"SPAN"==t.tagName){var n=parseInt($(t).parents("li").find("span").text(),10);$(a).html($(t).parents("li").find("b").html()),$(i).val("+"+n).focus(),$(t).parents("ul").find("li").removeClass("active"),$(t).parents("li").addClass("active")}$(this).removeClass("active")}else $(".drop").removeClass("active"),$(this).addClass("active")}),$(document).on("click",function(e){var t=$(".drop");t.is(e.target)||0!==t.has(e.target).length||$(".drop").removeClass("active")})});