...
var swiper=new Swiper(".products-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:25,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),swiper=new Swiper(".specialists-slider",{slidesPerView:5,freeMode:!1,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:30,navigation:{nextEl:".specialists-all .swiper-button-next",prevEl:".specialists-all .swiper-button-prev"},breakpoints:{10:{spaceBetween:15,slidesPerView:"auto",freeMode:!0},769:{spaceBetween:25,slidesPerView:3,freeMode:!1},980:{spaceBetween:25,slidesPerView:4,freeMode:!1},1261:{spaceBetween:30,slidesPerView:5,freeMode:!1}}}),swiper=new Swiper(".prospects-slider",{slidesPerView:3,freeMode:!1,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:30,navigation:{nextEl:".prospects-all .swiper-button-next",prevEl:".prospects-all .swiper-button-prev"},breakpoints:{10:{spaceBetween:15,slidesPerView:"auto",freeMode:!0},769:{spaceBetween:25,slidesPerView:2,freeMode:!1},1261:{spaceBetween:30,slidesPerView:3,freeMode:!1}}}),swiper=new Swiper(".testimonials-slider",{slidesPerView:"auto",freeMode:!1,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:50,centeredSlides:!0,loop:!0,breakpoints:{10:{spaceBetween:15,freeMode:!0},769:{spaceBetween:30,freeMode:!1},1461:{spaceBetween:50}}});$(document).ready(function(){$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".drop-top").on("click",function(e){e.preventDefault(),$(window).outerWidth()<769&&$(this).parents(".drop").toggleClass("active").find(".drop-list").slideToggle()}),$(window).on("scroll",function(){$(this).scrollTop()>400?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed")}),$(".services-item-main").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active");var i=$(e.target).attr("href");$(this).addClass("active"),$(window).outerWidth()<769?($(this).parents(".allTabs").find(".tab").slideUp(),$(i).slideDown("tab-active")):($(this).parents(".allTabs").find(".tab").removeClass("tab-active"),$(i).addClass("tab-active"))})});