...
$(document).ready(function(){if($("#bgvid").bind("ended",function(){this.play()}),setTimeout(function(){$(".about-img-arrow,.services-ico-1-2,services-ico-1-3,services-ico-1-4").css("animation-play-state","running")},100),$(window).width()<769)var e=new Swiper(".services-slider",{slidesPerView:1,watchOverflow:!0,spaceBetween:15,autoHeight:!0,pagination:{el:".swiper-pagination",clickable:!0}});$(window).on("scroll",function(){$(this).scrollTop()>0?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed")}),$(".header-list li a, .scroll-btn,.footer-col ul li a").on("click",function(a){a.preventDefault();var t=$(this).attr("href"),i=$(t).offset().top-$(".header").outerHeight();if($("html, body").animate({scrollTop:i},900),$(".header").removeClass("header-active"),"#services"==t){var s=$(this).attr("data-tab");$(".tab-list").find("a").removeClass("active"),$(".allTabs").find(".tab").removeClass("tab-active"),$("#tab-"+s).addClass("tab-active"),$(".tab-"+s).addClass("active"),$(window).width()<769&&e.slideTo(s-1)}}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".more").on("click",function(e){e.preventDefault(),$(".countries").toggleClass("active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var a=$(e.target).attr("href");$(a).addClass("tab-active"),$(this).addClass("active")}),$(".header-lang").on("click",function(e){$(this).toggleClass("active")}),$(document).on("click",function(e){var a=$(".header-lang");a.is(e.target)||0!==a.has(e.target).length||$(".header-lang").removeClass("active")})});