...
$(function(){}),$(document).ready(function(){setTimeout(function(){AOS.init()},600),window.addEventListener("load",AOS.refresh),$(".main-slider,.payment-slider").slick({infinite:!0,arrows:!0,dots:!1,fade:!0,nextArrow:'<button class="slick-arrow slick-next"><svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#owm32)"><path d="M10.8333 19.5L16.9502 13.3831C17.1618 13.1715 17.1618 12.8285 16.9502 12.6169L10.8333 6.5" stroke="white" stroke-width="2" stroke-linecap="round"/></g><defs><clipPath id="owm32"><rect width="26" height="26" fill="white" transform="matrix(4.37114e-08 1 1 -4.37114e-08 0 0)"/></clipPath></defs></svg></button>',prevArrow:'<button class="slick-arrow slick-prev"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.5 13.5L6.2652 9.2652C6.11872 9.11872 6.11872 8.88128 6.2652 8.7348L10.5 4.5" stroke="white" stroke-width="2" stroke-linecap="round"/></svg></button>',slidesToShow:1,slidesToScroll:1,autoplay:!1,autoplaySpeed:1e4,speed:300,swipe:!1,responsive:[{breakpoint:768,settings:{adaptiveHeight:!0}}]}),$(".main-slider").on("init",function(e,t){AOS.init()}),$(".main-slider").on("afterChange",function(e,a,i,s){$(".main-slide__3").hasClass("slick-active")&&setTimeout(function(){t.animate(.68)},200)}),$(".status").length&&setTimeout(function(){t.animate(.68)},200),$(window).width()<=768&&$("html,body").css("min-height",$(window).height()+"px"),$(window).resize(function(){$(window).width()<=768&&$("html,body").css("min-height",$(window).height()+"px")}),$(".main-social__wrap").on("click",function(e){$(window).width()<=768&&($(this).hasClass("active")?$(".main-social__wrap").removeClass("active"):($(".main-social__wrap").removeClass("active"),$(this).addClass("active")))}),$(".main-social__wrap").hover(function(){$(window).width()>=768&&$(this).addClass("active")},function(){$(window).width()>=768&&$(this).removeClass("active")}),$(".scrollbar-outer, .networks-main__wrap,.main-social__info-wrap").scrollbar(),$(window).width()<=768&&$(".main-row").scrollbar(),$(".select").on("click",function(e){if($(this).hasClass("active")){var t=e.target,a=$(this).find(".select-text"),i=$(this).find(".select-value");"LI"==t.tagName?($(a).text($(t).text()),$(i).val($(t).text())):"A"==t.tagName&&($(a).html($(t).html()),$(i).val($(t).text())),$(this).removeClass("active")}else $(".select").removeClass("active"),$(this).addClass("active")}),$(document).on("click",function(e){var t=$(".select");t.is(e.target)||0!==t.has(e.target).length||$(".select").removeClass("active")});var e=$(".arrow-top");if($(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(e).addClass("arrow-active"):$(e).removeClass("arrow-active")}),$(e).on("click",function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(".header-menu, .main-info").on("click","a",function(e){e.preventDefault();var t=$(this).attr("href"),a=$(t).offset().top;$("html, body").animate({scrollTop:a},900),$(".header").removeClass("header-active")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(".tab-list li a").removeClass("active"),$(".tab").removeClass("tab-active");var t=$(this).attr("href");$(t).addClass("tab-active"),$(this).addClass("active"),$(this).parents(".service-wrap").addClass("service-active")}),$(".service-tabs li a").on("click",function(e){e.preventDefault(),$(".service-tabs li a").removeClass("active"),$(".service-col").removeClass("tab-active");var t=$(this).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".service-back").on("click",function(){$(this).parents(".service-wrap").removeClass("service-active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".payment-accordeon.accordeon-active").find(".payment-accordeon__block").slideDown(),$(".payment-accordeon__top").on("click",function(){$(this).parents(".payment-accordeon").hasClass("accordeon-active")?$(this).parents(".payment-accordeon__parents").find(".payment-accordeon").removeClass("accordeon-active").find(".payment-accordeon__block").slideUp():($(this).parents(".payment-accordeon__parents").find(".payment-accordeon").removeClass("accordeon-active").find(".payment-accordeon__block").slideUp(),$(this).parents(".payment-accordeon").addClass("accordeon-active").find(".payment-accordeon__block").slideDown())}),$("#statistics").length){var t=new ProgressBar.SemiCircle(statistics,{color:"#aaa",strokeWidth:4,trailWidth:4,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#EAEAEA",width:4},to:{color:"#2945FF",width:4},step:function(e,t){t.path.setAttribute("stroke",e.color),t.path.setAttribute("stroke-width",e.width);var a=Math.round(100*t.value());0===a?t.setText(""):t.setText(a+"<span>%</span>")}});t.text.style.fontFamily='"Gilroy", Helvetica, sans-serif'}if($(".main-social").scroll(function(){console.log($(".main-social").scrollLeft())}),$("#slider1").length){var a=$(".main-social").children().length,i=$(".main-social .main-social__col").width()+1,s=$(".main-social").width(),o=i*a-s;noUiSlider.create(slider1,{start:0,step:200,animate:!0,connect:"lower",range:{min:0,max:o},decimals:0}),slider1.noUiSlider.on("slide",function(e,t){$(".main-social").animate({scrollLeft:e},100)})}$(".main-social").scrollbar({onScroll:function(e,t){slider1.noUiSlider.set(t.scroll)}})});