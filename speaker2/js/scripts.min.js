...
$(document).ready(function(){new Swiper(".testimonials-slider",{slidesPerView:1,watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),new Swiper(".speaker-slider",{slidesPerView:1,watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}})});