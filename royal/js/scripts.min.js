...
var swiper=new Swiper(".gallery-slider",{slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:30,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{spaceBetween:20},1121:{spaceBetween:30}}});$(document).ready(function(){if($(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".drop-text").on("click",function(e){e.preventDefault(),$(window).width()<=920&&$(this).toggleClass("open").parents(".drop").find(".drop-info").slideToggle()}),$(".header-cart__btn, .header-basket .close-dark-ico").on("click",function(){$(".header-basket").toggleClass("active")}),$(document).on("click",function(e){var t=$(".header-cart");(!t.is(e.target)&&0===t.has(e.target).length||$(".close-dark-ico").is(e.target))&&$(".header-basket").removeClass("active")}),$(".scrollbar-outer").scrollbar(),$(".order .primary-btn").on("click",function(){$(".order").toggleClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$("*").is(".basket")){w=$(window).width();var e=$(".basket-sidebar"),t=$(e).offset().top-20,r=$("body").outerHeight()-($(e).outerHeight()+70+$(".header").outerHeight()+$(".footer").outerHeight());$(window).width()<=700&&(t=232),$(window).on("scroll",function(){$(window).scrollTop()+$(".header").outerHeight()>=t?$(window).scrollTop()>=r?$(e).removeClass("sidebar-fixed").addClass("sidebar-absolute").css({right:"0",top:0}):$(e).addClass("sidebar-fixed").removeClass("sidebar-absolute").css({right:($(window).innerWidth()-$(".basket .wrapper").innerWidth())/2+($(".basket .wrapper").innerWidth()-$(".basket .wrapper").width())/2+"px",top:$(".header").outerHeight()+20}):$(e).removeClass("sidebar-fixed").removeClass("sidebar-absolute").css({right:"0",top:0})})}});