...
$(document).ready(function(){function e(){$(".card-top").css("padding-top",$(".card-main").height())}function e(){$(".modal-card .card-top").css("padding-top",$(".modal-card .card-main").height())}var t=(new Swiper(".main-slider",{slidesPerView:1,watchOverflow:!0,loop:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),new Swiper(".hits-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:46,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{0:{spaceBetween:18},769:{spaceBetween:46}}}),new Swiper(".products-slider",{slidesPerView:"auto",watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{0:{spaceBetween:30},769:{spaceBetween:0}}}),new Swiper(".products-slider2",{slidesPerView:"auto",watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{0:{slidesPerView:2,spaceBetween:10},381:{slidesPerView:2,spaceBetween:30},769:{slidesPerView:"auto",spaceBetween:0}}}),new Swiper(".blog-slider",{slidesPerView:2,watchOverflow:!0,spaceBetween:32,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{0:{slidesPerView:1},1101:{slidesPerView:2}}}),new Swiper(".mySwiper",{direction:"vertical",spaceBetween:10,slidesPerView:2,watchSlidesProgress:!0})),a=new Swiper(".mySwiper2",{spaceBetween:10,thumbs:{swiper:t},pagination:{el:".swiper-pagination",clickable:!0}});a.on("slideChangeTransitionStart",function(){t.slideTo(a.activeIndex)}),t.on("transitionStart",function(){a.slideTo(t.activeIndex)}),$(".search-drop-top").on("click",function(e){e.preventDefault(),$(this).parents(".search-drop").toggleClass("active")}),$(".header-button").on("click",function(e){e.preventDefault(),$(this).toggleClass("active"),$(".header-catalog").toggleClass("active")}),$(".header-catalog-btn").on("click",function(e){e.preventDefault(),$(this).parents(".header-catalog-more").toggleClass("active").find("ul").slideToggle()}),$(".header-bar,.menu-top .close-ico, .menu-bg").on("click",function(){$(".menu,.menu-bg").toggleClass("active")}),$(".search-wrap input").focus(function(){$(".search-wrap").addClass("active")}),$(".search-wrap input").blur(function(){$(".search-wrap").removeClass("active")}),$(".link-catalog,.link-delivery").on("click",function(e){e.preventDefault(),$(this).hasClass("link-catalog")?($(".menu-main").addClass("close"),$(".menu-catalog").addClass("active")):$(this).hasClass("link-delivery")&&($(".menu-main").addClass("close"),$(".menu-delivery").addClass("active"))}),$(".menu .back").on("click",function(e){e.preventDefault(),$(".menu-main").removeClass("close"),$(".menu-catalog,.menu-delivery").removeClass("active")}),$(".catalog-block-top").on("click",function(){$(this).parents(".catalog-block").toggleClass("active")}),$(".filter-ico,.catalog-bg").on("click",function(){$(".catalog-sidebar,.catalog-bg").toggleClass("active")}),$(".card-tit").on("click",function(){$(this).toggleClass("active").parents(".tab").find(".card-drop").slideToggle()}),$(".card").length&&($(window).outerWidth()<941&&e(),$(window).on("resize",function(){$(window).outerWidth()<941&&e()})),$(".modal-card").length&&($(window).on("resize",function(){$(window).outerWidth()<941&&e()}),$.fancybox.defaults.afterShow=function(){$(".modal-card").length&&(t.update(),a.update(),$(window).outerWidth()<941&&e())}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(e.target).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".modal-drop-top").on("click",function(){$(this).parents(".modal-drop").toggleClass("active")}),$(".modal-item-l").on("click",function(){$(this).parents(".modal-item").next().slideToggle()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}})});