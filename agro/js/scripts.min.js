...
AOS.init({startEvent:"load"}),$(document).ready(function(){window.addEventListener("load",AOS.refresh),setTimeout(function(){$(".main").addClass("main-done")},1e3),$(window).on("scroll",function(){$(this).scrollTop()>200?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed")}),$(".header").length&&$(".header-list li a, .header-logo a").each(function(){$(this).on("click",function(){var e=$(this).attr("href");$(this).hasClass("scroll-link")&&$(this).hasClass("link-to")||$(this).is("[target]")||$(location).attr("href",e)})}),$(".link-scroll").on("click",function(e){e.preventDefault();var t=$(this).attr("href"),a=$(t).offset().top;$("html, body").animate({scrollTop:a-$(".header").outerHeight()},900)}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}})});