...
$(document).ready(function(){var e=(new Swiper(".about-slider",{slidesPerView:3,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:30,breakpoints:{10:{slidesPerView:"auto",spaceBetween:20},1061:{slidesPerView:2,spaceBetween:20},1461:{slidesPerView:3}}}),new Swiper(".steps-slider",{slidesPerView:"auto",watchSlidesVisibility:!0,watchOverflow:!0,centeredSlides:!0,roundLengths:!0,loop:!0,spaceBetween:0,breakpoints:{10:{slidesPerView:"auto",spaceBetween:10,centeredSlides:!1,loop:!1},561:{slidesPerView:"auto",spaceBetween:0,centeredSlides:!0,loop:!0}}}),new Swiper(".payment-slider",{speed:500,effect:"fade",loop:!1,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},on:{slideChange:function(e){$(".payment-item").removeClass("active"),$(".payment-item-"+e.activeIndex).addClass("active")}},breakpoints:{10:{loop:!0},1061:{loop:!1}}}));$(".payment-item").on("click",function(t){t.preventDefault();var o=$(this).attr("data-slide");$(".payment-item").removeClass("active"),$(this).addClass("active"),e.slideTo(parseInt(o))}),$(".header-menu").on("click","a",function(e){e.preventDefault();var t=$(this).attr("href"),o=$(t).offset().top;$("html, body").animate({scrollTop:o},900),$(".header").removeClass("header-active"),$(".header-bar").removeClass("active"),$("html,body").removeClass("scroll-hidden")}),$(".header-bar").on("click",function(){$("html,body").toggleClass("scroll-hidden"),$(this).toggleClass("active"),$(".header").toggleClass("header-active")});var t=document.querySelector(".main-top"),o=document.querySelector(".main-phone"),s=document.querySelector(".main-line"),i=document.querySelector(".main-price-1"),l=document.querySelector(".main-price-2"),a=document.querySelector(".main-card"),r=document.querySelector(".main-qr"),n=document.querySelector(".main-block"),p=document.querySelector(".main-phone-mob"),c=document.querySelector(".main-card-mob"),d=document.querySelector(".main-qr-mob");$(window).on("scroll",function(){$(window).outerWidth()>=1060&&$(this).scrollTop()>$(".main").height()-124-$(".header").outerHeight()?$(".header").addClass("header-fix").css("top",$(".main").height()-124-$(".header").outerHeight()+"px"):$(".header").removeClass("header-fix").css("top","0px");var e=$(this).scrollTop();t.style.top=184+1.1*e+"px",t.style.opacity=1+-5e-4*e,o.style.bottom=-.6*e+"px",s.style.bottom=244+-.6*e+"px",s.style.opacity=1+-8e-4*e,i.style.top=667+.75*e+"px",i.style.opacity=1+-8e-4*e,l.style.top=380+.75*e+"px",l.style.opacity=1+-8e-4*e,a.style.top=565+1.17*e+"px",a.style.scale=1+15e-5*e,r.style.top=771+.9*e+"px",r.style.rotate=.02*e+"deg",r.style.scale=1+-2e-4*e,n.style.top=498+.5*e+"px",window.innerWidth<=1460&&(t.style.top=320+1.1*e+"px",o.style.bottom=-.6*e+"px",s.style.bottom=244+-.6*e+"px",i.style.top=646+.75*e+"px",l.style.top=515+.75*e+"px",a.style.top=665+1.17*e+"px",r.style.top=871+.9*e+"px",n.style.top=598+.5*e+"px"),window.innerWidth<=768&&(t.style.top=56+1.1*e+"px",p.style.bottom=25+-.6*e+"px",c.style.bottom=45+-1.17*e+"px",d.style.bottom=244+-.9*e+"px")})});