...
AOS.init({startEvent:"load"}),AOS.refresh(),$(document).ready(function(){window.addEventListener("load",AOS.refresh);new Swiper(".main-slider",{slidesPerView:"auto",loop:!0,freeMode:!0,grabCursor:!0,loop:!0,spaceBetween:40,slidesPerViewFit:!1,roundLengths:"false",autoplay:{delay:1,disableOnInteraction:!0},freeMode:!0,speed:1e4}),new Swiper(".products-slider",{slidesPerView:"auto",initialSlide:2,centeredSlides:!0,pagination:{el:".swiper-pagination",clickable:!0}}),new Swiper(".blog-slider",{loop:!0,slidesPerView:"auto",initialSlide:2,freeMode:!0,watchOverflow:!0,spaceBetween:20,centeredSlides:!0});$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")})});