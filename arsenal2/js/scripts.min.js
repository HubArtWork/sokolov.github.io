...
function loadAfterTime(){var e=new Swiper(".main-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,noSwiping:!0,allowTouchMove:!1,speed:1e3,pagination:{el:".swiper-pagination",clickable:!0},autoplay:{delay:5e3,disableOnInteraction:!0},effect:"fade",fadeEffect:{crossFade:!1},breakpoints:{10:{noSwiping:!1,allowTouchMove:!0},769:{noSwiping:!0,allowTouchMove:!1}}});e.el.addEventListener("mouseenter",function(t){e.autoplay.stop()},!1),e.el.addEventListener("mouseleave",function(t){e.autoplay.start()},!1);var t=document.querySelector("#main-name-1"),n=document.querySelector("#main-name-2"),a=document.querySelector("#main-name-3");t.addEventListener("click",function(t){"click"==t.type&&e.slideNext()}),n.addEventListener("click",function(t){"click"==t.type&&e.slideNext()}),a.addEventListener("click",function(t){"click"==t.type&&e.slideTo(0,0)})}function menuOpen(e){"click"==e.type&&header.classList.toggle("header-active")}setTimeout(loadAfterTime,1900);var bar=document.querySelector(".header-bar"),header=document.querySelector("body");bar.addEventListener("click",menuOpen);var allPanels=document.querySelectorAll(".header-menu ul");document.querySelector(".header-menu").addEventListener("click",function(e){if(window.innerWidth<721&&e.target.classList.contains("header-subtitle")){e.target.parentNode.classList.contains("active")?allPanels.forEach(function(e){"none"!==e.style.display&&e!==t&&e.parentNode.classList.remove("active")}):(allPanels.forEach(function(e){"none"!==e.style.display&&e!==t&&e.parentNode.classList.remove("active")}),e.target.parentNode.classList.add("active"));var t=e.target.nextElementSibling;slideToggle(t,200),allPanels.forEach(function(e){"none"!==e.style.display&&e!==t&&slideUp(e,200)})}});