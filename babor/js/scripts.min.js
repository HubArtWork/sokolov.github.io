...
var swiper=new Swiper(".header-slider",{slidesPerView:1,loop:!0,loopFillGroupWithBlank:!0,autoplay:{delay:5e3}}),swiper=new Swiper(".main-slider",{slidesPerView:1,navigation:{nextEl:".main .swiper-button-next",prevEl:".main .swiper-button-prev"},pagination:{el:".main .swiper-pagination",clickable:!0}}),swiper=new Swiper(".products-slider",{slidesPerView:4,pagination:{el:".products .swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},768:{slidesPerView:2},1200:{slidesPerView:4}}}),swiper=new Swiper(".products-swiper",{slidesPerView:2,pagination:{el:".products .swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},768:{slidesPerView:2}}}),swiper=new Swiper(".categories-wrapper",{slidesPerView:"auto",freeMode:!0,mousewheel:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),swiper=new Swiper(".news-slider",{slidesPerView:1,pagination:{el:".swiper-pagination",clickable:!0}});$(document).ready(function(){$(".header-bar, .mobileMenu-top .close-ico").on("click",function(){$(".mobileMenu").toggleClass("open")}),$(".mobileMenu-item .icon-accordeon").on("click",function(){$(this).parents(".mobileMenu-item").toggleClass("active").find(".mobileMenu-item__drop").slideToggle()}),$(".filter-drop__top").on("click",function(e){e.preventDefault(),$(window).width()<=768?$(this).parents(".filter-drop").toggleClass("active").find(".filter-drop__info").slideToggle():$(this).parents(".filter-drop").hasClass("active")?$(".filter-drop").removeClass("active"):($(".filter-drop").removeClass("active"),$(this).parents(".filter-drop").addClass("active"))}),$(document).on("click",function(e){var i=$(".filter-drop");i.is(e.target)||0!==i.has(e.target).length||$(".filter-drop").removeClass("active")}),$(".filter-mob, .filter-top .hb-ico").on("click",function(e){e.preventDefault(),$(".filter-all").toggleClass("active")}),$(".search-close").on("click",function(e){e.preventDefault(),$(".search-block").toggleClass("active"),setTimeout(function(){$(".search-block").toggleClass("search-open")},200)}),$(".faq-item").on("click",function(){var e=$(this).attr("data-faq");$(".faq-row").slideUp(),$("#"+e).slideDown()}),$(".footer-menu__title").on("click",function(e){e.preventDefault(),$(window).width()<=768&&$(this).parents(".footer-col").toggleClass("active").find("ul").slideToggle()}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var i=$(e.target).attr("href");$(i).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".select").on("click",function(e){if(!$(this).hasClass("select-hid"))if($(this).hasClass("active")){var i=e.target,t=$(this).find(".select-text"),a=$(this).find(".select-value");"LI"==i.tagName?($(t).text($(i).text()),$(a).val($(i).text())):"A"==i.tagName&&(e.preventDefault(),$(t).html($(i).html()),$(a).val($(i).text())),$(this).removeClass("active")}else $(".select").removeClass("active"),$(this).addClass("active")}),$(document).on("click",function(e){var i=$(".select");i.is(e.target)||0!==i.has(e.target).length||$(".select").removeClass("active")}),$(".input-tel").mask("+7 (999) 999-99-99"),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}}),$(document).mouseleave(function(){$("#modal-trigger").fancybox().trigger("click")})});