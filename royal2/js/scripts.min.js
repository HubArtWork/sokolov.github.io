...
var swiper=new Swiper(".gallery-slider",{slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:30,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{spaceBetween:20},1121:{spaceBetween:30}}});$(document).ready(function(){$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".drop-text").on("click",function(e){e.preventDefault(),$(window).width()<=920&&$(this).toggleClass("open").parents(".drop").find(".drop-info").slideToggle()}),$(".header-cart,.header-basket .close-dark-ico").on("click",function(){$(".header-basket").toggleClass("active")}),$(document).on("click",function(e){var t=$(".header-cart");(!t.is(e.target)&&0===t.has(e.target).length||$(".close-dark-ico").is(e.target))&&$(".header-basket").removeClass("active")}),$(".scrollbar-outer").scrollbar(),$(".order .primary-btn").on("click",function(){$(".order").toggleClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1})});