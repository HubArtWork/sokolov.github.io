...
var swiper=new Swiper(".category-slider",{slidesPerView:6,freeMode:!0,watchSlidesVisibility:!0,navigation:{nextEl:".category .swiper-button-next",prevEl:".category .swiper-button-prev"},breakpoints:{10:{slidesPerView:"auto"},640:{slidesPerView:3},769:{slidesPerView:4},970:{slidesPerView:5},1100:{slidesPerView:6}}}),swiper=new Swiper(".cities-slider",{slidesPerView:6,freeMode:!0,watchSlidesVisibility:!0,navigation:{nextEl:".cities .swiper-button-next",prevEl:".cities .swiper-button-prev"},breakpoints:{10:{slidesPerView:"auto"},640:{slidesPerView:3},769:{slidesPerView:4},970:{slidesPerView:5},1100:{slidesPerView:6}}}),swiper=new Swiper(".products-slider",{slidesPerView:3,freeMode:!0,watchSlidesVisibility:!0,navigation:{nextEl:".products .swiper-button-next",prevEl:".products .swiper-button-prev"},breakpoints:{10:{slidesPerView:1},640:{slidesPerView:1},769:{slidesPerView:2},970:{slidesPerView:3},1100:{slidesPerView:3}}});$(document).ready(function(){$(".drop-top").on("click",function(e){e.preventDefault(),$(this).parents(".drop").hasClass("active")?$(".drop").removeClass("active"):($(".drop").removeClass("active"),$(this).parents(".drop").addClass("active"))}),$(document).on("click",function(e){var t=$(".drop");t.is(e.target)||0!==t.has(e.target).length||$(".drop").removeClass("active")}),$(".datepicker").datepicker(),$(".footer-accordeon .footer-subtitle").on("click",function(){$(this).next(".footer-block").slideToggle().parents(".footer-accordeon").toggleClass("active")}),$(".dropbox .second-btn, .dropbox .close-ico").on("click",function(e){e.preventDefault(),$(this).parents(".dropbox").hasClass("active")?$(".dropbox").removeClass("active"):($(".dropbox").removeClass("active"),$(this).parents(".dropbox").addClass("active"))}),$(document).on("click",function(e){var t=$(".dropbox");t.is(e.target)||0!==t.has(e.target).length||$(".dropbox").removeClass("active")}),$(".checkout-top").on("click",function(){$(this).next(".checkout-drop").slideToggle().parents(".checkout-block").toggleClass("active")}),$(".list-block .list-ico").on("click",function(){$(this).parents(".list-top").next(".list-drop").slideToggle().parents(".list-block").toggleClass("open")});var e=$(".arrow-top");$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(e).addClass("arrow-active"):$(e).removeClass("arrow-active")}),$(e).on("click",function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(".header-menu, .main-info").on("click","a",function(e){e.preventDefault();var t=$(this).attr("href"),s=$(t).offset().top;$("html, body").animate({scrollTop:s},900),$(".header").removeClass("header-active")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(e.target).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".select").on("click",function(e){if(!$(this).hasClass("select-hid"))if($(this).hasClass("active")){var t=e.target,s=$(this).find(".select-text"),i=$(this).find(".select-value");"LI"==t.tagName?($(s).text($(t).text()),$(i).val($(t).text())):"A"==t.tagName&&(e.preventDefault(),$(s).html($(t).html()),$(i).val($(t).text())),$(this).removeClass("active")}else $(".select").removeClass("active"),$(this).addClass("active")}),$(document).on("click",function(e){var t=$(".select");t.is(e.target)||0!==t.has(e.target).length||$(".select").removeClass("active")})});