...
AOS.init({startEvent:"load"}),AOS.refresh(),$(document).ready(function(){window.addEventListener("load",AOS.refresh);var e=new Swiper(".mySwiper",{spaceBetween:10,slidesPerView:"auto",freeMode:!0,watchOverflow:!0,watchSlidesVisibility:!0,watchSlidesProgress:!0,breakpoints:{10:{slidesPerView:"auto"},769:{direction:"vertical"}}}),t=new Swiper(".mySwiper2",{loop:!0,spaceBetween:10,zoom:!0,zoom:{maxRatio:1.6},thumbs:{swiper:e}}),e=new Swiper(".reviews-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,spaceBetween:10});if(0!=$(".mySwiper2").length)for(var i=document.getElementsByClassName("swiper-zoom-container"),o=0;o<i.length;o++)i[o].addEventListener("mouseover",function(e){t.zoom.in()}),i[o].addEventListener("mouseout",function(e){t.zoom.out()});$(".header-bar,.header-wrap .close-ico").on("click",function(){$(".header").toggleClass("header-active")}),$(".header-message .close-ico").on("click",function(){$(".header-message").remove(),$("body").css("padding-top",$(".header").outerHeight()+"px"),0!=$(".main").length&&($(".main .wrapper").css("min-height",$(window).outerHeight()-$(".header").outerHeight()+"px"),$(".main-bg").resize())}),$(".drop-top").on("click",function(e){e.preventDefault(),$(window).outerWidth()<=1100&&$(this).parents().toggleClass("active").find(".drop-block").slideToggle()}),0!=$(".main").length&&$(".main .wrapper").css("min-height",$(window).outerHeight()-$(".header").outerHeight()+"px"),$("body").css("padding-top",$(".header").outerHeight()+"px"),$(window).resize(function(){0!=$(".main").length&&$(".main .wrapper").css("min-height",$(window).outerHeight()-$(".header").outerHeight()+"px"),$("body").css("padding-top",$(".header").outerHeight()+"px")}),$(".bag-top").on("click",function(e){e.preventDefault(),$(this).parents(".bag").toggleClass("active")}),$(document).on("click",function(e){var t=$(".bag");t.is(e.target)||0!==t.has(e.target).length||$(".bag").removeClass("active")}),$(".currency").on("click",function(e){e.preventDefault(),$(this).toggleClass("active")}),$(document).on("click",function(e){var t=$(".currency");t.is(e.target)||0!==t.has(e.target).length||$(".currency").removeClass("active")}),$(".choice-top").on("click",function(e){e.preventDefault(),$(this).parents(".choice").hasClass("active")?$(".choice").removeClass("active"):($(".choice").removeClass("active"),$(this).parents(".choice").addClass("active"))}),$(document).on("click",function(e){var t=$(".choice");t.is(e.target)||0!==t.has(e.target).length||$(".choice").removeClass("active")}),$(".product-like").on("click",function(e){e.preventDefault(),$(this).toggleClass("active")}),$('[data-fancybox=""]').click(function(){$.fancybox.close()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1})});