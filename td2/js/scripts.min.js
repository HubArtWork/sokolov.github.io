...
$(document).ready(function(){function e(){t.slider("values",[$("#filter-min").val(),$("#filter-max").val()])}$(".header-modal .close-ico-orange").on("click",function(e){e.preventDefault(),$(".header-modal").remove()}),$(".header-bar,.menu-top .filter-close-ico").on("click",function(e){e.preventDefault(),$(".menu").toggleClass("active")}),$(".menu-drop-top").on("click",function(e){e.preventDefault(),$(this).toggleClass("active").next("ul").slideToggle()}),$(".header-search input").on("input",function(){""==$(this).val()?$(this).parents(".header-search").removeClass("active"):$(this).parents(".header-search").addClass("active")}),$(".second-btn-catalog").on("click",function(e){e.preventDefault(),$(".directory").toggleClass("active"),$(".solution").removeClass("active")}),$(".directory-item-top").on("click",function(e){e.preventDefault(),$(this).parents(".directory-item").toggleClass("active")}),$(".directory-block .directory-title").on("click",function(e){e.preventDefault(),$(window).outerWidth()<=1200&&$(this).addClass("active").next("ul").slideToggle()}),$(".directory-sidebar ul li a").on("click",function(e){e.preventDefault(),$(this).parents(".directory-sidebar ul").find("a").removeClass("active"),$(this).parents(".directory").find(".directory-tab").removeClass("directory-tab-active");var t=$(e.target).attr("href");$(t).addClass("directory-tab-active"),$(this).addClass("active"),$(window).outerWidth()<=740&&($(".directory").addClass("directory-next"),$(".directory .mob-title").text($(this).text()))}),$(".directory .filter-close-ico").on("click",function(e){e.preventDefault(),$(".directory").removeClass("active directory-next")}),$(".directory .mob-title").on("click",function(e){e.preventDefault(),$(".directory").hasClass("directory-next")&&($(".directory").removeClass("directory-next"),$(".directory .mob-title").text("Оборудование"))}),$(".solution-link, .solution .mob-title, .solution .filter-close-ico").on("click",function(e){e.preventDefault(),$(".solution").toggleClass("active"),$(".directory").removeClass("active")});new Swiper(".equipment-slider",{slidesPerView:1,watchOverflow:!0,loop:!0,spaceBetween:30,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}}),new Swiper(".comparison-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:48,breakpoints:{10:{spaceBetween:16},769:{spaceBetween:48}}});if($(".card-slider").length>0){new Swiper(".card-slider",{slidesPerView:1,watchOverflow:!0,loop:!0,spaceBetween:30,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}})}new Swiper(".viewed-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:24,navigation:{nextEl:".card-viewed .swiper-button-next",prevEl:".card-viewed .swiper-button-prev"},breakpoints:{10:{spaceBetween:16},740:{spaceBetween:24}}}),new Swiper(".category-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:24,navigation:{nextEl:".card-category .swiper-button-next",prevEl:".card-category .swiper-button-prev"},breakpoints:{10:{spaceBetween:16},740:{spaceBetween:24}}}),new Swiper(".testimonials-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:24,breakpoints:{10:{spaceBetween:16},740:{spaceBetween:24}}});if($(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(e.target).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".equipment-row-folding").length>0&&($(".equipment-wrap ul li:nth-child(n+6)").slideUp(0),$(".equipment-row-folding .equipment-wrap ul").find("li").length>5&&$(".equipment-more").on("click",function(){var e=$(this).parents(".equipment-wrap"),t=+e.find("ul li").length-5;e.find("ul li:nth-child(n+6)").slideToggle(),e.toggleClass("active"),e.hasClass("active")?$(this).html("Скрыть"):$(this).html("Посмотреть еще "+t)})),$(".filter-block-top").on("click",function(e){$(this).parents(".filter-block").toggleClass("active").find(".filter-block-drop").slideToggle(0)}),$(".filter-more").on("click",function(e){e.preventDefault(),$(this).toggleClass("active"),$(".filter-all").slideToggle(200),$(this).hasClass("active")?$(this).html("Свернуть"):$(this).html("Показать весь фильтр")}),$(".catalog-view .hb-ico").on("click",function(e){e.preventDefault(),$(this).hasClass("active")||($(".catalog-view .hb-ico").removeClass("active"),$(this).addClass("active"))}),$(".catalog-mob-btn,.catalog-sidebar .filter-close-ico,.filter-bg").on("click",function(e){$(".catalog-sidebar").toggleClass("active"),$(".filter-bg").toggleClass("active")}),$("#filter-range").length>0){var t=$("#filter-range"),i=t.attr("data-min"),l=t.attr("data-max");$("#filter-min, #filter-max").map(function(){$(this).attr({min:i,max:l})}),$("#filter-min").attr({placeholder:"min "+i,value:i}),$("#filter-max").attr({placeholder:"max "+l,value:l}),t.slider({range:!0,min:Math.max(i,0),max:l,values:[i,l],slide:function(e,t){$("#filter-min").val(t.values[0]),$("#filter-max").val(t.values[1])}}),$("#filter-min, #filter-max").map(function(){$(this).on("input",function(){e()})})}$(".favorites-ico").on("click",function(e){e.preventDefault(),$(this).toggleClass("active")}),$(".comparison-ico").on("click",function(e){e.preventDefault(),$(this).toggleClass("active")}),$(".commodity-drop").on("click",function(e){e.preventDefault(),$(this).toggleClass("active")}),$(".commodity-drop-block li a").on("click",function(e){e.preventDefault(),$(this).parents(".commodity-drop").find(".commodity-drop-top").text($(this).text())}),$(".commodity-link").on("click",function(e){e.preventDefault(),$(this).hasClass("active")?$(this).removeClass("active").html("Посмотреть все").parents(".commodity-descr").find("ul").removeClass("active"):$(this).addClass("active").html("Скрыть").parents(".commodity-descr").find("ul").addClass("active")}),$(".ordering-sidebar-top").on("click",function(){$(window).outerWidth()<=980&&$(this).parents(".ordering-sidebar-wrap").toggleClass("active").find(".ordering-sidebar-drop").slideToggle()}),$(".amount input").on("change keyup input click",function(e){this.value.match(/[^0-9]/g)&&(this.value=this.value.replace(/[^0-9]/g,""))}),$(".amount-minus,.amount-plus").on("click",function(e){e.preventDefault();var t=$(this).parents(".amount").find("input");console.log(t.val()),$(this).hasClass("amount-minus")&&t.val()>=1&&t.val(+t.val()-1),$(this).hasClass("amount-plus")&&t.val()>=0&&t.val(+t.val()+1)}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}}),$.fancybox.defaults.closeExisting=!0,$(".modal-btn").on("click",function(e){e.preventDefault(),$.fancybox.close()}),$(".profile-sidebar").length>0&&$(window).width()>980&&$(".profile-all").css("min-height",$(".profile-sidebar").outerHeight()),$(".header-search-items").length>0&&(new SimpleBar($(".header-search-items")[0]),new SimpleBar($(".header-search-items")[1])),$(".directory").length>0&&(new SimpleBar($(".directory-sidebar")[0]),new SimpleBar($(".directory-content")[0])),$(".profile-menu").length>0&&new SimpleBar($(".profile-menu")[0]),$(".profile-list").length>0&&new SimpleBar($(".profile-list")[0]),$(".crumbs").length>0&&new SimpleBar($(".crumbs")[0]),$(".profile-table").length>0&&new SimpleBar($(".profile-table")[0]),$(".profile-table").length>1&&new SimpleBar($(".profile-table")[1]),$(".profile-table").length>2&&new SimpleBar($(".profile-table")[2]),$(".profile-table").length>3&&new SimpleBar($(".profile-table")[3]),$(".profile-table").length>4&&new SimpleBar($(".profile-table")[4]),$(".profile-scroll-main").length>0&&new SimpleBar($(".profile-scroll-main")[0]),$(".profile-scroll-main").length>1&&new SimpleBar($(".profile-scroll-main")[1]),$(".profile-scroll-main").length>2&&new SimpleBar($(".profile-scroll-main")[2]),$(".profile-scroll-main").length>3&&new SimpleBar($(".profile-scroll-main")[3]),$(".profile-scroll-main").length>4&&new SimpleBar($(".profile-scroll-main")[4])});