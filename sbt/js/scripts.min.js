...
var swiper=new Swiper(".production-slider",{slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,watchOverflow:!0});$(document).ready(function(){$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".tab-list li a").on("click",function(a){a.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var e=$(a.target).attr("href");$(e).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".catalog-tabs li a").on("click",function(a){a.preventDefault(),$(this).parents(".catalog-tabs").find("a").removeClass("active"),$(".catalog-content__row").removeClass("tit-1 tit-2");var e=$(a.target).attr("data-tit");$(".catalog-content__row").addClass(e),$(this).addClass("active")}),$(".catalog-sidebar__more").on("click",function(a){a.preventDefault(),$(this).hasClass("active")?$(this).removeClass("active").text("Показать еще"):$(this).addClass("active").text("Свернуть"),$(".catalog-sidebar__block").slideToggle()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}})});