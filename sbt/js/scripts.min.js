...
if($(".production-slider").length)var swiper=new Swiper(".production-slider",{slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,watchOverflow:!0});if($(".gallery-top").length){var galleryTop=new Swiper(".gallery-top",{slidesPerView:1,loop:!0,loopedSlides:50,effect:"fade",fadeEffect:{crossFade:!0}}),galleryThumbs=new Swiper(".gallery-thumbs",{direction:"vertical",slidesPerView:"auto",slideToClickedSlide:!0,loopedSlides:50,loop:!0});galleryTop.controller.control=galleryThumbs,galleryThumbs.controller.control=galleryTop}$(document).ready(function(){$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var a=$(e.target).attr("href");$(a).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".catalog-tabs li a").on("click",function(e){e.preventDefault(),$(this).parents(".catalog-tabs").find("a").removeClass("active"),$(".catalog-content__row").removeClass("tit-1 tit-2");var a=$(e.target).attr("data-tit");$(".catalog-content__row").addClass(a),$(this).addClass("active")}),$(".catalog-sidebar__more").on("click",function(e){e.preventDefault(),$(this).hasClass("active")?$(this).removeClass("active").text("Показать еще"):$(this).addClass("active").text("Свернуть"),$(".catalog-sidebar__block").slideToggle()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}})});