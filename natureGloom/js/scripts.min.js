...
AOS.init({startEvent:"load"});var swiper=new Swiper(".faq-slider",{freeMode:!0,watchSlidesVisibility:!0,mousewheel:!0,slidesPerView:"auto",navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),swiper=new Swiper(".categories-wrapper",{slidesPerView:"auto",freeMode:!0,mousewheel:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),swiper=new Swiper(".news-slider",{slidesPerView:1,pagination:{el:".swiper-pagination",clickable:!0}});$(document).ready(function(){window.addEventListener("load",AOS.refresh);var e=$(".arrow-top");$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(e).addClass("arrow-active"):$(e).removeClass("arrow-active")}),$(e).on("click",function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")})});