...
var swiper=new Swiper(".main-slider",{slidesPerView:1,watchOverflow:!0,loop:!0,paginationClickable:!0,navigation:{nextEl:".main-wrap .swiper-button-next",prevEl:".main-wrap .swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}}),swiper=new Swiper(".about-slider",{slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,watchOverflow:!0,paginationClickable:!0,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:"auto",spaceBetween:0},769:{slidesPerView:3}}}),swiper=new Swiper(".mySwiper",{spaceBetween:20,slidesPerView:3,freeMode:!0,watchSlidesProgress:!0}),swiper2=new Swiper(".mySwiper2",{spaceBetween:10,thumbs:{swiper:swiper},navigation:{nextEl:".card-swiper .swiper-button-next",prevEl:".card-swiper .swiper-button-prev"}});$(document).ready(function(){function e(){$("html,body").removeClass("scroll-hidden"),$(".header").removeClass("header-active"),$(".search,.header-phone,.header-wrap").removeClass("active")}$(document).on("click",function(a){var t=$(".header-bar,.header-bottom,.search, .search-ico, .search-close,.header-phone,.header-wrap");t.is(a.target)||0!==t.has(a.target).length||e()}),$(window).on("scroll",function(){$(window).scrollTop()>300?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed")}),$(".header-btn").on("click",function(e){e.preventDefault(),$(".header-catalog").toggleClass("active"),$(window).outerWidth()<980&&$(".header-catalog__drop").slideToggle()}),$(".header-catalog .drop-text").on("click",function(e){e.preventDefault(),$(window).outerWidth()<980&&$(this).toggleClass("active").next().slideToggle()}),$(".header-phone").on("click",function(){$(".header-phone,.header-wrap").toggleClass("active"),$("html,body").removeClass("scroll-hidden"),$(".header").removeClass("header-active"),$(".search").removeClass("active")}),$(".header-bar").on("click",function(){$("html,body").toggleClass("scroll-hidden"),$(".header").toggleClass("header-active"),$(".search,.header-phone,.header-wrap").removeClass("active")}),$(".search-ico, .search-close").on("click",function(e){e.preventDefault(),$(".search").toggleClass("active"),$(".header-phone,.header-wrap").removeClass("active"),$("html,body").removeClass("scroll-hidden"),$(".header").removeClass("header-active")});var a=$(".arrow-top");$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(a).addClass("arrow-active"):$(a).removeClass("arrow-active")}),$(a).on("click",function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(".about-descr .primary-btn").on("click",function(e){e.preventDefault(),$(this).hasClass("active")?$(this).removeClass("active").html("<span><i>Подробнее</i></span>").parents(".about-descr").find(".about-text").slideUp():$(this).addClass("active").html("<span><i>Скрыть</i></span>").parents(".about-descr").find(".about-text").slideDown()}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var a=$(e.target).attr("href");$(a).addClass("tab-active"),$(this).addClass("active")}),$(".catalog-sidebar .drop-text").on("click",function(e){e.preventDefault(),$(this).toggleClass("active").next(".drop-list").slideToggle()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}})});