...
function menuOpen(e){"click"==e.type&&(header.classList.toggle("header-active"),body.classList.toggle("scroll-hidden"))}function searchOpen(e){"click"==e.type&&header.classList.toggle("header-fixed")}function change(e){var t=e.target;"SPAN"===t.tagName&&(t.classList.contains("select")?hideAll():(hideAll(),t.classList.add("select"),showText(t.nextElementSibling)))}function hideAll(){for(var e=headerMob.querySelectorAll("SPAN"),t=headerMob.querySelectorAll("UL"),a=0;a<e.length;a++)e[a].classList.remove("select");for(var a=0;a<t.length;a++)t[a].style.height="0"}function showText(e){e.style.height=e.scrollHeight+"px"}function forRemove(e){for(var t=0;t<e.length;t++)e[t].classList.remove("active")}function modalS(e){for(var t=e.width||300,a=e.height||400,s=e.bg||"white",i=0;i<modal.length;i++)modal[i].style.maxWidth=t+"px",modal[i].style.maxHeight=a+"px",modal[i].style.background=s}var swiper=new Swiper(".main-slider",{spaceBetween:30,effect:"fade",pagination:{el:".swiper-pagination",clickable:!0}}),swiper=new Swiper(".products-slider",{slidesPerView:3,freeMode:!0,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:20,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{spaceBetween:12,slidesPerView:"auto"},769:{spaceBetween:20,slidesPerView:"auto"},961:{spaceBetween:20,slidesPerView:3}}}),swiper=new Swiper(".mySwiper",{direction:"vertical",slidesPerView:"auto",spaceBetween:10,watchSlidesProgress:!0}),swiper2=new Swiper(".mySwiper2",{spaceBetween:10,pagination:{el:".swiper-pagination",clickable:!0},thumbs:{swiper:swiper},breakpoints:{10:{spaceBetween:12,slidesPerView:"auto"},961:{spaceBetween:10,slidesPerView:1}}});if(document.getElementsByClassName("header-bar").length){var bar=document.querySelector(".header-bar"),header=document.querySelector(".header"),body=document.querySelector("HTML");bar.addEventListener("click",menuOpen)}if(document.getElementsByClassName("header-item")[0].addEventListener("mouseover",function(e){document.getElementsByClassName("header")[0].classList.add("active")}),document.getElementsByClassName("header-item")[0].addEventListener("mouseout",function(e){document.getElementsByClassName("header")[0].classList.remove("active")}),document.getElementsByClassName("header-actions").length){var searchBtn=document.querySelector(".header-actions .search-ico"),header=document.querySelector(".header");searchBtn.addEventListener("click",searchOpen)}var headerMob=document.getElementsByClassName("header-mob")[0];if(headerMob.addEventListener("click",change),document.getElementsByClassName("drop1").length){var drop1=document.querySelector(".drop1");drop1.onclick=function(e){e.target;this.classList.contains("active")?drop1.classList.remove("active"):drop1.classList.add("active")},document.addEventListener("click",function(e){drop1.contains(e.target)||drop1.classList.remove("active")})}if(document.getElementsByClassName("drop2").length){var drop2=document.querySelector(".drop2");drop2.onclick=function(e){e.target;this.classList.contains("active")?drop2.classList.remove("active"):drop2.classList.add("active")},document.addEventListener("click",function(e){drop2.contains(e.target)||drop2.classList.remove("active")})}if(document.getElementsByClassName("drop3").length){var drop3=document.querySelector(".drop3");drop3.onclick=function(e){e.target;this.classList.contains("active")?drop3.classList.remove("active"):drop3.classList.add("active")},document.addEventListener("click",function(e){drop3.contains(e.target)||drop3.classList.remove("active")})}if(document.getElementsByClassName("profile-sidebar").length){var profile=document.querySelector(".profile-sidebar");profile.onclick=function(e){e.target;this.classList.contains("active")?profile.classList.remove("active"):profile.classList.add("active")},document.addEventListener("click",function(e){profile.contains(e.target)||profile.classList.remove("active")})}if(document.getElementsByClassName("tabbed").length){var tabsWrap=document.querySelector(".tabs-list"),tabsItem=document.getElementsByClassName("tabs-item"),tabbed=document.getElementsByClassName("tabbed");tabsWrap.addEventListener("click",function(e){var t=e.target;"SPAN"==t.tagName&&(forRemove(tabsItem),forRemove(tabbed),t.classList.add("active"),document.getElementById(t.getAttribute("data-tabs")).classList.add("active"))})}if(document.getElementsByClassName("profile-new").length)for(var profileBtn=document.getElementsByClassName("add-btn"),j=0;j<profileBtn.length;j++)profileBtn[j].addEventListener("click",function(e){e.preventDefault(),e.target.parentElement.parentElement.classList.toggle("active")});for(var overlay=document.getElementById("overlay"),modal=document.getElementsByClassName("modal"),button=document.getElementsByClassName("button-modal"),i=0;i<button.length;i++)button[i].addEventListener("click",function(e){e.preventDefault();var t=this.getAttribute("href"),a=document.getElementById(t);a.classList.add("open-modal"),overlay.classList.add("open-overlay"),a.clientHeight>=400&&(a.style.overflowY="scroll");var s=document.createElement("div");s.className="cancel",a.appendChild(s),s.addEventListener("click",function(){a.classList.remove("open-modal"),overlay.classList.remove("open-overlay"),a.removeChild(s)}),overlay.addEventListener("click",function(){a.classList.remove("open-modal"),overlay.classList.remove("open-overlay"),a.removeChild(s)})});