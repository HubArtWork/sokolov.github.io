...
function menuOpen(e){"click"==e.type&&header.classList.toggle("header-active")}var swiper=new Swiper(".main-slider",{spaceBetween:30,effect:"fade",pagination:{el:".swiper-pagination",clickable:!0}}),swiper=new Swiper(".product-slider",{slidesPerView:3,freeMode:!0,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:20,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{spaceBetween:12,slidesPerView:"auto"},769:{spaceBetween:20},1e3:{spaceBetween:20,slidesPerView:3}}}),swiper=new Swiper(".categories-wrapper",{slidesPerView:"auto",freeMode:!0,mousewheel:!0,watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),swiper=new Swiper(".news-slider",{slidesPerView:1,watchOverflow:!0,pagination:{el:".swiper-pagination",clickable:!0}});if(document.getElementsByClassName("header-bar").length){var bar=document.querySelector(".header-bar"),header=document.querySelector(".header");bar.addEventListener("click",menuOpen)}