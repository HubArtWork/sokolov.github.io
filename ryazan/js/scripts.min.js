...
var swiper=new Swiper(".categories-slider",{slidesPerView:6,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:20,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:4},850:{slidesPerView:5},1e3:{slidesPerView:6}}}),swiper=new Swiper(".suggestions-slider",{slidesPerView:1,watchOverflow:!0,navigation:{nextEl:".suggestions-all .swiper-button-next",prevEl:".suggestions-all .swiper-button-prev"}});$(document).ready(function(){function e(){var e=window.matchMedia("(min-width: 0px) and (max-width: 768px)");window.matchMedia("(min-width: 769px) and (max-width: 1024px)"),window.matchMedia("(min-width: 1025px)");e.matches&&(a||(a=!0,i=new Swiper(".enterprises-slider",{spaceBetween:16,slidesPerView:3,watchOverflow:!0,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{spaceBetween:3},600:{spaceBetween:4},768:{spaceBetween:5}}})))}function t(){$(".map-info").css("left",($(window).width()-$(".about-block .wrapper").width())/2+"px")}var i=new Swiper(".mySwiper",{spaceBetween:10,slidesPerView:"auto",freeMode:!0,watchOverflow:!0,watchSlidesVisibility:!0,watchSlidesProgress:!0,breakpoints:{10:{slidesPerView:"auto"},769:{direction:"vertical"}}});new Swiper(".mySwiper2",{loop:!0,spaceBetween:10,zoom:!0,zoom:{maxRatio:1.6},thumbs:{swiper:i}});if($(".enterprises-slider").length>0){var i=Swiper,a=!1;window.addEventListener("load",function(){e()}),window.addEventListener("resize",function(){e()})}$(".catalog-btn").on("click",function(e){e.preventDefault(),$(".header").toggleClass("header-active"),$(".header-menu-item,.header-menu-drop").removeClass("active")}),$(".header-menu-link").on("click",function(e){e.preventDefault(),$(window).outerWidth()<=768&&$(this).parents(".header-menu-item").addClass("active")}),$(".header-menu-tit").on("click",function(e){$(window).outerWidth()<=768&&$(this).next().length>0&&(e.preventDefault(),$(this).next().addClass("active").parents(".header-menu-drop").addClass("active"))}),$(".input-block input").focus(function(){$(this).parents(".input-block").addClass("focused")}),$(".input-block input").blur(function(){""==$(this).val()?($(this).removeClass("filled"),$(this).parents(".input-block").removeClass("focused")):$(this).addClass("filled")}),0!=$(".map-info").length&&(t(),$(window).on("resize",function(){t()})),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(e.target).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".card-block-top").on("click",function(){console.log("das"),$(this).parents(".card-block").hasClass("active")?$(".card-block-top").next(".card-block-wrap").slideUp().parents(".card-block").removeClass("active"):($(".card-block-top").next(".card-block-wrap").slideUp().parents(".card-block").removeClass("active"),$(this).next(".card-block-wrap").slideDown().parents(".card-block").addClass("active"))}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(document).on("click",function(e){var t=$(".select");t.is(e.target)||0!==t.has(e.target).length||$(".select").removeClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}})});