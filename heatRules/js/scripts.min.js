...
var galleryThumbs=new Swiper(".portfolio-row__1 .gallery-thumbs",{spaceBetween:4,slidesPerView:7,freeMode:!0,watchSlidesVisibility:!0,watchSlidesProgress:!0,breakpoints:{10:{slidesPerView:4},500:{slidesPerView:5},769:{slidesPerView:7}}}),galleryTop=new Swiper(".portfolio-row__1 .gallery-top",{thumbs:{swiper:galleryThumbs}}),galleryThumbs=new Swiper(".portfolio-row__2 .gallery-thumbs",{spaceBetween:4,slidesPerView:7,freeMode:!0,watchSlidesVisibility:!0,watchSlidesProgress:!0,breakpoints:{10:{slidesPerView:4},500:{slidesPerView:5},769:{slidesPerView:7}}}),galleryTop=new Swiper(".portfolio-row__2 .gallery-top",{thumbs:{swiper:galleryThumbs}}),galleryThumbs=new Swiper(".portfolio-row__3 .gallery-thumbs",{spaceBetween:4,slidesPerView:7,freeMode:!0,watchSlidesVisibility:!0,watchSlidesProgress:!0,breakpoints:{10:{slidesPerView:4},500:{slidesPerView:5},769:{slidesPerView:7}}}),galleryTop=new Swiper(".portfolio-row__3 .gallery-top",{thumbs:{swiper:galleryThumbs}}),galleryThumbs=new Swiper(".portfolio-row__4 .gallery-thumbs",{spaceBetween:4,slidesPerView:7,freeMode:!0,watchSlidesVisibility:!0,watchSlidesProgress:!0,breakpoints:{10:{slidesPerView:4},500:{slidesPerView:5},769:{slidesPerView:7}}}),galleryTop=new Swiper(".portfolio-row__4 .gallery-top",{thumbs:{swiper:galleryThumbs}}),swiper=new Swiper(".testimonials-slider",{slidesPerView:6,grabCursor:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:3},500:{slidesPerView:4},769:{slidesPerView:6}}});$(document).ready(function(){$(window).on("scroll",function(){$(window).scrollTop()>200?$(".menu").addClass("active"):$(".menu").removeClass("active")}),$(".input-tel").mask("+7 (999) 999-99-99"),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1})});