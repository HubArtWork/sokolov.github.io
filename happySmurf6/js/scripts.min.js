...
var swiper=new Swiper(".testimonials-slider",{slidesPerView:2,freeMode:!1,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:40,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:"auto",freeMode:!0,spaceBetween:16},981:{slidesPerView:2,freeMode:!1,spaceBetween:40}}}),swiper=new Swiper(".posts-slider",{slidesPerView:3,freeMode:!1,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:40,breakpoints:{10:{slidesPerView:"auto",freeMode:!0,spaceBetween:16},981:{slidesPerView:3,freeMode:!1,spaceBetween:40}}});$(document).ready(function(){if($("#slider").length){var e=document.getElementById("slider");noUiSlider.create(e,{start:[0,1e3],connect:!0,range:{min:0,max:1e3},step:1,tooltips:!0,pips:{mode:"steps"},format:{from:function(e){return parseInt(e)},to:function(e){return parseInt(e)}}})}if($("#slider2").length){var t=document.getElementById("slider2");noUiSlider.create(t,{start:[0,123],connect:!0,range:{min:0,max:140},step:1,tooltips:!0,pips:{mode:"steps"},format:{from:function(e){return parseInt(e)},to:function(e){return parseInt(e)}}})}$(window).on("scroll",function(){console.log("das"),$(this).scrollTop()>0?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(this).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".select").on("click",function(e){$(this).toggleClass("active")}),$(document).on("click",function(e){var t=$(".select");t.is(e.target)||0!==t.has(e.target).length||$(".select").removeClass("active")}),$(".search-drop").on("click",function(e){$(this).toggleClass("active")}),$(document).on("click",function(e){var t=$(".search-drop");t.is(e.target)||0!==t.has(e.target).length||$(".search-drop").removeClass("active")}),$(".sort").on("click",function(e){$(this).toggleClass("active")}),$(document).on("click",function(e){var t=$(".sort");t.is(e.target)||0!==t.has(e.target).length||$(".sort").removeClass("active")})});