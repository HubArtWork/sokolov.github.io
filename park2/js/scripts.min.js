...
var swiper=new Swiper(".activity-slider",{slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,mousewheel:!0,watchOverflow:!0});$(document).ready(function(){$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".header-list, .footer-menu").on("click","a",function(e){e.preventDefault();var t=$(this).attr("href"),a=$(t).offset().top;$(window).outerWidth()<=1100?($(".header").removeClass("header-active"),$("html, body").animate({scrollTop:a-$(".header").outerHeight()},900)):$("html, body").animate({scrollTop:a},900)}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1})});