...
function menuOpen(e){"click"==e.type&&header.classList.toggle("header-active")}function forRemove(e){for(var t=0;t<e.length;t++)e[t].classList.remove("active")}var swiper=new Swiper(".trending-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,navigation:{nextEl:".trending .swiper-button-next",prevEl:".trending .swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}});if(document.getElementsByClassName("header-bar").length){var bar=document.querySelector(".header-bar"),header=document.querySelector(".header");bar.addEventListener("click",menuOpen)}if(document.getElementsByClassName("drop").length){var drop=document.querySelector(".drop");drop.onclick=function(e){e.target;this.classList.contains("active")?drop.classList.remove("active"):drop.classList.add("active")},document.addEventListener("click",function(e){drop.contains(e.target)||drop.classList.remove("active")})}if(document.getElementsByClassName("allTabs").length){var tabsWrap=document.querySelector(".allTabs"),tabsItem=document.getElementsByClassName("tabs-item"),tab=document.getElementsByClassName("tab");tabsWrap.addEventListener("click",function(e){var t=e.target;if(t.classList.contains("tabs-item")){if("SPAN"!=t.tagName)return;forRemove(tabsItem),forRemove(tab),t.classList.add("active"),document.getElementById(t.getAttribute("data-tabs")).classList.add("active")}})}document.getElementsByClassName("specifications").length&&(document.querySelector(".specifications-top").onclick=function(){document.querySelector(".specifications").classList.toggle("active")});