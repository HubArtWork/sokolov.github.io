...
function magic(){window.pageYOffset>100?document.querySelector(".learn").classList.add("learn-active"):document.querySelector(".learn").classList.remove("learn-active")}var swiper=new Swiper(".trending-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,navigation:{nextEl:".trending .swiper-button-next",prevEl:".trending .swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}});document.addEventListener("DOMContentLoaded",function(){function e(e){"click"==e.type&&a.classList.toggle("header-active")}function t(e){for(var t=0;t<e.length;t++)e[t].classList.remove("active")}if(document.getElementsByClassName("header-bar").length){var n=document.querySelector(".header-bar"),a=document.querySelector(".header");n.addEventListener("click",e)}if(document.getElementsByClassName("drop").length){var c=document.querySelector(".drop");c.onclick=function(e){e.target;this.classList.contains("active")?c.classList.remove("active"):c.classList.add("active")},document.addEventListener("click",function(e){c.contains(e.target)||c.classList.remove("active")})}if(document.getElementsByClassName("allTabs").length){var s=document.querySelector(".allTabs"),i=document.getElementsByClassName("tabs-item"),l=document.getElementsByClassName("tab");s.addEventListener("click",function(e){var n=e.target;if(n.classList.contains("tabs-item")){if("SPAN"!=n.tagName)return;t(i),t(l),n.classList.add("active"),document.getElementById(n.getAttribute("data-tabs")).classList.add("active")}})}if(document.getElementsByClassName("specifications").length&&(document.querySelector(".specifications-top").onclick=function(){document.querySelector(".specifications").classList.toggle("active")}),document.getElementsByClassName("scroll-link").length)for(var o=document.querySelectorAll(".scroll-link"),r=0;r<o.length;r++)o[r].onclick=function(e){e.preventDefault();var t=this,n=t.getAttribute("href"),a=document.querySelectorAll(n)[0];window.scrollTo({top:a.offsetTop-20,behavior:"smooth"})}}),document.getElementsByClassName("learn").length&&(window.onscroll=magic);