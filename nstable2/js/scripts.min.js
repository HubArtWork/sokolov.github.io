...
function menuOpen(e){"click"==e.type&&(header.classList.toggle("header-active"),menu.classList.toggle("active"),body.classList.toggle("scroll-hidden"))}function forRemove(e){for(var t=0;t<e.length;t++)e[t].classList.remove("active")}function forRemove2(e){for(var t=0;t<e.length;t++)e[t].classList.remove("active")}if(window.innerWidth<=960&&document.getElementsByClassName("advantage-slider").length)var swiper=new Swiper(".advantage-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,pagination:{el:".swiper-pagination",clickable:!0}});if(document.getElementsByClassName("aboutUs-slider").length)var swiper=new Swiper(".aboutUs-slider",{slidesPerView:1,watchOverflow:!0,navigation:{nextEl:".aboutUs-top .swiper-button-next",prevEl:".aboutUs-top .swiper-button-prev"}});if(document.getElementsByClassName("blockquote-slider").length)var swiper=new Swiper(".blockquote-slider",{slidesPerView:1,watchOverflow:!0,pagination:{el:".blockquote .swiper-pagination",clickable:!0}});if(document.getElementsByClassName("header-bar").length){var bar=document.querySelector(".header-bar"),header=document.querySelector(".header"),menu=document.querySelector(".menu"),body=document.querySelector("HTML");bar.addEventListener("click",menuOpen)}if(document.getElementsByClassName("tabbed").length){var tabsWrap=document.querySelector(".tabs-list"),tabsItem=document.getElementsByClassName("tabs-item"),tabbed=document.getElementsByClassName("tabbed");tabsWrap.addEventListener("click",function(e){var t=e.target;"SPAN"==t.tagName&&(forRemove(tabsItem),forRemove(tabbed),t.classList.add("active"),document.getElementById(t.getAttribute("data-tabs")).classList.add("active"))})}if(document.getElementsByClassName("howWorks-tabbed").length){var tabsWrap2=document.querySelector(".howWorks-list"),tabsItem2=document.getElementsByClassName("howWorks-item"),tabbed2=document.getElementsByClassName("howWorks-tabbed");tabsWrap2.addEventListener("click",function(e){var t=e.target;"SPAN"==t.tagName&&(forRemove2(tabsItem2),forRemove2(tabbed2),t.classList.add("active"),document.getElementById(t.getAttribute("data-tabs")).classList.add("active"))});var acc=document.getElementsByClassName("howWorks-sub"),i;for(i=0;i<acc.length;i++)acc[i].onclick=function(){var e=this.nextElementSibling,t=document.getElementsByClassName("howWorks-items"),s=(document.getElementsByClassName("howWorks-sub"),document.getElementsByClassName("howWorks-sub active"));if(e.style.maxHeight)e.style.maxHeight=null,this.classList.remove("active");else{for(var a=0;a<s.length;a++)s[a].classList.remove("active");for(var l=0;l<t.length;l++)this.classList.remove("active"),t[l].style.maxHeight=null;e.style.maxHeight=e.scrollHeight+"px",this.classList.add("active")}}}if(document.getElementsByClassName("footer-title-sub").length){var acc=document.getElementsByClassName("footer-title-sub"),i;for(i=0;i<acc.length;i++)acc[i].onclick=function(){var e=this.nextElementSibling,t=document.getElementsByClassName("footer-wrap"),s=(document.getElementsByClassName("footer-title-sub"),document.getElementsByClassName("footer-title-sub active"));if(e.style.maxHeight)e.style.maxHeight=null,this.classList.remove("active");else{for(var a=0;a<s.length;a++)s[a].classList.remove("active");for(var l=0;l<t.length;l++)this.classList.remove("active"),t[l].style.maxHeight=null;e.style.maxHeight=e.scrollHeight+"px",this.classList.add("active")}}}if(document.getElementsByClassName("docs-link-top").length){var acc=document.getElementsByClassName("docs-link-top"),i;for(i=0;i<acc.length;i++)acc[i].onclick=function(){var e=this.nextElementSibling,t=document.getElementsByClassName("docs-wrap"),s=(document.getElementsByClassName("docs-link-top"),document.getElementsByClassName("docs-link-top active"));if(e.style.maxHeight)e.style.maxHeight=null,this.classList.remove("active");else{for(var a=0;a<s.length;a++)s[a].classList.remove("active");for(var l=0;l<t.length;l++)this.classList.remove("active"),t[l].style.maxHeight=null;e.style.maxHeight=e.scrollHeight+"px",this.classList.add("active")}}}if(document.getElementsByClassName("course-accordion").length){var acc=document.getElementsByClassName("course-accordion"),i;for(i=0;i<acc.length;i++)acc[i].onclick=function(){var e=this.nextElementSibling,t=document.getElementsByClassName("course-panel"),s=(document.getElementsByClassName("course-accordion"),document.getElementsByClassName("course-accordion active"));if(e.style.maxHeight)e.style.maxHeight=null,this.classList.remove("active");else{for(var a=0;a<s.length;a++)s[a].classList.remove("active");for(var l=0;l<t.length;l++)this.classList.remove("active"),t[l].style.maxHeight=null;e.style.maxHeight=e.scrollHeight+"px",this.classList.add("active")}}}