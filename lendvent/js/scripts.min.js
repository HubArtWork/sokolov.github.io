...
var swiper=new Swiper(".portfolio-slider",{slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}});if($(".gallery-top").length){var galleryTop=new Swiper(".gallery-top",{slidesPerView:1,loop:!0,loopedSlides:50}),galleryThumbs=new Swiper(".gallery-thumbs",{direction:"vertical",slidesPerView:3,slideToClickedSlide:!0,spaceBetween:20,loopedSlides:50,loop:!0,breakpoints:{10:{direction:"horizontal",slidesPerView:"auto"},769:{direction:"vertical",slidesPerView:3}}});galleryTop.controller.control=galleryThumbs,galleryThumbs.controller.control=galleryTop}AOS.init({startEvent:"load"}),AOS.refresh(),$(document).ready(function(){window.addEventListener("load",AOS.refresh),$(window).on("scroll",function(){$(window).scrollTop()>200?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1})});