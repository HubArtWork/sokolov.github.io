...
var swiper=new Swiper(".services-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,spaceBetween:32,breakpoints:{10:{slidesPerView:"auto",spaceBetween:16},769:{spaceBetween:32}}}),swiper=new Swiper(".situation-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:32,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:"auto",spaceBetween:20},769:{spaceBetween:32}}}),swiper=new Swiper(".testimonials-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:29,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:"auto",spaceBetween:16},769:{spaceBetween:29}}}),swiper=new Swiper(".rating-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:32,breakpoints:{10:{slidesPerView:"auto",spaceBetween:16},769:{spaceBetween:32}}}),swiper=new Swiper(".partners-slider",{slidesPerView:"auto",watchOverflow:!0,navigation:{nextEl:".partners .swiper-button-next",prevEl:".partners .swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},769:{slidesPerView:"auto"}}}),swiper=new Swiper(".team-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:32,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:"auto",spaceBetween:16},769:{spaceBetween:32}}}),swiper=new Swiper(".networks-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:32,breakpoints:{10:{slidesPerView:"auto",spaceBetween:16},769:{spaceBetween:32}}});$(document).ready(function(){var e=$(".main-arrow");$(e).on("click",function(){$("html, body").stop().animate({scrollTop:$(".main").height()},"slow","swing")}),$(".header-list").on("click","a",function(e){e.preventDefault();var t=$(this).attr("href"),a=$(t).offset().top;$("html, body").animate({scrollTop:a-$(".header").outerHeight()},900),$(".header").removeClass("header-active"),$(".header-bg").removeClass("active")}),$(".modal-step .btn-next").on("click",function(e){e.preventDefault(),$(this).parents(".modal-step").next().addClass("active").prev().removeClass("active")}),$(".modal-step .btn-prev").on("click",function(e){e.preventDefault(),$(this).parents(".modal-step").prev().addClass("active").next().removeClass("active")}),$(".header-bar,.header-bg").on("click",function(){$(".header").toggleClass("header-active"),$(".header-bg").toggleClass("active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(e.target).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}}),$(".modal-form-done .primary-btn").on("click",function(e){e.preventDefault(),$.fancybox.close()})});