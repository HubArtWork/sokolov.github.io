...
$(function(){AOS.init()}),$(document).ready(function(){window.addEventListener("load",AOS.refresh),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents().find(".accordeon-block").not(this).slideUp(600).prev(),$(this).next().not(":visible").slideDown(600).prev().parents(),$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active"))}),$(".link-scroll").on("click",function(e){e.preventDefault();var o=$(this).attr("href"),c=$(o).offset().top;$("html, body").animate({scrollTop:c-20},900)})});