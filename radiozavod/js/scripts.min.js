...
function swiperMode(){var e=window.matchMedia("(min-width: 0px) and (max-width: 768px)"),i=window.matchMedia("(min-width: 769px) and (max-width: 1025px)");e.matches?init||(swiper.destroy(),init=!1):i.matches&&(init=!0,swiper=new Swiper(".news-slider",{slidesPerView:3,watchOverflow:!0,loop:!0,spaceBetween:20,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}))}var swiper=new Swiper(".categories-slider",{slidesPerView:5,watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:1,loop:!0},768:{slidesPerView:2,loop:!0},830:{slidesPerView:3,loop:!0},1120:{slidesPerView:4,loop:!0},1260:{slidesPerView:5,loop:!1}}}),swiper=new Swiper(".products-slider",{slidesPerView:1,watchOverflow:!0,loop:!0,effect:"fade",navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),swiper=new Swiper(".about-slider",{slidesPerView:3,watchOverflow:!0,loop:!0,spaceBetween:20,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:1},768:{slidesPerView:2},900:{slidesPerView:3}}}),swiper=Swiper,init=!1;window.addEventListener("load",function(){swiperMode()}),window.addEventListener("resize",function(){swiperMode()}),$(document).ready(function(){$(".header-bar").on("click",function(){$(".header").toggleClass("header-active"),$(".header-search").removeClass("active")}),$(".header-row .search-ico").on("click",function(){$(".header-search").toggleClass("active")}),$(".footer-title").on("click",function(){$(window).outerWidth()<=560&&$(this).parents(".footer-item").toggleClass("active").find(".footer-block").slideToggle()}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var i=$(e.target).attr("href");$(i).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1})});