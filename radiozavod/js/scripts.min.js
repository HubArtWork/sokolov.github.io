...
var swiper = new Swiper('.about-slider', {
  ...
  spaceBetween: 20,
  navigation: {
    nextEl: '.about-all .swiper-button-next',
    prevEl: '.about-all .swiper-button-prev',
  },
  breakpoints: {
  	10: {
      slidesPerView: 1,
...
var swiper = new Swiper('.responsibility-slider', {
  slidesPerView: 1,
  watchOverflow: true,
  loop: true,
  effect: "fade",
...
var element = document.getElementById('news-slider');
      ...
      // Disable (for tablet)
        ...
        if (!init) {
            ...
            swiper = new Swiper('.news-slider', {
              ...
              spaceBetween: 15,
              navigation: {
                nextEl: '.news-all .swiper-button-next',
                prevEl: '.news-all .swiper-button-prev',
              },
            });
        }
      }
...
var swiper = new Swiper('.quality-slider', {
  ...
  spaceBetween: 30,
  navigation: {
    nextEl: '.quality-all .swiper-button-next',
    prevEl: '.quality-all .swiper-button-prev',
  },
  breakpoints: {
    10: {
      slidesPerView: 1,
...
var swiper = new Swiper('.article-slider', {
  ...
  spaceBetween: 20,
  navigation: {
    nextEl: '.article-all .swiper-button-next',
    prevEl: '.article-all .swiper-button-prev',
  },
  breakpoints: {
    10: {
      slidesPerView: 1,
...
var swiper = new Swiper('.areasOfUse-slider', {
  slidesPerView: 3,
  watchOverflow: true,
  loop: true,
  spaceBetween: 25,
  navigation: {
    nextEl: '.areasOfUse-all .swiper-button-next',
    prevEl: '.areasOfUse-all .swiper-button-prev',
  },
  breakpoints: {
    10: {
      slidesPerView: 1,
...
var servicesSwiper = new Swiper("#services-mob-1 .services-slider2", {
  spaceBetween: 10,
  slidesPerView: 3,
  freeMode: true,
...
var servicesSwiper2 = new Swiper("#services-mob-1 .services-slider", {
  spaceBetween: 10,
  thumbs: {
...
var servicesSwiper = new Swiper("#services-mob-2 .services-slider2", {
  spaceBetween: 10,
  slidesPerView: 3,
  freeMode: true,
  watchSlidesVisibility: true,
...
var servicesSwiper2 = new Swiper("#services-mob-2 .services-slider", {
  spaceBetween: 10,
  thumbs: {
    swiper: servicesSwiper,
  },
...
var servicesSwiper = new Swiper("#services-mob-3 .services-slider2", {
  spaceBetween: 10,
  slidesPerView: 3,
  freeMode: true,
  watchSlidesVisibility: true,
...
var servicesSwiper2 = new Swiper("#services-mob-3 .services-slider", {
  spaceBetween: 10,
  thumbs: {
    swiper: servicesSwiper,
  },
...
$(document).ready(function(){
  ...
  //search
  $('.header-row .search-ico').on('click', function(){
	...
	$('.footer-title').on('click', function(){
		if($(window).outerWidth() <= 560){
			$(this).parents('.footer-item').toggleClass('active').find('.footer-block').slideToggle();
		}
	});

  //shareholders
  $('.shareholders-top').on('click', function(){
    $(this).toggleClass('active').next('.shareholders-info').slideToggle();
  });

  //catalog
  $('.catalog-mob, .catalog-sidebar .close-ico').on('click', function(e){
    e.preventDefault();
  ...
  $('.filter-top').on('click', function(){
    $(this).toggleClass('close-block').next('.filter-drop').slideToggle();
  });

  //show
  $('.tab-btn .primary-btn').on('click', function(e){
    e.preventDefault();

    $(this).toggleClass('active').parents('.tab-btn').prev('ol').toggleClass('active');
  });

  //tab-mob
  $('.tab-mob').on('click', function(e){
    e.preventDefault();

    $(this).toggleClass('active').next('.tab-drop').slideToggle();
  });
  ...
  if ($(".aboutUs").length) {
    ...
    $(window).on('scroll', function(){
      if($(window).scrollTop() > ($('.aboutUs-main').height() + 56) && $(window).scrollTop() < ($('.aboutUs').height() - $('.timeline-list').height() - 200)){
        $('.timeline-navwrap').addClass('active').css('right', ($(window).width() - $('.aboutUs-all').width()) / 2 + 'px');
      }
      else{
        $('.timeline-navwrap').removeClass('active');
      }
    });
    ...
    var screenArr = document.querySelectorAll(".timeline-item__observer");
    
    var itemFirstOffset = $(".timeline-item").eq(3).find(".timeline-item__observer").offset(),
        itemLastOffset = $(".timeline-item").eq(23).find(".timeline-item__observer").offset(),
        timelineHeight = itemLastOffset.top - itemFirstOffset.top,
        timelineBoxHeight = $("#timeline-box").height() - $('.timeline-nav').height();

    var screenObserver = new IntersectionObserver((entries) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          
          var item = $('.timeline-nav__item[href="#' + $(entry.target).closest(".timeline-item").attr("id") + '"]'),
            itemOffset = $(entry.target).offset();

            if(itemOffset.top < itemFirstOffset.top) {
              itemOffset.top = itemFirstOffset.top;
              $(".timeline-nav__item-arrow_up").hide();
            } else {
              $(".timeline-nav__item-arrow_up").show();
            }

            if(itemOffset.top > itemLastOffset.top) {
              itemOffset.top = itemLastOffset.top;
              $(".timeline-nav__item-arrow_down").hide();
            } else {
              $(".timeline-nav__item-arrow_down").show();
            }

          var timelinePercent = ((itemOffset.top - itemFirstOffset.top) / timelineHeight),
            timelineBoxOffset = timelineBoxHeight * timelinePercent;
          

          $(".timeline-nav__item").removeClass("js-hightlight");
          $(item).addClass("js-hightlight");

          $("#timeline-box").css("top", '-' + timelineBoxOffset + 'px');
    ...
    //about timeline
    $(".timeline-nav").on("click", ".js-timeline-nav-item", function() {
      var el = $($(this).attr("href")).attr("id");
