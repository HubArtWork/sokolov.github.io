...
$(document).ready(function(){function e(e){return e.id?$('<span class="'+e.element.value+'">'+e.text+"</span>"):e.text}function t(e,t){if(0===e.indexOf("#")&&(e=e.slice(1)),3===e.length&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),6!==e.length)throw new Error("Invalid HEX color.");return.299*parseInt(e.slice(0,2),16)+.587*parseInt(e.slice(2,4),16)+.114*parseInt(e.slice(4,6),16)>186?"#000000":"#FFFFFF"}function i(e){var t=e.files[0];if(-1===t.type.indexOf("image"))return alert("Sorry, the file you uploaded doesn't appear to be an image."),!1;var i=new FileReader;i.onload=function(e){var t=new Image;t.onload=function(){if(t.width<200||t.height<200)return alert("Sorry, the image you uploaded doesn't appear to be large enough."),!1;a(t)},t.src=e.target.result},i.readAsDataURL(t)}function a(e){$(e).attr("id","fullImage"),$("#imageResize").html(e),$("#sectionDragAndDrop").addClass("hidden"),$("#sectionResize").removeClass("hidden");var t=new d("#fullImage",200,200);$("#crop").on("click",function(){var e=t.crop();$("#thumbnail").html(e.img),$("#sectionResize").addClass("hidden"),$("#sectionThumbnail").removeClass("hidden")})}if(0!=$(".payment-slider").length){new Swiper(".payment-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,spaceBetween:30,navigation:{nextEl:".payment-list .swiper-button-next",prevEl:".payment-list .swiper-button-prev"},breakpoints:{10:{spaceBetween:10},768:{spaceBetween:30}}})}if(0!=$("#calendar").length){new FullCalendar.Calendar(document.getElementById("calendar"),{initialView:"dayGridMonthCustom",initialDate:"2020-03-01",duration:{weeks:8},views:{dayGridMonthCustom:{type:"dayGridMonth",fixedWeekCount:!1}}}).render()}$(".drop-top").on("click",function(e){e.preventDefault(),$(this).parents(".drop").hasClass("active")?$(".drop").removeClass("active"):($(".drop").removeClass("active"),$(this).parents(".drop").addClass("active"))}),$(document).on("click",function(e){var t=$(".drop");t.is(e.target)||0!==t.has(e.target).length||$(".drop").removeClass("active")}),$(".header-bar,.sidebar-mob").on("click",function(){$(".page").toggleClass("sidebar-active")}),$(".content-top .pencil-ico").on("click",function(e){e.preventDefault(),$(".content-top").toggleClass("active"),setTimeout(function(){$(".content-top .pencil-input input").focus()},200)}),$(document).on("click",function(e){var t=$(".pencil-input,.content-top .pencil-ico");t.is(e.target)||0!==t.has(e.target).length||$(".content-top").removeClass("active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(e.target).attr("href");if($(t).addClass("tab-active"),$(this).addClass("active"),0!=$("#calendar").length){new FullCalendar.Calendar(document.getElementById("calendar"),{initialView:"dayGridMonthCustom",initialDate:"2020-03-01",duration:{weeks:8},views:{dayGridMonthCustom:{type:"dayGridMonth",fixedWeekCount:!1}}}).render()}}),$(".payment-list a").on("click",function(e){if(e.preventDefault(),$(this).parents(".payment-list").find("a").removeClass("active"),$(this).parents(".payment").find(".payment-block").removeClass("active"),!$(e.target).hasClass("close-ico")){var t=$(this).attr("href");$(t).addClass("active"),$(this).addClass("active")}}),$(".method-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".method-list").find("a").removeClass("active"),$(this).parents(".method").find(".method-block").removeClass("active");var t=$(e.target).attr("href");$(t).addClass("active"),$(this).addClass("active")}),$(".recipients-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".recipients-list").find("a").removeClass("active"),$(this).parents(".recipients").find(".recipients-block").removeClass("active");var t=$(this).attr("href");$(t).addClass("active"),$(this).addClass("active")}),$(".modal-bg, .formModal .close-ico,.modal-btn").on("click",function(){$(".modal-bg, .formModal").removeClass("modal-open")}),$(".modal-btn").on("click",function(e){e.preventDefault();var t=$(this).attr("href");$(t).addClass("modal-open"),$(".modal-bg").addClass("modal-open")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".select").on("click",function(e){if(!$(this).hasClass("select-hid"))if($(this).hasClass("active")){var t=e.target,i=$(this).find(".select-text"),a=$(this).find(".select-value");"LI"==t.tagName?($(i).text($(t).text()),$(a).val($(t).text())):"A"==t.tagName&&(e.preventDefault(),$(i).html($(t).html()),$(a).val($(t).text())),$(this).removeClass("active")}else $(".select").removeClass("active"),$(this).addClass("active")}),$(document).on("click",function(e){var t=$(".select");t.is(e.target)||0!==t.has(e.target).length||$(".select").removeClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1});var n=$(".select-second").html();if($(".pricing-wrap-1 .select-main,.pricing-wrap-1 .select-second,.pricing-wrap-2 .select-main,.pricing-wrap-2 .select-second").on("change",function(){"product-1"==$(this).val()&&$(this).parents(".pricing-wrap").removeClass("range-notActive")}),$(".pricing-selects .select-main").on("change",function(){var e=this.value,t=$(this).parents(".pricing-selects").find(".select-second");$(t).html(n),$(t).find("option[value="+e+"]").remove()}),$(".pricing-selects .select-second").on("change",function(){if(!$(this).parents(".pricing-wrap").hasClass("priceChange")){var e=$(this).parents(".pricing-wrap"),t=$(e).find(".pricing-price b"),i=parseInt($(t).text());$(t).text(i+19),$(e).addClass("priceChange")}}),0!=$("#range-1").length){var o=($("#range-1-text"),parseInt($("#range-1").parents(".pricing-range").attr("data-step"))),s=parseInt($("#range-1-text").text());$("#range-1").slider({range:"min",value:1e4,min:1e4,step:o,max:1e5,slide:function(e,t){$("#range-1").parents(".pricing-wrap").hasClass("priceChange")?$("#range-1-text").text(s+19+(t.value-1e4)/o*10):$("#range-1-text").text(s+(t.value-1e4)/o*10),$(this).parents(".pricing-range").find("p").find("span").text(t.value.toLocaleString())}}),$(this).parents(".pricing-range").find("p").find("span").text($("#range-1").slider("value"))}if(0!=$("#range-2").length){var l=$("#range-2-text"),c=parseInt($("#range-2").parents(".pricing-range").attr("data-step")),r=parseInt($(l).text());$("#range-2").slider({range:"min",value:1e4,min:1e4,step:c,max:1e5,slide:function(e,t){$("#range-2-text").text(r+(t.value-1e4)/o*10),$(this).parents(".pricing-range").find("p").find("span").text(t.value.toLocaleString())}}),$(this).parents(".pricing-range").find("p").find("span").text($("#range-2").slider("value"))}if(0!=$(".mySelect").length&&$(".mySelect").select2({placeholder:"Email address or name"}),0!=$(".select-second").length&&$(".select-second").select2({placeholder:"Additional products (optional)"}),0!=$(".js-example-basic-multiple").length&&$(".js-example-basic-multiple").select2({placeholder:"Select services (optional)"}),0!=$(".select-category").length&&$(".select-category").select2({placeholder:"Category"}),0!=$(".js-example-basic-single").length&&$(".js-example-basic-single").select2({placeholder:"Rate"}),0!=$(".blockFix-select").length&&$(".blockFix-select").select2({placeholder:"Save"}),0!=$(".booking").length&&$(".booking select").select2(),$(".sidebar").mouseover(function(){$(window).outerWidth()<=1600&&$(".content").addClass("pad-active")}).mouseout(function(){$(window).outerWidth()<=1600&&$(".content").removeClass("pad-active")}),$(".animation-btn").on("click",function(e){e.preventDefault(),$(".emailCustomer-img").addClass("active")}),$(".pipeline-history__add").on("click",function(){$(".pipeline-history__form").slideToggle()}),$(".pipeline-history__item").on("click",function(){$(this).toggleClass("active")}),$(".select").length>0&&$(".select-color select").select2({minimumResultsForSearch:1/0,placeholder:"Color",templateResult:e,templateSelection:e}),0!=$(".droppable-area1").length&&function(){$(".droppable-area1, .droppable-area2").sortable({connectWith:".pipeline-content",stack:".pipeline-content .pipeline-content"}).disableSelection()}(),$(".steps-item .steps-btn").on("click",function(e){e.preventDefault(),$(this).parent(".steps-item").toggleClass("active")}),$(document).on("input",".addCategory-input",function(){$(this).val().length>2?$(".addCategory").addClass("addCategory-active"):$(".addCategory").removeClass("addCategory-active")}),$(".addCategory-btn .second-btn").on("click",function(e){return e.preventDefault(),$(".addCategory-block").append("<div class='addCategory-item'><div class='input-block'><input class='addCategory-input' type='text' name='text' placeholder='Category'></div><div class='input-block'><select name='text'><option value=''>Select services (optional)</option><option value=''>Select services (optional)</option></select></div><div class='txt-btn'><a href='#'>cancel</a></div></div>"),!1}),$(".addCategory-item .primary-btn").on("click",function(e){e.preventDefault(),$(this).parent().remove()}),$(".btn-show").on("click",function(){var e=$(this).parents(".input-block");$(e).hasClass("active")?($(this).text("Show"),$(e).removeClass("active").find("input").attr("type","password")):($(this).text("Hide"),$(e).addClass("active").find("input").attr("type","text"))}),$(".dots-ico.dots-ico-mob").on("click",function(){$(this).parents("td").find(".table-drop.drop").addClass("open")}),$(".table-drop.drop, .table-drop.drop .drop-info").on("click",function(){$(".table-drop.drop").removeClass("open")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1,beforeShow:function(){$("html").css({"overflow-y":"hidden"})},afterClose:function(){$("html").css({"overflow-y":"visible"})}}),0!=$(".dataTable").length&&$(".dataTable").DataTable(),$(".checkbox-partial input").on("click",function(){var e=$(this).parents(".blockFix");$(this).is(":checked")?e.addClass("active"):e.removeClass("active")}),$("#uploadFile").on("change",function(){var e=this.files?this.files:[];if(e.length&&window.FileReader&&/^image/.test(e[0].type)){var t=new FileReader;t.readAsDataURL(e[0]),t.onloadend=function(){$("#imagePreview").css("background-image","url("+this.result+")")}}}),$(".file__input--file").on("change",function(e){for(var t=e.target.files,i=0;i<t.length;i++){var a=t[i];$("<div class='file__value'><div class='file__value--text'>"+a.name+"</div><div class='close-ico hb-ico' data-id='"+a.name+"' ></div></div>").insertBefore("#file__input")}}),$("body").on("click",".file__value",function(){$(this).remove()}),$(".color input").change(function(){var e=$(this).val(),i=t(e);console.log(e),console.log(i),$(".modalTemplate .invoices-wrap,.modalTemplate-content,.invoices-wrap__text").css("border-color",e),$(".invoices-wrap__amount-bottom,.invoices-wrap__table-top,.invoices-wrap__table-top .invoices-wrap__table-col,.modalTemplate .invoices-wrap__total ul li:last-child,.modalTemplate-head,.modalTemplate-col-main").css("background-color",e),$(".invoices-wrap__amount-bottom,.modalTemplate .invoices-wrap__table-top .invoices-wrap__table-col,.modalTemplate .invoices-wrap__total ul li:last-child,.modalTemplate-head__title,.modalTemplate-head__row ul li,.modalTemplate-head .invoices-wrap__descr h3,.modalTemplate-head__row ul li,.modalTemplate-col-main b,.modalTemplate-col-main span").css("color",i)}),0!=$("#sectionResize").length){$("#drop").on("click",function(){$("#fileUpload").trigger("click")}),$("#fileUpload").on("change",function(e){i(e.target)}),$("#drop").on("dragover",function(e){e.preventDefault(),e.stopPropagation(),$(this).addClass("dragging")}),$("#drop").on("dragleave",function(e){$(this).removeClass("dragging")}),$("#drop").on("drop",function(e){e.preventDefault(),e.stopPropagation(),i(e.dataTransfer||e.originalEvent.dataTransfer)});var d=function(e,t,i){function a(e){e.preventDefault(),e.stopPropagation(),k(e),m.on("mousemove touchmove",o),m.on("mouseup touchend",n)}function n(e){e.preventDefault(),m.off("mouseup touchend",n),m.off("mousemove touchmove",o)}function o(e){var a,n,o,s,l={},c=d.outerWidth(),h=d.outerHeight(),u=d.position();l.x=(e.clientX||e.pageX||e.originalEvent.touches[0].clientX)+$(window).scrollLeft(),l.y=(e.clientY||e.pageY||e.originalEvent.touches[0].clientY)+$(window).scrollTop();var v=!1,m=!1,w=!1,y=!1;$(C.evnt.target).is("#icResizeHandleSE")?v=!0:$(C.evnt.target).is("#icResizeHandleSW")?m=!0:$(C.evnt.target).is("#icResizeHandleNW")?w=!0:$(C.evnt.target).is("#icResizeHandleNE")&&(y=!0),v?(a=l.x-C.containerLeft-p.offset().left,n=a/t*i,o=C.containerLeft,s=C.containerTop):m?(a=C.containerWidth-(l.x-C.containerLeft-p.offset().left),n=a/t*i,o=l.x-p.offset().left,s=C.containerTop):w?(a=C.containerWidth-(l.x-C.containerLeft-p.offset().left),n=a/t*i,o=l.x-p.offset().left,s=u.top+h-n):y&&(a=l.x-C.containerLeft-p.offset().left,n=a/t*i,o=C.containerLeft,s=u.top+h-n),s>=0&&o>=0&&Math.round(s+n)<=Math.round(p.height())&&Math.round(o+a)<=Math.round(p.width())&&(b=!0),b&&(s<0?(n=h+u.top,a=n/i*t,s=0,w&&(o=u.left-(a-c)),b=!1):o<0?(a=c+u.left,n=a/t*i,o=0,v&&(s=u.top-(n-h)),b=!1):Math.round(s+n)>Math.round(p.height())?(n=p.height()-s,a=n/i*t,m&&(o=u.left-(a-c)),b=!1):Math.round(o+a)>Math.round(p.width())&&(a=p.width()-o,n=a/t*i,y&&(s=u.top-(n-h)),b=!1),a>g&&n>f?(d.outerWidth(a).outerHeight(n),d.css({left:o,top:s})):((m||w)&&(o-=g-a),(w||y)&&(s-=f-n),d.outerWidth(g).outerHeight(f),d.css({left:o,top:s}))),r()}function s(e){e.preventDefault(),e.stopPropagation(),k(e),m.on("mousemove touchmove",c),m.on("mouseup touchend",l)}function l(e){e.preventDefault(),m.off("mouseup touchend",l),m.off("mousemove touchmove",c)}function c(e){var t,i,a,n={};e.preventDefault(),e.stopPropagation(),a=e.originalEvent.touches,n.x=(e.clientX||e.pageX||a[0].clientX)+$(window).scrollLeft(),n.y=(e.clientY||e.pageY||a[0].clientY)+$(window).scrollTop(),t=n.y-(C.mouseY-C.containerTop),i=n.x-(C.mouseX-C.containerLeft),t<0&&(t=0),t+d.outerHeight()>p.height()&&(t=p.height()-d[0].getBoundingClientRect().height),i<0&&(i=0),i+d.outerWidth()>p.width()&&(i=p.width()-d[0].getBoundingClientRect().width),d.css({top:t,left:i}),r()}function r(){var e=p[0].getBoundingClientRect().width,t=(p[0].getBoundingClientRect().height,d.position().top),i=d.position().left,a=d[0].getBoundingClientRect().width,n=d[0].getBoundingClientRect().height;parseFloat(d.css("border-top-width"));$("#icOverlayN").css({right:e-i-a,height:t,left:i}),$("#icOverlayE").css({left:i+a}),$("#icOverlayS").css({right:e-i-a,top:t+n,left:i}),$("#icOverlayW").css({width:i})}var d,p,h,u,v,g,f,m=$(document),w=new Image,e=$(e).get(0),C={},b=!0,y=!1,x=new $.Deferred;w.crossOrigin="Anonymous",document.addEventListener("keydown",function(e){var t,i,a,t=d.position().top,i=d.position().left;a=e.shiftKey?10:1,37===e.keyCode?i-=a:38===e.keyCode?t-=a:39===e.keyCode?i+=a:40===e.keyCode&&(t+=a),t<0&&(t=0),t+d.outerHeight()>p.height()&&(t=p.height()-d[0].getBoundingClientRect().width),i<0&&(i=0),i+d.outerWidth()>p.width()&&(i=p.width()-d[0].getBoundingClientRect().width),y&&(d.css({top:t,left:i}),r())}),m.click(function(e){y=!!$(e.target).closest(".ic-container").length});var k=function(e){C.containerWidth=d.outerWidth(),C.containerHeight=d.outerHeight(),C.containerLeft=d.position().left,C.containerTop=d.position().top,C.mouseX=(e.clientX||e.pageX||e.originalEvent.touches[0].clientX)+$(window).scrollLeft(),C.mouseY=(e.clientY||e.pageY||e.originalEvent.touches[0].clientY)+$(window).scrollTop(),C.evnt=e},_=function(){v>u?(d.outerWidth(p.width()),d.outerHeight(d.outerWidth()/t*i),d.css({top:(p.height()-d.height())/2+"px",left:0})):(d.outerHeight(p.height()),d.outerWidth(d.outerHeight()/i*t),d.css({left:(p.width()-d.width())/2+"px",top:0}))};this.crop=function(){var e,a=new Image,n=w.width/p.width(),o=Math.round(d.position().left*n),s=Math.round(d.position().top*n),l=Math.round(d.outerWidth()*n),c=Math.round(d.outerHeight()*n);e=document.createElement("canvas"),e.width=t,e.height=i,e.getContext("2d").drawImage(w,o,s,l,c,0,0,t,i),a.src=e.toDataURL();var r={img:a,left:o,top:s,width:l,height:c,requiredWidth:t,requiredHeight:i};return r},this.position=function(e,t,i,a){$.when(x).done(function(){var n=w.width/p.width();e=Math.round(e/n),t=Math.round(t/n),i=Math.round(i/n),a=Math.round(a/n),d.outerWidth(i).outerHeight(a),d.css({left:e,top:t}),r()})},this.cropReset=function(){_(),r()},$(window).resize(function(){h=w.width/p.width(),g=t/h,f=i/h,_(),r()}),function(){w.onload=function(){if(w.width<t||w.height<i)return console.log("Image Crop error: The required dimensions are larger than the target image."),!1;$(e).wrap('<div class="ic-container"></div>').before('\t\t                <div class="ic-overlay-n" id="icOverlayN"></div>\t\t                <div class="ic-overlay-e" id="icOverlayE"></div>\t\t                <div class="ic-overlay-s" id="icOverlayS"></div>\t\t                <div class="ic-overlay-w" id="icOverlayW"></div>\t\t                <div class="ic-crop-marker" id="icCropMarker">\t\t                    <div class="ic-resize-handle-nw" id="icResizeHandleNW"></div>\t\t                    <div class="ic-resize-handle-ne" id="icResizeHandleNE"></div>\t\t                    <div class="ic-resize-handle-sw" id="icResizeHandleSW"></div>\t\t                    <div class="ic-resize-handle-se" id="icResizeHandleSE"></div>\t\t                    <div class="ic-move-handle" id="icMoveHandle"></div>\t\t                </div>\t\t            '),d=$("#icCropMarker"),p=$(e),h=w.width/p.width(),u=w.width/w.height,v=t/i,g=t/h,f=i/h,_(),r(),d.on("mousedown touchstart",a),d.on("mousedown touchstart","#icMoveHandle",s),x.resolve()},w.src=e.src}()};if($("#exampleImage").length)var p=new d("#exampleImage",200,200);$("#exampleCrop").on("click",function(){var e=p.crop();$("body").html(e.img)})}$(".customer-notes-info").on("click",function(){$(this).parents(".customer-notes-item").toggleClass("active")}),$(".details-checkbox input").on("click",function(){$(this).parents(".details-checkbox");$(this).is(":checked")?$(".details-address").removeClass("active"):$(".details-address").addClass("active")}),$(".scroll-links").on("click","a",function(e){e.preventDefault();var t=$(this).attr("href"),i=$(t).offset().top;$("html, body").animate({scrollTop:i-20},500)})});