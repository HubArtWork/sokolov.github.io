...
var swiper=new Swiper(".popular-slider",{slidesPerView:"auto",watchSlidesVisibility:!0,watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}});$(document).ready(function(){$("#input-data1").datetimepicker({inline:!0}),$("#input-data2").datetimepicker(),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".tab-list li a").on("click",function(t){t.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var e=$(t.target).attr("href");$(e).addClass("tab-active"),$(this).addClass("active")}),$(".reservation .radio input").on("click",function(){var t=$(this).attr("data-reservation");$(this).parents(".reservation-col").find(".input-item").removeClass("active"),$(this).parents(".reservation-col").find("#"+t).addClass("active")})});