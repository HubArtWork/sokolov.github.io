...
var swiper=new Swiper(".main-slider",{slidesPerView:5,freeMode:!0,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:13,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:1},500:{slidesPerView:2},769:{slidesPerView:3},970:{slidesPerView:4},1100:{slidesPerView:5}}});$(document).ready(function(){$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var a=$(e.target).attr("href");$(a).addClass("tab-active"),$(this).addClass("active"),$(window).outerWidth()<=520&&($(this).parents(".allTabs").find(".tab").removeClass("tab-open"),$(a).addClass("tab-open"))}),$(".tab .close-ico").on("click",function(){$(this).parents(".tab").toggleClass("tab-open")}),$(".personalArea-info,.personalArea-block .close-ico").on("click",function(e){e.preventDefault(),$(".personalArea-block").toggleClass("active")}),$(".main-share-link").on("click",function(){$(".main-share").toggleClass("active")}),$(document).on("click",function(e){var a=$(".main-share");a.is(e.target)||0!==a.has(e.target).length||$(".main-share").removeClass("active")}),$(".input-password .eye-ico").on("click",function(){$(this).parents(".input-wrap").hasClass("active")?$(this).parents(".input-wrap").removeClass("active").find("input").attr("type","password"):$(this).parents(".input-wrap").addClass("active").find("input").attr("type","text")}),$(".search-drop-top").on("click",function(){$(window).outerWidth()<=768?$(this).parents(".search-drop").hasClass("active")?($(".search-bg").removeClass("active"),$(".search-drop").removeClass("active")):($(".search-bg").addClass("active"),$(".search-drop").removeClass("active"),$(this).parents(".search-drop").addClass("active")):$(this).parents(".search-drop").toggleClass("active")}),$(".search-drop-date span").on("click",function(){$(".search-drop-date").toggleClass("open")}),$(document).on("click",function(e){var a=$(".search-drop-date");a.is(e.target)||0!==a.has(e.target).length||$(".search-drop-date").removeClass("open")}),$(".search-bg").on("click",function(){$(".search-drop").removeClass("active"),$(".search-bg").removeClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}})});