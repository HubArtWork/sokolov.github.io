...
AOS.init({startEvent:"load"}),$(document).ready(function(){function e(){$(".howItWorks").hasClass("howItWorks-1")?($(".howItWorks").removeClass("howItWorks-1 howItWorks-2 howItWorks-3").addClass("howItWorks-2"),l[0].src=$(".howItWorks-block-1").attr("data-video"),n.load()):$(".howItWorks").hasClass("howItWorks-2")?($(".howItWorks").removeClass("howItWorks-1 howItWorks-2 howItWorks-3").addClass("howItWorks-3"),l[0].src=$(".howItWorks-block-2").attr("data-video"),n.load()):$(".howItWorks").hasClass("howItWorks-3")&&($(".howItWorks").removeClass("howItWorks-1 howItWorks-2 howItWorks-3").addClass("howItWorks-1"),l[0].src=$(".howItWorks-block-3").attr("data-video"),n.load())}function t(){r=setInterval(function(){e()},3e4)}function i(){clearInterval(r)}function o(){var e=window.matchMedia("(min-width: 0px) and (max-width: 768px)");window.matchMedia("(min-width: 769px) and (max-width: 1024px)"),window.matchMedia("(min-width: 1025px)");e.matches&&(d||(d=!0,$(".howItWorks").removeClass("howItWorks-1 howItWorks-2 howItWorks-3"),s=new Swiper(".howItWorks-slider",{slidesPerView:"auto",watchSlidesVisibility:!0,watchOverflow:!0,slideToClickedSlide:!0,autoplay:{delay:3e4,disableOnInteraction:!1},on:{slideNextTransitionEnd:function(e){var t=e.slides[e.activeIndex],i=$(t).find(".howItWorks-block").attr("data-video");l[0].src=i,n.load(),console.log("vid:",i)},slideChange:function(e){console.log("CurrentActive2:",e.activeIndex)}}})))}function a(){var e=window.matchMedia("(min-width: 0px) and (max-width: 768px)");window.matchMedia("(min-width: 769px) and (max-width: 1024px)"),window.matchMedia("(min-width: 1025px)");e.matches&&(w||(w=!0,c=new Swiper(".pricing-slider",{slidesPerView:"auto",watchSlidesVisibility:!0,watchOverflow:!0,slideToClickedSlide:!0})))}window.addEventListener("load",AOS.refresh);var s=new Swiper(".features-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,autoplay:{delay:3e4,disableOnInteraction:!1},pagination:{el:".swiper-pagination",clickable:!0,renderBullet:function(e,t){return'<span class="'+t+'"><svg class="circle-chart" viewbox="0 0 33.83098862 33.83098862" width="60" height="60" xmlns="http://www.w3.org/2000/svg"><circle class="circle-chart__background" stroke="#000" stroke-width="0.5" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" style="stroke-opacity: .3;"/><circle class="circle-chart__circle" stroke="#FF7F57" stroke-width="1" stroke-dasharray="100,100" stroke-linecap="round" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" /></svg></span>'}}}),s=new Swiper(".testimonials-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,autoplay:{delay:3e4,disableOnInteraction:!1},pagination:{el:".testimonials .swiper-pagination",clickable:!0,renderBullet:function(e,t){return'<span class="'+t+'"><svg class="circle-chart" viewbox="0 0 33.83098862 33.83098862" width="60" height="60" xmlns="http://www.w3.org/2000/svg"><circle class="circle-chart__background" stroke="#000" stroke-width="0.5" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" style="stroke-opacity: .3;"/><circle class="circle-chart__circle" stroke="#8C88A3" stroke-width="1" stroke-dasharray="100,100" stroke-linecap="round" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" /></svg></span>'}},breakpoints:{10:{slidesPerView:"auto"},769:{slidesPerView:1}}}),r=null,n=$(".howItWorks video")[0],l=n.getElementsByTagName("source");if($(window).outerWidth()>769&&($(".howItWorks-block").on("click",function(){var e=$(this).attr("data-block"),o=$(this).attr("data-video");$(".howItWorks").removeClass("howItWorks-1 howItWorks-2 howItWorks-3").addClass(e),l[0].src=o,n.load(),i(),t()}),t()),$(".howItWorks-slider").length>0){var s=Swiper,d=!1;window.addEventListener("load",function(){o()}),window.addEventListener("resize",function(){o()})}if($(".pricing-slider").length>0){var c=Swiper,w=!1;window.addEventListener("load",function(){a()}),window.addEventListener("resize",function(){a()})}$(".menu li").on("click","a",function(e){e.preventDefault();var t=$(this).attr("href"),i=$(t).offset().top;$("html, body").animate({scrollTop:i-$(".header").outerHeight()},900),$(".header").removeClass("header-active"),$(".menu").slideToggle()}),$(".header-bar,.header-close").on("click",function(){$(".header").toggleClass("header-active"),$(".menu").slideToggle()}),$(".footer-tit").on("click",function(){$(this).toggleClass("active").next(".footer-block").slideToggle()}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(this).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".advantage-mob .second-btn").on("click",function(e){e.preventDefault(),$(this).parents(".tab").addClass("open")})});