...
$(document).ready(function(){if($(".about-slider").length){new Swiper(".about-slider",{slidesPerView:1,watchOverflow:!0,autoHeight:!0,loop:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}})}if($(".services-slider").length&&$(window).outerWidth()<961){new Swiper(".services-slider",{slidesPerView:3,watchOverflow:!0,spaceBetween:20,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},600:{slidesPerView:2},820:{slidesPerView:3}}})}if($(".specialist-slider").length){new Swiper(".specialist-slider",{slidesPerView:3,watchOverflow:!0,spaceBetween:60,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},769:{slidesPerView:2},1400:{slidesPerView:3}}})}if($(".testimonials-slider").length){new Swiper(".testimonials-slider",{slidesPerView:1,watchOverflow:!0,autoHeight:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}})}if($(".plans-slider").length){new Swiper(".plans-slider",{slidesPerView:3,watchOverflow:!0,spaceBetween:20,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:1},769:{slidesPerView:2},1451:{slidesPerView:3}}})}$(".main-arrow , .scroll-link , .header-list li a , .footer-list li a").on("click",function(e){e.preventDefault();var i=$(this).attr("href"),t=$(i).offset().top;$("html, body").animate({scrollTop:t},900),$(".header").removeClass("header-active")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".services-wrap .border-btn").on("click",function(e){e.preventDefault(),$(this).hasClass("active")?$(this).removeClass("active").text("Показать всё").parents(".services-wrap").find("ul").slideUp():$(this).addClass("active").text("Скрыть всё").parents(".services-wrap").find("ul").slideDown()})});