...
var swiper=new Swiper(".collections-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:30,navigation:{nextEl:".collections-all .swiper-button-next",prevEl:".collections-all .swiper-button-prev"},breakpoints:{10:{spaceBetween:22},581:{spaceBetween:30}}}),galleryThumbs=new Swiper(".post-thumbs",{spaceBetween:17,slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,watchSlidesProgress:!0,breakpoints:{10:{spaceBetween:5},581:{spaceBetween:8},921:{spaceBetween:14}}}),galleryTop=new Swiper(".post-slider",{effect:"fade",thumbs:{swiper:galleryThumbs},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),galleryThumbs2=new Swiper(".about-thumbs",{spaceBetween:10,slidesPerView:3,freeMode:!0,watchSlidesVisibility:!0,watchSlidesProgress:!0,direction:"vertical"}),galleryTop2=new Swiper(".about-slider",{effect:"fade",spaceBetween:10,thumbs:{swiper:galleryThumbs2}}),swiper=new Swiper(".card-images__list",{slidesPerView:3,watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:1},721:{slidesPerView:3}}}),swiper=new Swiper(".suitable-slider",{effect:"fade",loop:!0,navigation:{nextEl:".suitable-slider .swiper-button-next",prevEl:".suitable-slider .swiper-button-prev"}});$(document).ready(function(){if($(window).on("scroll",function(){$(this).scrollTop()>0?$(".header").addClass("header-fixed").removeClass("header-active"):$(".header").removeClass("header-fixed")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".drop-text").on("click",function(e){e.preventDefault(),$(this).parents(".drop").toggleClass("active").find("ul").slideToggle()}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).closest(".tab-list").find("a").removeClass("active"),$(this).closest(".allTabs").find(".tab").removeClass("tab-active");var t=$(this).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".select").on("click",function(e){if(!$(this).hasClass("select-hid"))if($(this).hasClass("active")){var t=e.target,s=$(this).find(".select-text"),a=$(this).find(".select-value");"LI"==t.tagName?($(s).text($(t).text()),$(a).val($(t).text())):"A"==t.tagName&&(e.preventDefault(),$(s).html($(t).html()),$(a).val($(t).text())),$(this).removeClass("active")}else $(".select").removeClass("active"),$(this).addClass("active")}),$(document).on("click",function(e){var t=$(".select");t.is(e.target)||0!==t.has(e.target).length||$(".select").removeClass("active")}),$(".search-filter, .search-mob .close-ico").on("click",function(e){$(".search").hasClass("active")?($(".search").removeClass("active"),$(this).hasClass("search-filter")&&$(this).find("span").text("Фильтр")):($(".search").addClass("active"),$(this).hasClass("search-filter")&&$(this).find("span").text("Скрыть фильтр"))}),0!=$("#range-1").length&&$("#range-1").slider({range:!0,min:2e3,max:2e7,step:500,values:[2e3,14e6],slide:function(e,t){var s=t.values[0],a=t.values[1];$(this).parents(".fromTo").find(".fromTo-1").val(s),$(this).parents(".fromTo").find(".fromTo-2").val(a)}}),0!=$("#range-2").length&&$("#range-2").slider({range:!0,min:2e3,max:2e7,step:500,values:[2e3,14e6],slide:function(e,t){var s=t.values[0],a=t.values[1];$(this).parents(".fromTo").find(".fromTo-1").val(s),$(this).parents(".fromTo").find(".fromTo-2").val(a)}}),0!=$("#range-3").length&&$("#range-3").slider({range:!0,min:2e3,max:2e7,step:500,values:[2e3,14e6],slide:function(e,t){var s=t.values[0],a=t.values[1];$(this).parents(".fromTo").find(".fromTo-1").val(s),$(this).parents(".fromTo").find(".fromTo-2").val(a)}}),0!=$("#range-4").length&&$("#range-4").slider({range:!0,min:2e3,max:2e7,step:500,values:[2e3,14e6],slide:function(e,t){var s=t.values[0],a=t.values[1];$(this).parents(".fromTo").find(".fromTo-1").val(s),$(this).parents(".fromTo").find(".fromTo-2").val(a)}}),0!=$("#range-5").length&&$("#range-5").slider({range:!0,min:2e3,max:2e7,step:500,values:[2e3,14e6],slide:function(e,t){var s=t.values[0],a=t.values[1];$(this).parents(".fromTo").find(".fromTo-1").val(s),$(this).parents(".fromTo").find(".fromTo-2").val(a)}}),0!=$("#range-6").length&&$("#range-6").slider({range:!0,min:2e3,max:2e7,step:500,values:[2e3,14e6],slide:function(e,t){var s=t.values[0],a=t.values[1];$(this).parents(".fromTo").find(".fromTo-1").val(s),$(this).parents(".fromTo").find(".fromTo-2").val(a)}}),0!=$("#range-7").length&&$("#range-7").slider({range:!0,min:2e3,max:2e7,step:500,values:[2e3,14e6],slide:function(e,t){var s=t.values[0],a=t.values[1];$(this).parents(".fromTo").find(".fromTo-1").val(s),$(this).parents(".fromTo").find(".fromTo-2").val(a)}}),0!=$("#range-8").length&&$("#range-8").slider({range:!0,min:2e3,max:2e7,step:500,values:[2e3,14e6],slide:function(e,t){var s=t.values[0],a=t.values[1];$(this).parents(".fromTo").find(".fromTo-1").val(s),$(this).parents(".fromTo").find(".fromTo-2").val(a)}}),0!=$("#range-9").length&&$("#range-9").slider({range:!0,min:2e3,max:2e7,step:500,values:[2e3,14e6],slide:function(e,t){var s=t.values[0],a=t.values[1];$(this).parents(".fromTo").find(".fromTo-1").val(s),$(this).parents(".fromTo").find(".fromTo-2").val(a)}}),0!=$("#range-10").length&&$("#range-10").slider({range:!0,min:2e3,max:2e7,step:500,values:[2e3,14e6],slide:function(e,t){var s=t.values[0],a=t.values[1];$(this).parents(".fromTo").find(".fromTo-1").val(s),$(this).parents(".fromTo").find(".fromTo-2").val(a)}}),0!=$("#range-11").length&&$("#range-11").slider({range:!0,min:2e3,max:2e7,step:500,values:[2e3,14e6],slide:function(e,t){var s=t.values[0],a=t.values[1];$(this).parents(".fromTo").find(".fromTo-1").val(s),$(this).parents(".fromTo").find(".fromTo-2").val(a)}}),0!=$(".datepicker").length&&$(".datepicker").datepicker(),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),0!=$("#statistics1").length){var e=new ProgressBar.Circle(statistics1,{color:"#fff",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#73C84C",width:5},to:{color:"#73C84C",width:5},step:function(e,t){t.path.setAttribute("stroke",e.color),t.path.setAttribute("stroke-width",e.width);var s=Math.round(t.value()*$("#statistics1-1").text());0===s?t.setText(""):t.setText(s+"%")}});e.text.style.fontFamily='"Manrope", Helvetica, sans-serif',e.text.style.fontSize="24px",e.animate($("#statistics-1").text(),{duration:1500})}if(0!=$("#statistics2").length){var e=new ProgressBar.Circle(statistics2,{color:"#fff",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFC42E",width:5},to:{color:"#FFC42E",width:5},step:function(e,t){t.path.setAttribute("stroke",e.color),t.path.setAttribute("stroke-width",e.width);var s=Math.round(t.value()*$("#statistics2-2").text());0===s?t.setText(""):t.setText(s+"%")}});e.text.style.fontFamily='"Manrope", Helvetica, sans-serif',e.text.style.fontSize="24px",e.animate($("#statistics-2").text(),{duration:1500})}if(0!=$("#statistics3").length){var e=new ProgressBar.Circle(statistics3,{color:"#fff",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#EC462F",width:5},to:{color:"#EC462F",width:5},step:function(e,t){t.path.setAttribute("stroke",e.color),t.path.setAttribute("stroke-width",e.width);var s=Math.round(t.value()*$("#statistics3-3").text());0===s?t.setText(""):t.setText(s)}});e.text.style.fontFamily='"Manrope", Helvetica, sans-serif',e.text.style.fontSize="24px",e.animate($("#statistics-3").text(),{duration:1500})}if(0!=$("#statistics4").length){var e=new ProgressBar.Circle(statistics4,{color:"#fff",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#8862F1",width:5},to:{color:"#8862F1",width:5},step:function(e,t){t.path.setAttribute("stroke",e.color),t.path.setAttribute("stroke-width",e.width);var s=Math.round(t.value()*$("#statistics4-4").text());0===s?t.setText(""):t.setText(s)}});e.text.style.fontFamily='"Manrope", Helvetica, sans-serif',e.text.style.fontSize="24px",e.animate($("#statistics-4").text(),{duration:1500})}});