...
$(document).ready(function(){if($(".drop-top").on("click",function(e){e.preventDefault(),$(this).parents(".drop").toggleClass("active")}),$(document).on("click",function(e){var t=$(".drop");t.is(e.target)||0!==t.has(e.target).length||$(".drop").removeClass("active")}),$(".link-store").on("click",function(e){e.preventDefault(),$(".header,.store").toggleClass("active")}),$(document).on("click",function(e){var t=$(".link-store,.store");t.is(e.target)||0!==t.has(e.target).length||$(".header,.store").removeClass("active")}),$(".header-actions-link.basket-ico").on("click",function(e){e.preventDefault(),$(".header-basket").toggleClass("active")}),$(document).on("click",function(e){var t=$(".header-actions-link.basket-ico,.header-basket");t.is(e.target)||0!==t.has(e.target).length||$(".header-basket").removeClass("active")}),$(".header-actions-link.search-ico, .header-search .close-ico").on("click",function(e){e.preventDefault(),$(".header-search").toggleClass("active")}),$(".bar-ico").on("click",function(e){e.preventDefault(),$(".menu").toggleClass("active")}),$(document).on("click",function(e){var t=$(".menu,.bar-ico");t.is(e.target)||0!==t.has(e.target).length||$(".menu").removeClass("active")}),$(".menu-next,.menu-back").on("click",function(e){e.preventDefault(),$(".menu-drop").toggleClass("active")}),$(".products-slider").length)var e=new Swiper(".products-slider",{slidesPerView:1,watchOverflow:!0,autoHeight:!0,navigation:{nextEl:".products .swiper-button-next",prevEl:".products .swiper-button-prev"}});if($(".sellers-slider").length)var e=new Swiper(".sellers-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:30,scrollbar:{el:".swiper-scrollbar",hide:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:1,spaceBetween:20},768:{slidesPerView:"auto",spaceBetween:30}}});if($(".testimonials-slider").length)var e=new Swiper(".testimonials-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:20,autoHeight:!1,scrollbar:{el:".swiper-scrollbar",hide:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:1,autoHeight:!0},550:{slidesPerView:"auto",autoHeight:!1}}});if($(".inst-slider").length)var e=new Swiper(".inst-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:20,scrollbar:{el:".swiper-scrollbar",hide:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:1},550:{slidesPerView:"auto"}}});if($(".card-mob").length){var e=new Swiper(".mySwiper",{spaceBetween:10,slidesPerView:3,freeMode:!0,watchSlidesProgress:!0});new Swiper(".mySwiper2",{spaceBetween:10,thumbs:{swiper:e}})}if($(".about-slider").length)var e=new Swiper(".about-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:25,scrollbar:{el:".swiper-scrollbar",hide:!0}});$(".about-item-mob").on("click",function(e){e.preventDefault(),$(this).parents(".about-item").toggleClass("active").find(".about-item-row").slideToggle()}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}})});