...
$(function(){AOS.init()}),$(document).ready(function(){window.addEventListener("load",AOS.refresh),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(window).on("scroll",function(){$(this).scrollTop()>0?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed")})});