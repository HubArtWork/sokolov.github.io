...
var swiper=new Swiper(".testimonials-slider",{slidesPerView:2,freeMode:!1,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:40,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:"auto",freeMode:!0,spaceBetween:16},981:{slidesPerView:2,freeMode:!1,spaceBetween:40}}}),swiper=new Swiper(".posts-slider",{slidesPerView:3,freeMode:!1,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:40,breakpoints:{10:{slidesPerView:"auto",freeMode:!0,spaceBetween:16},981:{slidesPerView:3,freeMode:!1,spaceBetween:40}}});$(document).ready(function(){if($(".collection").length){var e=document.getElementById("slider");noUiSlider.create(e,{start:[0,1e3],connect:!0,range:{min:0,max:1e3},step:1,tooltips:!0,pips:{mode:"steps"}});var t=document.getElementById("slider2");noUiSlider.create(t,{start:[0,1e3],connect:!0,range:{min:0,max:1e3},step:1,tooltips:!0,pips:{mode:"steps"}})}$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(this).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".select").on("click",function(e){if(!$(this).hasClass("select-hid"))if($(this).hasClass("active")){var t=e.target,s=$(this).find(".select-text"),a=$(this).find(".select-value");"LI"==t.tagName?($(s).text($(t).text()),$(a).val($(t).text())):"A"==t.tagName&&(e.preventDefault(),$(s).html($(t).html()),$(a).val($(t).text())),$(this).removeClass("active")}else $(".select").removeClass("active"),$(this).addClass("active")}),$(document).on("click",function(e){var t=$(".select");t.is(e.target)||0!==t.has(e.target).length||$(".select").removeClass("active")})});