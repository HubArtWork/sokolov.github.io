...
var swiper=new Swiper(".main-story__wrapper",{slidesPerView:8,freeMode:!0,watchSlidesVisibility:!0,mousewheel:!0,watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:"auto"},600:{slidesPerView:5},650:{slidesPerView:6},769:{slidesPerView:5},970:{slidesPerView:6},1100:{slidesPerView:8}}});$(document).ready(function(){function e(){$(".main .slider-arrows").css("left",($(window).width()-$(".header-row").outerWidth())/2+"px"),$(".main .swiper-pagination").css("left",($(window).width()-$(".header-row").outerWidth())/2+"px")}var t=new Swiper(".main-slider",{slidesPerView:1,watchOverflow:!0,navigation:{nextEl:".main .swiper-button-next",prevEl:".main .swiper-button-prev"},pagination:{el:".main .swiper-pagination",clickable:!0},effect:"fade",fadeEffect:{crossFade:!0}});e(),$(window).on("resize",function(){e()});var t=new Swiper(".main2-slider",{slidesPerView:8,watchOverflow:!0,breakpoints:{10:{slidesPerView:"auto"},1381:{slidesPerView:8}}}),t=new Swiper(".new-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,spaceBetween:32,navigation:{nextEl:".new .swiper-button-next",prevEl:".new .swiper-button-prev"},breakpoints:{10:{spaceBetween:16},769:{spaceBetween:32}}}),t=new Swiper(".new-slider2",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,spaceBetween:16,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),t=new Swiper(".testimonials-slider",{slidesPerView:2,freeMode:!0,watchOverflow:!0,spaceBetween:16,navigation:{nextEl:".testimonials .swiper-button-next",prevEl:".testimonials .swiper-button-prev"},breakpoints:{10:{slidesPerView:1},981:{slidesPerView:2}}}),t=new Swiper(".mySwiper",{slidesPerView:"auto",freeMode:!0,watchSlidesProgress:!0,spaceBetween:8});new Swiper(".mySwiper2",{spaceBetween:8,navigation:{nextEl:".card-main .swiper-button-next",prevEl:".card-main .swiper-button-prev"},thumbs:{swiper:t}});$(".drop-top").on("click",function(e){e.preventDefault(),$(this).parents(".drop").hasClass("active")?$(".drop").removeClass("active"):($(".drop").removeClass("active"),$(this).parents(".drop").addClass("active"))}),$(document).on("click",function(e){var t=$(".drop");t.is(e.target)||0!==t.has(e.target).length||$(".drop").removeClass("active")}),$(".header .header-bar").on("click",function(){$(".header").toggleClass("active"),$(".header-catalog,.header-bg,.header-menu .link-arrow").removeClass("active")}),$(".header-menu .link-arrow").on("click",function(e){e.preventDefault(),$(".header").removeClass("active"),$(".header-catalog,.header-bg").toggleClass("active"),$(this).toggleClass("active")}),$(".header-catalog .header-bar").on("click",function(){$(".header-catalog,.header-bg,.header-menu .link-arrow").toggleClass("active")}),$(".eye-ico").on("click",function(){$(".eye-ico").toggleClass("active").parents(".input-wrap").find("input").attr("type","text")}),$(".header-actions .basket-ico, .header-basket .close-ico").on("click",function(e){e.preventDefault(),$(".header-basket").toggleClass("active")}),$(document).on("click",function(e){var t=$(".header-actions .basket-ico,.header-basket");t.is(e.target)||0!==t.has(e.target).length||$(".header-basket").removeClass("active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(e.target).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}}),$(".close-button").click(function(){$.fancybox.close()})});