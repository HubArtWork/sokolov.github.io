...
var swiper=new Swiper(".certificates-slider",{slidesPerView:3,spaceBetween:15,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},500:{slidesPerView:2},650:{slidesPerView:2},769:{slidesPerView:3}}}),swiper=new Swiper(".objects-slider",{slidesPerView:3,spaceBetween:15,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},500:{slidesPerView:2},650:{slidesPerView:2},769:{slidesPerView:3}}}),swiper=new Swiper(".categories-wrapper",{slidesPerView:"auto",freeMode:!0,mousewheel:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),swiper=new Swiper(".news-slider",{slidesPerView:1,pagination:{el:".swiper-pagination",clickable:!0}});$(document).ready(function(){$(".header-bar,.header-nav .close-ico").on("click",function(){$(".header-nav").toggleClass("active")}),$(document).on("click",function(e){var t=$(".header-nav,.header-bar");t.is(e.target)||0!==t.has(e.target).length||$(".header-nav").removeClass("active")}),$(".header-drop__top").on("click",function(){$(this).parents(".header-drop").toggleClass("active").find(".header-category").slideToggle()}),$(".contactUs-info .primary-btn").on("click",function(e){e.preventDefault(),$(window).width()<=768&&$(this).parents(".contactUs-item").find(".contactUs-block").slideToggle()}),$(".tooltip .close-ico").on("click",function(){$(this).parents(".tooltip").removeClass("active")}),$(".tooltip-dot").on("click",function(){$(this).parents(".tooltip").hasClass("active")?$(".tooltip").removeClass("active"):($(".tooltip").removeClass("active"),$(this).parents(".tooltip").addClass("active"))}),$(window).width()<=768&&$(".tooltip").removeClass("active"),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(e.target).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".select").on("click",function(e){if(!$(this).hasClass("select-hid"))if($(this).hasClass("active")){var t=e.target,i=$(this).find(".select-text"),a=$(this).find(".select-value");"LI"==t.tagName?($(i).text($(t).text()),$(a).val($(t).text())):"A"==t.tagName&&(e.preventDefault(),$(i).html($(t).html()),$(a).val($(t).text())),$(this).removeClass("active")}else $(".select").removeClass("active"),$(this).addClass("active")}),$(document).on("click",function(e){var t=$(".select");t.is(e.target)||0!==t.has(e.target).length||$(".select").removeClass("active")}),$(".input-tel").mask("+7 (999) 999-99-99"),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1})});