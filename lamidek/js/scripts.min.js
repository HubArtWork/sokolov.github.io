...
var swiper=new Swiper(".certificates-slider",{slidesPerView:3,spaceBetween:15,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},500:{slidesPerView:2},650:{slidesPerView:2},769:{slidesPerView:3}}}),swiper=new Swiper(".objects-slider",{slidesPerView:3,spaceBetween:15,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},500:{slidesPerView:2},650:{slidesPerView:2},769:{slidesPerView:3}}}),galleryThumbs=new Swiper(".main-slider__info",{slidesPerView:1,watchSlidesVisibility:!0,loop:!0,onlyExternal:!0,noSwiping:!1}),galleryTop=new Swiper(".main-slider",{loop:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},thumbs:{swiper:galleryThumbs}}),swiper=new Swiper(".decor-slider",{slidesPerView:5,spaceBetween:30,watchSlidesVisibility:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},450:{slidesPerView:2},650:{slidesPerView:3},840:{slidesPerView:4},1040:{slidesPerView:5}}}),swiper=new Swiper(".spheres-slider",{loop:!0,watchSlidesVisibility:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}}),swiper=new Swiper(".partners-slider",{slidesPerView:4,spaceBetween:50,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},540:{slidesPerView:2},650:{slidesPerView:3},840:{slidesPerView:3},1040:{slidesPerView:4}}}),swiper=new Swiper(".main-production__slider",{slidesPerView:1,loop:!0,watchSlidesVisibility:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}}),swiper=new Swiper(".main-production__slider2",{slidesPerView:1,loop:!0,watchSlidesVisibility:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}});$(document).ready(function(){0!=$(".pageMenu").length&&$(window).on("scroll",function(){var e=$(".pageMenu").position().top;$(this).outerWidth()>=1040&&($(this).scrollTop()+67>=e?$("body").addClass("menuFixed"):$("body").removeClass("menuFixed"))}),$(".pageMenu-list").on("click","a",function(e){e.preventDefault();var i=$(this).attr("href"),t=$(i).offset().top;$("html, body").animate({scrollTop:t-$(".header").outerHeight()},900)}),$(".header-bar,.header-nav .close-ico").on("click",function(){$(".header-nav").toggleClass("active")}),$(document).on("click",function(e){var i=$(".header-nav,.header-bar");i.is(e.target)||0!==i.has(e.target).length||$(".header-nav").removeClass("active")}),$(".header-drop__top").on("click",function(){$(this).parents(".header-drop").toggleClass("active").find(".header-category").slideToggle()}),$(".contactUs-info .primary-btn").on("click",function(e){e.preventDefault(),$(window).width()<=768&&$(this).parents(".contactUs-item").find(".contactUs-block").slideToggle()}),$(".tooltip .close-ico").on("click",function(){$(this).parents(".tooltip").removeClass("active")}),$(".tooltip-dot").on("click",function(){$(this).parents(".tooltip").hasClass("active")?$(".tooltip").removeClass("active"):($(".tooltip").removeClass("active"),$(this).parents(".tooltip").addClass("active"))}),$(window).width()<=768&&$(".tooltip").removeClass("active"),$(".filter-ico, .filter .close-ico").on("click",function(){$(".filter").toggleClass("active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var i=$(e.target).attr("href");$(i).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".input-tel").mask("+7 (999) 999-99-99"),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1})});