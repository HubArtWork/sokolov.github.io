...
function swiperMode(){var e=window.matchMedia("(min-width: 0px) and (max-width: 768px)"),i=window.matchMedia("(min-width: 769px) and (max-width: 1024px)"),t=window.matchMedia("(min-width: 1025px)");e.matches?init||(init=!0,swiper=new Swiper(".gallery-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,loop:!0,effect:"fade",fadeEffect:{crossFade:!0},navigation:{nextEl:".gallery .swiper-button-next",prevEl:".gallery .swiper-button-prev"}})):i.matches?(swiper.destroy(),init=!1):t.matches&&(swiper.destroy(),init=!1)}var swiper=new Swiper(".main-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,loop:!0,effect:"fade",fadeEffect:{crossFade:!0},navigation:{nextEl:".main .swiper-button-next",prevEl:".main .swiper-button-prev"}}),swiper=new Swiper(".about-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,loop:!0,effect:"fade",fadeEffect:{crossFade:!0},navigation:{nextEl:".about .swiper-button-next",prevEl:".about .swiper-button-prev"}});if($(".gallery-slider").length>0){var swiper=Swiper,init=!1;window.addEventListener("load",function(){swiperMode()}),window.addEventListener("resize",function(){swiperMode()})}$(document).ready(function(){$(".header-bar,.header-close").on("click",function(){$(".header").toggleClass("header-active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var i=$(e.target).attr("href");$(i).addClass("tab-active"),$(this).addClass("active")})});