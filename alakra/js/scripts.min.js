...
AOS.init({startEvent:"load"}),$(document).ready(function(){window.addEventListener("load",AOS.refresh),$(".body-bg, .basket-btn, .basket .close-ico").on("click",function(e){e.preventDefault(),$(".basket,.body-bg").toggleClass("active")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(window).on("scroll",function(){$(this).scrollTop()>136?$(".card-sidebar").addClass("fixed").css("right",$(".wrapper").outerWidth()+"px"):$(".card-sidebar").removeClass("fixed")})});