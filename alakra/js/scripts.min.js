...
function initSwiper(){var e=$(window).width();e<768&&void 0==mySwiper?($(".card-slider").addClass("swiper-container"),$(".card-row").addClass("swiper-wrapper"),mySwiper=new Swiper(".swiper-container",{slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,mousewheel:!0})):e>768&&void 0!=mySwiper&&(mySwiper.destroy(),mySwiper=void 0,$(".swiper-wrapper").removeAttr("style"),$(".swiper-slide").removeAttr("style"))}AOS.init({startEvent:"load"});var mySwiper=void 0;initSwiper(),$(window).on("resize",function(){initSwiper()}),$(document).ready(function(){window.addEventListener("load",AOS.refresh),$(".body-bg, .basket-btn, .basket .close-ico").on("click",function(e){e.preventDefault(),$(".basket,.body-bg").toggleClass("active")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active"),$("html,body").toggleClass("scroll-hidden")}),$(".accordeon-top").on("click",function(){$(this).parents(".accordeon").toggleClass("accordeon-active").find(".accordeon-block").slideToggle()}),$(window).on("scroll",function(){$(this).scrollTop()>$("html").outerHeight()-$(".card-sidebar__block").outerHeight()-340?$(".card-sidebar").addClass("absolute").removeClass("fixed"):$(this).scrollTop()>136?$(".card-sidebar").removeClass("absolute").addClass("fixed").css("right",$(".wrapper").outerWidth()+"px"):$(".card-sidebar").removeClass("absolute").removeClass("fixed")}),$(window).on("scroll",function(){$(this).scrollTop()>$("html").outerHeight()-$(".checkout-sidebar__wrap").outerHeight()-340?$(".checkout-sidebar").addClass("absolute").removeClass("fixed"):$(this).scrollTop()>136?$(".checkout-sidebar").removeClass("absolute").addClass("fixed").css("left",$(".wrapper").outerWidth()+"px"):$(".checkout-sidebar").removeClass("absolute").removeClass("fixed").find(".checkout-sidebar__wrap").css("width",$(".checkout-content").outerWidth()-40+"px")}),$(".quantity-minus,.quantity-plus").on("click",function(){var e=$(this).parents(".quantity").find("input"),t=$(e).val();$(this).hasClass("quantity-minus")&&0!=t&&t>0&&$(e).val(t-1),$(this).hasClass("quantity-plus")&&$(e).val(+t+1)}),$(".card-sidebar__detail-top").on("click",function(){$(this).parents(".card-sidebar__detail").toggleClass("active").find(".card-sidebar__detail-block").slideToggle()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$('[data-fancybox="images"]').fancybox({protect:!0,loop:!1,margin:[40,0],gutter:12,keyboard:!0,arrows:!1,infobar:!1,toolbar:!1,btnTpl:{close:'<button data-fancybox-close class="fancybox-button fancybox-button--close" title="{{CLOSE}}"><svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 30 30"><path d="M30,14l0,2H16v14h-2V16H0l0-2l14,0V0h2l0,14L30,14z"></path></svg></button>',arrowLeft:'<button data-fancybox-prev class="fancybox-button fancybox-button--arrow_left" title="{{PREV}}"><svg viewBox="0 0 100 100"><path d="M66.8,95l8.6-8.6c0,0-25.7-25.7-19.6-19.6C62,73,39,50,39,50l36.4-36.4L66.9,5L30.4,41.4l0,0L21.8,50l0,0l-0.1,0.1l8.6,8.6 l0.1-0.1L66.8,95z" class="arrow"></path></svg></button>',arrowRight:'<button data-fancybox-next="" class="fancybox-button fancybox-button--arrow_right" title="Next"><svg viewBox="0 0 100 100"><path d="M66.8,95l8.6-8.6c0,0-25.7-25.7-19.6-19.6C62,73,39,50,39,50l36.4-36.4L66.9,5L30.4,41.4l0,0L21.8,50l0,0l-0.1,0.1l8.6,8.6 l0.1-0.1L66.8,95z" class="arrow" transform="translate(100, 100) rotate(180) "></path></svg></button>'},touch:{vertical:!1,momentum:!1}}),$(".catalog-sidebar__block ul li a").on("click",function(e){e.preventDefault(),$(this).toggleClass("active")}),$(".filter-btn, .catalog-sidebar__mob, .catalog-sidebar__bg, .catalog-sidebar .close-ico").on("click",function(){$(".catalog-sidebar,.catalog-sidebar__bg").toggleClass("active")}),$(".catalog-sidebar__subtitle").on("click",function(){$(window).width()<769&&$(this).parents(".catalog-sidebar__block").toggleClass("active").find("ul").slideToggle()}),$(".catalog-sidebar__btn").on("click",function(e){e.preventDefault(),$(".catalog-sidebar__content ul li a").removeClass("active")}),$(".checkout-radio").change(function(){"delivery1"==$(this).attr("attr-delivery")?$(".checkout-delivery").removeClass("delivery2").addClass("delivery1"):"delivery2"==$(this).attr("attr-delivery")&&$(".checkout-delivery").removeClass("delivery1").addClass("delivery2")}),$(".cart-sidebar__change").on("click",function(e){e.preventDefault(),$(".cart-sidebar__form").slideToggle()}),0!=$(".catalog-slider .product-name").length&&$(".product-name").text(function(e,t){if(t.length>=26){t=t.substring(0,26);var a=t.lastIndexOf(" ");t=t.substring(0,a)+"..."}$(this).text(t)})});