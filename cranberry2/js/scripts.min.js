...
function menuOpen(e){"click"==e.type&&header.classList.toggle("header-active")}var swiper=new Swiper(".brands-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,navigation:{nextEl:".brands .swiper-button-next",prevEl:".brands .swiper-button-prev"},breakpoints:{10:{slidesPerView:1},769:{slidesPerView:"auto"}}}),swiper=new Swiper(".team-slider",{slidesPerView:4,watchOverflow:!0,navigation:{nextEl:".team .swiper-button-next",prevEl:".team .swiper-button-prev"},breakpoints:{10:{slidesPerView:1},650:{slidesPerView:2},1200:{slidesPerView:3},1530:{slidesPerView:4}}}),bar=document.querySelector(".header-bar"),header=document.querySelector(".header");bar.addEventListener("click",menuOpen);for(var overlay=document.getElementById("overlay"),modal=document.getElementsByClassName("modal"),button=document.getElementsByClassName("button-modal"),cancel=document.getElementById("cancel"),i=0;i<button.length;i++)button[i].addEventListener("click",function(e){e.preventDefault();var t=this.getAttribute("href"),n=document.getElementById(t);n.classList.add("open-modal"),overlay.classList.add("open-overlay"),cancel.addEventListener("click",function(){n.classList.remove("open-modal"),overlay.classList.remove("open-overlay")})});