...
function menuOpen(e){"click"==e.type&&header.classList.toggle("header-active")}var swiper=new Swiper(".brands-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,navigation:{nextEl:".brands .swiper-button-next",prevEl:".brands .swiper-button-prev"},breakpoints:{10:{slidesPerView:1},769:{slidesPerView:"auto"}}}),swiper=new Swiper(".text-slider",{slidesPerView:1,watchOverflow:!0,effect:"fade",navigation:{nextEl:".mission-top .swiper-button-next",prevEl:".mission-top .swiper-button-prev"}}),swiper=new Swiper(".mission-slider",{slidesPerView:4,watchOverflow:!0,navigation:{nextEl:".mission-slider .swiper-button-next",prevEl:".mission-slider .swiper-button-prev"},breakpoints:{10:{slidesPerView:1},500:{slidesPerView:2},800:{slidesPerView:3},1200:{slidesPerView:4}}}),swiper=new Swiper(".team-slider",{slidesPerView:5,watchOverflow:!0,navigation:{nextEl:".team .swiper-button-next",prevEl:".team .swiper-button-prev"},breakpoints:{10:{slidesPerView:1},400:{slidesPerView:2},600:{slidesPerView:3},800:{slidesPerView:4},1200:{slidesPerView:5}}});0!=document.getElementById("ourWork-1").length&&lightGallery(document.getElementById("ourWork-1"),{selector:".ourWork-item"}),0!=document.getElementById("ourWork-2").length&&lightGallery(document.getElementById("ourWork-2"),{selector:".ourWork-item"}),0!=document.getElementById("ourWork-3").length&&lightGallery(document.getElementById("ourWork-3"),{selector:".ourWork-item"}),0!=document.getElementById("ourWork-4").length&&lightGallery(document.getElementById("ourWork-4"),{selector:".ourWork-item"}),0!=document.getElementById("ourWork-5").length&&lightGallery(document.getElementById("ourWork-5"),{selector:".ourWork-item"});var bar=document.querySelector(".header-bar"),header=document.querySelector(".header");bar.addEventListener("click",menuOpen);for(var overlay=document.getElementById("overlay"),modal=document.getElementsByClassName("modal"),button=document.getElementsByClassName("button-modal"),cancel=document.getElementById("cancel"),i=0;i<button.length;i++)button[i].addEventListener("click",function(e){e.preventDefault();var t=this.getAttribute("href"),r=document.getElementById(t);r.classList.add("open-modal"),overlay.classList.add("open-overlay"),cancel.addEventListener("click",function(){r.classList.remove("open-modal"),overlay.classList.remove("open-overlay")})});