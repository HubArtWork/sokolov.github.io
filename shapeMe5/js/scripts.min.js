...
function menuOpen(e){"click"==e.type&&header.classList.toggle("header-active")}function hideTabsContent(e){for(var t=e;t<tabContent.length;t++)tabContent[t].classList.remove("show"),tabContent[t].classList.add("hide"),tab[t].classList.remove("active")}function showTabsContent(e){tabContent[e].classList.contains("hide")&&(hideTabsContent(0),tab[e].classList.add("active"),tabContent[e].classList.remove("hide"),tabContent[e].classList.add("show"))}function init(){document.querySelectorAll(".product .primary-btn").forEach(function(e){e.addEventListener("click",function(t){e.parentNode.classList.toggle("active"),t.preventDefault()})})}function openSidebar(e){"click"==e.type&&sidebar.classList.toggle("active")}function carte(){document.querySelectorAll(".carte-item").forEach(function(e){e.addEventListener("click",function(t){e.classList.toggle("active"),t.preventDefault()})})}function sortDrop(e){"click"==e.type&&sort.classList.toggle("active")}function settings(e){"click"==e.type&&profile.classList.toggle("active")}function dropToggle(e){e.preventDefault(),"click"==e.type&&drop.classList.toggle("active")}function settings(e){"click"==e.type&&cardBlock.classList.toggle("active")}var swiper=new Swiper(".menu-slider",{slidesPerView:"auto",freeMode:!0,spaceBetween:40,watchOverflow:!0,breakpoints:{10:{spaceBetween:14},768:{spaceBetween:40}}}),swiper=new Swiper(".carte-slider",{slidesPerView:"auto",freeMode:!0,spaceBetween:10,watchOverflow:!0,watchSlidesVisibility:!0,clickable:!0,navigation:{nextEl:".carte-all .swiper-button-next",prevEl:".carte-all .swiper-button-prev"}}),swiper=new Swiper(".mayAlsoLike-slider",{slidesPerView:"auto",spaceBetween:20,watchOverflow:!0,watchSlidesVisibility:!0,freeMode:!0,clickable:!0,navigation:{nextEl:".mayAlsoLike-all .swiper-button-next",prevEl:".mayAlsoLike-all .swiper-button-prev"},breakpoints:{10:{spaceBetween:14,watchSlidesVisibility:!1},768:{spaceBetween:20,watchSlidesVisibility:!0}}}),bar=document.querySelector(".header-bar"),header=document.querySelector(".header");bar.addEventListener("click",menuOpen);var accordion=document.getElementById("accordions");if(accordion){var acc=document.getElementsByClassName("course-accordion"),i;for(i=0;i<acc.length;i++)acc[i].onclick=function(){var e=this.nextElementSibling,t=document.getElementsByClassName("course-panel"),n=(document.getElementsByClassName("course-accordion"),document.getElementsByClassName("course-accordion active"));if(e.style.maxHeight)e.style.maxHeight=null,this.classList.remove("active");else{for(var a=0;a<n.length;a++)n[a].classList.remove("active");for(var c=0;c<t.length;c++)this.classList.remove("active"),t[c].style.maxHeight=null;e.style.maxHeight=e.scrollHeight+"px",this.classList.add("active")}}}var element=document.getElementById("tabs");if(element){var tab,tabContent;window.onload=function(){tabContent=document.getElementsByClassName("tabContent"),tab=document.getElementsByClassName("tab-link"),hideTabsContent(1)},document.getElementById("tabs").onclick=function(e){var t=e.target;if("tab-link"==t.className)for(var n=0;n<tab.length;n++)if(t==tab[n]){showTabsContent(n);break}}}init();var bundle=document.getElementById("bundle");if(bundle){var pageMob=document.querySelector(".page-mob"),close=document.querySelector(".sidebar-page .close-ico"),sidebar=document.querySelector(".sidebar-page");pageMob.addEventListener("click",openSidebar),close.addEventListener("click",openSidebar)}carte();var sort=document.getElementById("sort");if(sort){var sort=document.querySelector(".sort");sort.addEventListener("click",sortDrop)}var bundle=document.getElementById("profile");if(bundle){var button=document.querySelector(".changes-btn"),profile=document.querySelector(".profile-settings");button.addEventListener("click",settings)}var dropBtn=document.querySelector(".drop-text"),drop=document.querySelector(".drop");dropBtn.addEventListener("click",dropToggle);var card=document.getElementById("card");if(card){var cardBtn=document.querySelector(".card-actions .show-more"),cardBlock=document.querySelector(".card-actions");cardBtn.addEventListener("click",settings)}