...
var swiper=new Swiper(".catalog-slider",{slidesPerView:1,pagination:{el:".swiper-pagination",clickable:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),swiper=new Swiper(".article-slider",{slidesPerView:1,pagination:{el:".swiper-pagination",clickable:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:"auto",spaceBetween:8},661:{slidesPerView:1,spaceBetween:0}}}),swiper=new Swiper(".viewed-slider",{slidesPerView:4,spaceBetween:8,pagination:{el:".swiper-pagination",clickable:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:"auto",spaceBetween:16,centeredSlides:!0,loop:!0},661:{slidesPerView:3,spaceBetween:0,centeredSlides:!1,loop:!1},1260:{slidesPerView:4}}});$(document).ready(function(){function e(){$(".tags").each(function(){if($(window).width()>1261)var e=7;else var e=4;var a=$(this).find(".tags-link");a.length>e&&a.slice(e).hide()})}$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),e(),$(".tags").on("click",".tags-more",function(a){a.preventDefault(),$(this).hasClass("active")?($(this).parents(".tags").addClass("open").find(".tags-more").text("Показать еще").removeClass("active"),e()):$(this).parents(".tags").removeClass("open").find(".tags-more").text("Свернуть").addClass("active").prevAll().show()}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var a=$(e.target).attr("href");$(a).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()})});