...
$(document).ready(function(){if($(".works-slider").length){new Swiper(".works-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:60,autoHeight:!1,centeredSlides:!0,loop:!0,scrollbar:{el:".swiper-scrollbar",hide:!0},navigation:{nextEl:".works .swiper-button-next",prevEl:".works .swiper-button-prev"},breakpoints:{10:{spaceBetween:20},769:{spaceBetween:60}}})}if($(".testimonials-slider").length){new Swiper(".testimonials-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:20,autoHeight:!1,scrollbar:{el:".swiper-scrollbar",hide:!0},navigation:{nextEl:".testimonials .swiper-button-next",prevEl:".testimonials .swiper-button-prev"}})}if($(".inst-slider").length){new Swiper(".inst-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:20,scrollbar:{el:".swiper-scrollbar",hide:!0},navigation:{nextEl:".inst .swiper-button-next",prevEl:".inst .swiper-button-prev"}})}var e=$(".arrow-top");$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(e).addClass("arrow-active"):$(e).removeClass("arrow-active")}),$(e).on("click",function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(".arrow-top").length&&($(".arrow-top").css("right",($(window).width()-$(".wrapper").width())/2),$(window).on("resize",function(){$(".arrow-top").css("right",($(window).width()-$(".wrapper").width())/2)})),$(".header-menu, .main-info").on("click","a",function(e){e.preventDefault();var t=$(this).attr("href"),i=$(t).offset().top;$("html, body").animate({scrollTop:i},900),$(".header").removeClass("header-active")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".differences-accordeon-tit").on("click",function(){$(this).parents(".differences-accordeon").toggleClass("active").find(".differences-accordeon-block").slideToggle()}),$(".curriculum-sub").on("click",function(){$(window).outerWidth()<=768&&$(this).parents(".curriculum-item").toggleClass("active").find("ul").slideToggle()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1})});