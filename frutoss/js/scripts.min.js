...
var swiper=new Swiper(".main-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,loop:!0,loopFillGroupWithBlank:!0,effect:"fade",navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}}),swiper=new Swiper(".catalog-slider",{slidesPerView:3,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:28,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},scrollbar:{el:".swiper-scrollbar",hide:!0},breakpoints:{10:{slidesPerView:2,spaceBetween:20},600:{slidesPerView:3,spaceBetween:28}}}),swiper=new Swiper(".ordering-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,loop:!0,loopFillGroupWithBlank:!0,effect:"fade",navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}});$(document).ready(function(){if($(".scrollbar-outer").scrollbar(),$(".header-bar").on("click",function(){$("body").toggleClass("menuOpen")}),$(".mobMenu-menu .drop-text").on("click",function(e){e.preventDefault(),$(this).next("ul").slideToggle()}),$(".filter-top").on("click",function(e){e.preventDefault(),$(this).hasClass("active")?$(".filter-top").removeClass("active").next(".filter-info").slideUp():($(".filter-top").removeClass("active").next(".filter-info").slideUp(),$(this).toggleClass("active").next(".filter-info").slideToggle())}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var a=$(e.target).attr("href");$(a).addClass("tab-active"),$(this).addClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$("*").is(".filter")){w=$(window).width(),$(window).on("orientationchange",function(){w!=$(window).width()&&($(e).removeClass("sidebar-fixed").removeClass("sidebar-absolute").css("left","0").parents(".brand-sidebar").removeClass("block-m"),delete w)});var e=$(".filter"),a=$(e).offset().top-20,i=$("body").height()-($(e).height()+20+$(".header").height()+$(".footer").height());$(window).width()<=700&&(a=232),$(window).on("scroll",function(){$(window).scrollTop()+$(".header").height()>=a?$(window).scrollTop()>=i?$(e).removeClass("sidebar-fixed").addClass("sidebar-absolute").css("left","0"):$(e).addClass("sidebar-fixed").removeClass("sidebar-absolute").css("left",($(window).innerWidth()-$(".catalog .wrapper").innerWidth())/2+($(".catalog .wrapper").innerWidth()-$(".catalog .wrapper").width())/2+"px"):$(e).removeClass("sidebar-fixed").removeClass("sidebar-absolute").css("left","0")})}$(".personalArea-head .hb-ico").on("click",function(e){e.preventDefault();var a=$(".personalArea-list").find("a.active"),i=$(a).parents("li").index();$(".personalArea-list li a").removeClass("active"),$(this).hasClass("arrow-left")?0==i?($(a).parents(".personalArea-list").find("li").eq("2").find("a").addClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active"),$($(".personalArea-list").find("a.active").attr("href")).addClass("tab-active")):($(a).parents("li").prev("li").find("a").addClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active"),$($(".personalArea-list").find("a.active").attr("href")).addClass("tab-active")):2==i?($(a).parents(".personalArea-list").find("li").eq("0").find("a").addClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active"),$($(".personalArea-list").find("a.active").attr("href")).addClass("tab-active")):($(a).parents("li").next("li").find("a").addClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active"),$($(".personalArea-list").find("a.active").attr("href")).addClass("tab-active"))}),$(".personalArea-main").on("click",function(e){e.preventDefault(),$(this).hasClass("active")?$(".personalArea-main").removeClass("active").next(".personalArea-drop").slideUp():($(".personalArea-main").removeClass("active").next(".personalArea-drop").slideUp(),$(this).toggleClass("active").next(".personalArea-drop").slideToggle())})});