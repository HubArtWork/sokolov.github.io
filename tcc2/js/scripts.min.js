...
var swiper=new Swiper(".main-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,loop:!0,effect:"fade",fadeEffect:{crossFade:!0},navigation:{nextEl:".main .swiper-button-next",prevEl:".main .swiper-button-prev"}}),swiper=new Swiper(".about-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,loop:!0,effect:"fade",fadeEffect:{crossFade:!0},navigation:{nextEl:".about .swiper-button-next",prevEl:".about .swiper-button-prev"}}),swiper=new Swiper(".mySwiper",{spaceBetween:30,slidesPerView:4,freeMode:!0,watchSlidesProgress:!0}),swiper2=new Swiper(".mySwiper2",{spaceBetween:10,thumbs:{swiper:swiper}}),swiper=new Swiper(".services-slider",{spaceBetween:30,slidesPerView:3,navigation:{nextEl:".services-slider__all .swiper-button-next",prevEl:".services-slider__all .swiper-button-prev"},breakpoints:{10:{slidesPerView:1},650:{slidesPerView:2},970:{slidesPerView:3}}});$(document).ready(function(){function e(){var e=window.matchMedia("(min-width: 0px) and (max-width: 768px)"),t=window.matchMedia("(min-width: 769px) and (max-width: 1024px)"),a=window.matchMedia("(min-width: 1025px)");e.matches?s||(s=!0,i=new Swiper(".gallery-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,loop:!0,effect:"fade",fadeEffect:{crossFade:!0},navigation:{nextEl:".gallery .swiper-button-next",prevEl:".gallery .swiper-button-prev"}})):t.matches?(i.destroy(),s=!1):a.matches&&(i.destroy(),s=!1)}if($(window).on("scroll",function(){$(this).scrollTop()>0?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed")}),$(".header-bar,.header-close").on("click",function(){$(".header").toggleClass("header-active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var i=$(e.target).attr("href");$(i).addClass("tab-active"),$(this).addClass("active")}),$(".services-sidebar__arrow").on("click",function(){$(".services-sidebar").toggleClass("active")}),$(".services-sidebar__tit").on("click",function(){$(this).parents(".services-sidebar__block").hasClass("active")?$(".services-sidebar__block").removeClass("active").find(".services-sidebar__list").slideUp():($(".services-sidebar__block").removeClass("active").find(".services-sidebar__list").slideUp(),$(this).parents(".services-sidebar__block").addClass("active").find(".services-sidebar__list").slideDown())}),$(".services-tit").on("click",function(){$(window).outerWidth()<=768&&$(this).parents(".services-block").toggleClass("active").find(".services-drop").slideToggle()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}}),$(".gallery-slider").length>0){var i=Swiper,s=!1;window.addEventListener("load",function(){e()}),window.addEventListener("resize",function(){e()})}});