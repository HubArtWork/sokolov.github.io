...
function swiperMode(){var e=window.matchMedia("(min-width: 0px) and (max-width: 768px)"),i=window.matchMedia("(min-width: 769px) and (max-width: 1024px)"),t=window.matchMedia("(min-width: 1025px)");e.matches?(swiper.destroy(),init=!1):i.matches?init||(init=!0,swiper=new Swiper(".main-slider",{slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:36,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}})):t.matches&&(init||(init=!0,swiper=new Swiper(".main-slider",{slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:36,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}})))}var element=document.getElementById("main");if(element){var swiper=Swiper,init=!1;window.addEventListener("load",function(){swiperMode()}),window.addEventListener("resize",function(){swiperMode()})}