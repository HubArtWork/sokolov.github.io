...
var swiper=new Swiper(".energy-slider",{slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,mousewheel:!0,watchOverflow:!0,pagination:{el:".energy .swiper-pagination",clickable:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),swiper=new Swiper(".leisure-slider",{slidesPerView:1,freeMode:!0,watchSlidesVisibility:!0,effect:"fade",fadeEffect:{crossFade:!0},pagination:{el:".leisure .swiper-pagination",clickable:!0},navigation:{nextEl:".leisure .swiper-button-next",prevEl:".leisure .swiper-button-prev"}}),swiper=new Swiper(".peculiarities-slider",{slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,mousewheel:!0,watchOverflow:!0,spaceBetween:12,pagination:{el:".energy .swiper-pagination",clickable:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}});$(document).ready(function(){$(".header-menu, .main-info").on("click","a",function(e){e.preventDefault();var i=$(this).attr("href"),t=$(i).offset().top;$("html, body").animate({scrollTop:t},900),$(".header").removeClass("header-active")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".about-btn").on("click",function(e){e.preventDefault(),$(this).toggleClass("active"),$(".about-map").slideToggle()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}})});