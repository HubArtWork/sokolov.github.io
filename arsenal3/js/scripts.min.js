...
function slideToggle(t,e,o){0===t.clientHeight?j(t,e,o,!0):j(t,e,o)}function slideUp(t,e,o){j(t,e,o)}function slideDown(t,e,o){j(t,e,o,!0)}function j(t,e,o,i){void 0===e&&(e=600),void 0===i&&(i=!1),t.style.overflow="hidden",i&&(t.style.display="block");var p,l=window.getComputedStyle(t),n=parseFloat(l.getPropertyValue("height")),a=parseFloat(l.getPropertyValue("padding-top")),s=parseFloat(l.getPropertyValue("padding-bottom")),r=parseFloat(l.getPropertyValue("margin-top")),d=parseFloat(l.getPropertyValue("margin-bottom")),g=n/e,y=a/e,m=s/e,u=r/e,h=d/e;window.requestAnimationFrame(function l(x){void 0===p&&(p=x);var f=x-p;i?(t.style.height=g*f+"px",t.style.paddingTop=y*f+"px",t.style.paddingBottom=m*f+"px",t.style.marginTop=u*f+"px",t.style.marginBottom=h*f+"px"):(t.style.height=n-g*f+"px",t.style.paddingTop=a-y*f+"px",t.style.paddingBottom=s-m*f+"px",t.style.marginTop=r-u*f+"px",t.style.marginBottom=d-h*f+"px"),f>=e?(t.style.height="",t.style.paddingTop="",t.style.paddingBottom="",t.style.marginTop="",t.style.marginBottom="",t.style.overflow="",i||(t.style.display="none"),"function"==typeof o&&o()):window.requestAnimationFrame(l)})}

function menuOpen(e){"click"==e.type&&header.classList.toggle("header-active")}var mySwiper=new Swiper(".main-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,noSwiping:!0,allowTouchMove:!1,speed:1e3,pagination:{el:".swiper-pagination",clickable:!0},autoplay:{delay:5e3,disableOnInteraction:!0},effect:"fade",fadeEffect:{crossFade:!1},breakpoints:{10:{noSwiping:!1,allowTouchMove:!0},769:{noSwiping:!0,allowTouchMove:!1}}});mySwiper.el.addEventListener("mouseenter",function(e){mySwiper.autoplay.stop()},!1),mySwiper.el.addEventListener("mouseleave",function(e){mySwiper.autoplay.start()},!1);var name1=document.querySelector("#main-name-1"),name2=document.querySelector("#main-name-2"),name3=document.querySelector("#main-name-3");name1.addEventListener("click",function(e){"click"==e.type&&mySwiper.slideNext()}),name2.addEventListener("click",function(e){"click"==e.type&&mySwiper.slideNext()}),name3.addEventListener("click",function(e){"click"==e.type&&mySwiper.slideTo(0,0)});var bar=document.querySelector(".header-bar"),header=document.querySelector("body");bar.addEventListener("click",menuOpen);var allPanels=document.querySelectorAll(".header-menu ul");document.querySelector(".header-menu").addEventListener("click",function(e){if(window.innerWidth<721&&e.target.classList.contains("header-subtitle")){e.target.parentNode.classList.contains("active")?allPanels.forEach(function(e){"none"!==e.style.display&&e!==n&&e.parentNode.classList.remove("active")}):(allPanels.forEach(function(e){"none"!==e.style.display&&e!==n&&e.parentNode.classList.remove("active")}),e.target.parentNode.classList.add("active"));var n=e.target.nextElementSibling;slideToggle(n,200),allPanels.forEach(function(e){"none"!==e.style.display&&e!==n&&slideUp(e,200)})}});