...
AOS.init({startEvent:"load"}),$(document).ready(function(){function e(){$(".howItWorks").hasClass("howItWorks-1")?($(".howItWorks").removeClass("howItWorks-1 howItWorks-2 howItWorks-3").addClass("howItWorks-2"),r[0].src=$(".howItWorks-block-1").attr("data-video"),a.load()):$(".howItWorks").hasClass("howItWorks-2")?($(".howItWorks").removeClass("howItWorks-1 howItWorks-2 howItWorks-3").addClass("howItWorks-3"),r[0].src=$(".howItWorks-block-2").attr("data-video"),a.load()):$(".howItWorks").hasClass("howItWorks-3")&&($(".howItWorks").removeClass("howItWorks-1 howItWorks-2 howItWorks-3").addClass("howItWorks-1"),r[0].src=$(".howItWorks-block-3").attr("data-video"),a.load())}function o(){s=setInterval(function(){e()},3e4)}function t(){clearInterval(s)}window.addEventListener("load",AOS.refresh);new Swiper(".features-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,pagination:{el:".swiper-pagination",clickable:!0,renderBullet:function(e,o){return'<span class="'+o+'"><svg class="circle-chart" viewbox="0 0 33.83098862 33.83098862" width="60" height="60" xmlns="http://www.w3.org/2000/svg"><circle class="circle-chart__background" stroke="#000" stroke-width="0.5" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" style="stroke-opacity: .3;"/><circle class="circle-chart__circle" stroke="#FF7F57" stroke-width="1" stroke-dasharray="100,100" stroke-linecap="round" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" /></svg></span>'}}}),new Swiper(".testimonials-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,autoplay:{delay:3e4},pagination:{el:".testimonials .swiper-pagination",clickable:!0,renderBullet:function(e,o){return'<span class="'+o+'"><svg class="circle-chart" viewbox="0 0 33.83098862 33.83098862" width="60" height="60" xmlns="http://www.w3.org/2000/svg"><circle class="circle-chart__background" stroke="#000" stroke-width="0.5" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" style="stroke-opacity: .3;"/><circle class="circle-chart__circle" stroke="#8C88A3" stroke-width="1" stroke-dasharray="100,100" stroke-linecap="round" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" /></svg></span>'}},breakpoints:{10:{slidesPerView:"auto"},769:{slidesPerView:1}}});$(".menu li").on("click","a",function(e){e.preventDefault();var o=$(this).attr("href"),t=$(o).offset().top;$("html, body").animate({scrollTop:t},900),$(".header").removeClass("header-active")}),$(".header-bar,.header-close").on("click",function(){$(".header").toggleClass("header-active"),$(".menu").slideToggle()}),$(".footer-tit").on("click",function(){$(this).toggleClass("active").next(".footer-block").slideToggle()}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var o=$(this).attr("href");$(o).addClass("tab-active"),$(this).addClass("active")});var s=null,a=$(".howItWorks video")[0],r=a.getElementsByTagName("source");$(".howItWorks-block").on("click",function(){var e=$(this).attr("data-block"),s=$(this).attr("data-video");$(".howItWorks").removeClass("howItWorks-1 howItWorks-2 howItWorks-3").addClass(e),r[0].src=s,a.load(),t(),o()}),o(),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()})});