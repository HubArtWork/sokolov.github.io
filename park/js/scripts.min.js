...
var swiper=new Swiper(".activity-slider",{slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,mousewheel:!0,watchOverflow:!0});$(document).ready(function(){$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1})});