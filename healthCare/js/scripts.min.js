...
var swiperMain=new Swiper(".main-slider",{slidesPerView:1,watchOverflow:!0,effect:"fade",onInit:function(e){document.querySelector(".main-num").innerHTML="<span>0"+(e.activeIndex+1)+"/</span>"+e.slides.length+"Offers"},onSlideChangeEnd:function(e){document.querySelector(".main-num").innerHTML=e.activeIndex+1+"/"+e.slides.length+"Offers"}}),swiper=new Swiper(".testimonials-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,spaceBetween:4}),swiper=new Swiper(".comparison-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:24});$(document).ready(function(){if($(window).outerWidth()<768&&$(".search-main input").attr("placeholder","Введите запрос"),$(".disabled").on("click",function(e){e.preventDefault()}),$(".header-lang-top").on("click",function(e){$(window).outerWidth()>768&&(e.preventDefault(),$(this).parents(".header-lang").hasClass("active")?$(".header-lang").removeClass("active"):($(".header-lang").removeClass("active"),$(this).parents(".header-lang").addClass("active")))}),$(document).on("click",function(e){var a=$(".header-lang");a.is(e.target)||0!==a.has(e.target).length||$(".header-lang").removeClass("active")}),$(".header-lang-top").on("click",function(e){e.preventDefault(),$(window).outerWidth()<=768&&$(this).parents(".header-lang").toggleClass("active").find(".header-lang-list").slideToggle()}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".drop-top").on("click",function(e){e.preventDefault(),$(window).outerWidth()<=1230&&$(this).parents(".drop").toggleClass("active").find(".drop-list").slideToggle()}),$(".video .post-img").on("click",function(e){e.preventDefault();var a=$(this).attr("data-url");$(this).addClass("active").find("iframe").attr("src",a)}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var a=$(e.target).attr("href");$(a).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$("*").is(".ordering-sidebar")){w=$(window).width();var e=$(".ordering-sidebar-wrap"),a=$(e).offset().top-20,t=$(".page-top").height()+$(".ordering-row").height();$(window).on("scroll",function(){$(window).scrollTop()>=a?$(window).scrollTop()>=t-$(e).height()?$(e).removeClass("sidebar-fixed").addClass("sidebar-absolute").css("right","0"):$(e).addClass("sidebar-fixed").removeClass("sidebar-absolute").css("right",($(window).innerWidth()-$(".ordering-row").innerWidth())/2+($(".ordering-row").innerWidth()-$(".ordering-row").width())/2+"px"):$(e).removeClass("sidebar-fixed").removeClass("sidebar-absolute").css("right","0")})}$(".aboutUs-menu").on("click","a",function(e){e.preventDefault();var a=$(this).attr("href"),t=$(a).offset().top;$("html, body").animate({scrollTop:t-$(".header").outerHeight()},600),$(".aboutUs-sidebar").removeClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}}),$(".modal .sidebar-close").click(function(){$.fancybox.close()}),0!=$("#range-1").length&&$("#range-1").slider({range:!0,min:1,max:7,step:1,values:[3,5],slide:function(e,a){var t=a.values[0],i=a.values[1];$(this).parents(".catalog-range").find(".catalog-range-1").text(t),$(this).parents(".catalog-range").find(".catalog-range-2").text(i)}}),$(".filters-btn, .catalog-sidebar .sidebar-close, .aboutUs-sidebar .close-ico").on("click",function(e){e.preventDefault(),$(this).hasClass("filters-btn-menu")?$(".aboutUs-sidebar").toggleClass("active"):$(this).hasClass("close-ico")?$(".catalog-sidebar,.aboutUs-sidebar").removeClass("active"):$(".catalog-sidebar").toggleClass("active")}),0!=$("select").length&&$("select").select2()});