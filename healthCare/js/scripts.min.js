...
var swiper=new Swiper(".testimonials-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,spaceBetween:4}),swiper=new Swiper(".comparison-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:24,mousewheel:!0,visibilityFullFit:!0});$(document).ready(function(){function e(){if(0!=$(".modal-slider").length){new Swiper(".modal-slider",{slidesPerView:1,watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}})}}var t=new Swiper(".main-slider",{slidesPerView:1,watchOverflow:!0,speed:500,navigation:{nextEl:".main-actions .swiper-button-next",prevEl:".main-actions .swiper-button-prev"}});if(t.on("slideChange",function(e){$("#main-num").html("<span>0"+parseInt(t.activeIndex+1)+"/</span>0"+e.slides.length)}),$(".disabled").on("click",function(e){e.preventDefault()}),$(".header-lang-top").on("click",function(e){$(window).outerWidth()>768&&(e.preventDefault(),$(this).parents(".header-lang").hasClass("active")?$(".header-lang").removeClass("active"):($(".header-lang").removeClass("active"),$(this).parents(".header-lang").addClass("active")))}),$(document).on("click",function(e){var t=$(".header-lang");t.is(e.target)||0!==t.has(e.target).length||$(".header-lang").removeClass("active")}),$(".header-lang-top").on("click",function(e){e.preventDefault(),$(window).outerWidth()<=768&&$(this).parents(".header-lang").toggleClass("active").find(".header-lang-list").slideToggle()}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".drop-top").on("click",function(e){"Каталог"==$(this).text()&&e.preventDefault(),$(this).parent().hasClass("drop-catalog")||$(window).outerWidth()<=1230&&$(this).toggleClass("active").next(".drop-list").slideToggle().parent(".drop")}),$(window).outerWidth()>1230&&$(".drop").hover(function(){$(this).addClass("drop-hover")},function(){$(this).removeClass("drop-hover")}),$(".video .post-img").on("click",function(e){e.preventDefault();var t=$(this).attr("data-url");$(this).addClass("active").find("iframe").attr("src",t)}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(e.target).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$("*").is(".ordering-sidebar")){w=$(window).width();var s=$(".ordering-sidebar-wrap"),a=$(s).offset().top-20,o=$(".page-top").height()+$(".ordering-row").height();$(window).on("scroll",function(){$(window).scrollTop()>=a?$(window).scrollTop()>=o-$(s).height()?$(s).removeClass("sidebar-fixed").addClass("sidebar-absolute").css("right","0"):$(s).addClass("sidebar-fixed").removeClass("sidebar-absolute").css("right",($(window).innerWidth()-$(".ordering-row").innerWidth())/2+($(".ordering-row").innerWidth()-$(".ordering-row").width())/2+"px"):$(s).removeClass("sidebar-fixed").removeClass("sidebar-absolute").css("right","0")})}if($('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1,afterShow:function(){e()}}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}}),$(".modal .sidebar-close").click(function(){$.fancybox.close()}),0!=$("#range-1").length&&$("#range-1").slider({range:!0,min:1,max:7,step:1,values:[3,5],slide:function(e,t){var s=t.values[0],a=t.values[1];$(this).parents(".catalog-range").find(".catalog-range-1").text(s),$(this).parents(".catalog-range").find(".catalog-range-2").text(a)}}),$(".filters-btn, .catalog-sidebar .sidebar-close, .aboutUs-sidebar .close-ico").on("click",function(e){e.preventDefault(),$(this).hasClass("filters-btn-menu")?$(".aboutUs-sidebar").toggleClass("active"):$(this).hasClass("close-ico")?$(".catalog-sidebar,.aboutUs-sidebar").removeClass("active"):$(".catalog-sidebar").toggleClass("active")}),0!=$(".aboutUs-menu").length){$(".aboutUs-menu").on("click","a",function(e){e.preventDefault();var t=$(this).attr("href"),s=$(t).offset().top;$(window).outerWidth()<=1230?($("html, body").animate({scrollTop:s-$(".header").outerHeight()},600),$(".aboutUs-sidebar").removeClass("active")):$("html, body").animate({scrollTop:s},600)});var i=$(".block"),l=$(".aboutUs-menu");l.outerHeight();$(window).on("scroll",function(){var e=$(".aboutUs-row").offset().top,t=$(this).scrollTop()-e;i.each(function(){var s=$(this).offset().top-e,a=s+$(this).outerHeight();t>=s&&t<=a&&(l.find("a").removeClass("active"),i.removeClass("active"),$(this).addClass("active"),l.find('a[href="#'+$(this).attr("id")+'"]').addClass("active"))})})}if($(window).width()>768){new Swiper(".kit-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:24,mousewheel:!0,allowTouchMove:!1,scrollbar:{el:".swiper-scrollbar",draggable:!0}})}new Swiper(".filters-slider",{slidesPerView:"auto",watchOverflow:!0,mousewheel:!0,freeMode:!0});0!=$("select").length&&($("select").select2(),0!=$("#select-1").length&&$("#select-1 select").select2({dropdownParent:$("#select-1")}),0!=$("#select-2").length&&$("#select-2 select").select2({dropdownParent:$("#select-2")}),0!=$("#select-3").length&&$("#select-3 select").select2({dropdownParent:$("#select-3")}),0!=$("#select-4").length&&$("#select-4 select").select2({dropdownParent:$("#select-4")}),0!=$("#select-5").length&&$("#select-5 select").select2({dropdownParent:$("#select-5")}),0!=$("#select-6").length&&$("#select-6 select").select2({dropdownParent:$("#select-6")}),0!=$("#select-7").length&&$("#select-7 select").select2({dropdownParent:$("#select-7")}),0!=$("#select-8").length&&$("#select-8 select").select2({dropdownParent:$("#select-8")}),0!=$("#select-9").length&&$("#select-9 select").select2({dropdownParent:$("#select-9")}),0!=$("#select-10").length&&$("#select-10 select").select2({dropdownParent:$("#select-10")})),0!=$(".filters-btn").length&&$(window).on("scroll",function(){$(window).scrollTop()>=$(document).outerHeight()-($(".footer").outerHeight()+$(window).height())?$(".filters-btn").addClass("active").css("bottom",$(".footer").outerHeight()+40+"px"):$(".filters-btn").removeClass("active").css("bottom","30px")}),e()});