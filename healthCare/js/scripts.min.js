...
var swiper=new Swiper(".testimonials-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,spaceBetween:4}),swiper=new Swiper(".comparison-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:24});$(document).ready(function(){var e=new Swiper(".main-slider",{slidesPerView:1,watchOverflow:!0,effect:"fade",navigation:{nextEl:".main-actions .swiper-button-next",prevEl:".main-actions .swiper-button-prev"}});if(e.on("slideChange",function(a){$("#main-num").html("<span>0"+parseInt(e.activeIndex+1)+"/</span>0"+a.slides.length),console.log("*** mySwiper.activeIndex",e.activeIndex)}),$(".disabled").on("click",function(e){e.preventDefault()}),$(".header-lang-top").on("click",function(e){$(window).outerWidth()>768&&(e.preventDefault(),$(this).parents(".header-lang").hasClass("active")?$(".header-lang").removeClass("active"):($(".header-lang").removeClass("active"),$(this).parents(".header-lang").addClass("active")))}),$(document).on("click",function(e){var a=$(".header-lang");a.is(e.target)||0!==a.has(e.target).length||$(".header-lang").removeClass("active")}),$(".header-lang-top").on("click",function(e){e.preventDefault(),$(window).outerWidth()<=768&&$(this).parents(".header-lang").toggleClass("active").find(".header-lang-list").slideToggle()}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".drop-top").on("click",function(e){$(window).outerWidth()>1230&&e.preventDefault()}),$(".drop-top").on("click",function(e){$(this).parent().hasClass("drop-catalog")||(e.preventDefault(),$(window).outerWidth()<=1230&&$(this).toggleClass("active").next(".drop-list").slideToggle().parent(".drop"))}),$(window).outerWidth()>1230&&$(".drop").hover(function(){$(this).addClass("drop-hover")},function(){$(this).removeClass("drop-hover")}),$(".video .post-img").on("click",function(e){e.preventDefault();var a=$(this).attr("data-url");$(this).addClass("active").find("iframe").attr("src",a)}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var a=$(e.target).attr("href");$(a).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$("*").is(".ordering-sidebar")){w=$(window).width();var a=$(".ordering-sidebar-wrap"),t=$(a).offset().top-20,i=$(".page-top").height()+$(".ordering-row").height();$(window).on("scroll",function(){$(window).scrollTop()>=t?$(window).scrollTop()>=i-$(a).height()?$(a).removeClass("sidebar-fixed").addClass("sidebar-absolute").css("right","0"):$(a).addClass("sidebar-fixed").removeClass("sidebar-absolute").css("right",($(window).innerWidth()-$(".ordering-row").innerWidth())/2+($(".ordering-row").innerWidth()-$(".ordering-row").width())/2+"px"):$(a).removeClass("sidebar-fixed").removeClass("sidebar-absolute").css("right","0")})}if($('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}}),$(".modal .sidebar-close").click(function(){$.fancybox.close()}),0!=$("#range-1").length&&$("#range-1").slider({range:!0,min:1,max:7,step:1,values:[3,5],slide:function(e,a){var t=a.values[0],i=a.values[1];$(this).parents(".catalog-range").find(".catalog-range-1").text(t),$(this).parents(".catalog-range").find(".catalog-range-2").text(i)}}),$(".filters-btn, .catalog-sidebar .sidebar-close, .aboutUs-sidebar .close-ico").on("click",function(e){e.preventDefault(),$(this).hasClass("filters-btn-menu")?$(".aboutUs-sidebar").toggleClass("active"):$(this).hasClass("close-ico")?$(".catalog-sidebar,.aboutUs-sidebar").removeClass("active"):$(".catalog-sidebar").toggleClass("active")}),0!=$(".aboutUs-menu").length){$(".aboutUs-menu").on("click","a",function(e){e.preventDefault();var a=$(this).attr("href"),t=$(a).offset().top;$(window).outerWidth()<=1230?($("html, body").animate({scrollTop:t-$(".header").outerHeight()},600),$(".aboutUs-sidebar").removeClass("active")):$("html, body").animate({scrollTop:t},600)});var o=$(".block"),s=$(".aboutUs-menu");s.outerHeight();$(window).on("scroll",function(){var e=$(".aboutUs-row").offset().top,a=$(this).scrollTop()-e;o.each(function(){var t=$(this).offset().top-e,i=t+$(this).outerHeight();a>=t&&a<=i&&(s.find("a").removeClass("active"),o.removeClass("active"),$(this).addClass("active"),s.find('a[href="#'+$(this).attr("id")+'"]').addClass("active"))})})}if($(window).width()>768){new Swiper(".kit-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:24,mousewheel:!0,freeMode:!0,simulateTouch:!1,scrollbar:{el:".swiper-scrollbar",draggable:!0}})}0!=$("select").length&&$("select").select2(),0!=$(".filters-btn").length&&$(window).on("scroll",function(){$(window).scrollTop()>=$(document).outerHeight()-($(".footer").outerHeight()+$(window).height())?$(".filters-btn").addClass("active"):$(".filters-btn").removeClass("active")}),0!=$("#openreader-btn").length&&$("#openreader-btn").qrCodeReader({target:"#target-input",audioFeedback:!0,multiple:!0,skipDuplicates:!1,callback:function(e){console.log(e)}})});