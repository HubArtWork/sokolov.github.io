...
$(document).ready(function(){function t(){var t=($(window).height(),$(".main img").width());$(".main-wrap").width(t+"px")}t(),$(window).on("resize",function(){t()}),$("body").on("scroll",function(t){var i=$("body").width(),o=$(".main img").width(),n=100*$("body").scrollLeft()/(o-i);$(".scroll-pos").css("left",n+"%")}),$(window).width()<768&&$(".tooltip").on("click",function(t){$(this).hasClass("active")?$(".tooltip").removeClass("active"):(t.preventDefault(),$(".tooltip").removeClass("active"),$(this).addClass("active"))}),$(document).on("click",function(t){var i=$(".tooltip");i.is(t.target)||0!==i.has(t.target).length||$(".tooltip").removeClass("active")})});