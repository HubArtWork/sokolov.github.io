...
$(document).ready(function(){function t(){var t=($(window).height(),$(".main img").width());$(".main-wrap").width(t+"px")}t(),$(window).on("resize",function(){t()}),$("body").on("scroll",function(t){var o=$("body").width(),i=$(".main img").width(),n=100*$("body").scrollLeft()/(i-o);$(".scroll-pos").css("left",n+"%")}),$(window).width()<768&&$(".tooltip").on("click",function(t){$(this).hasClass("active")?$(".tooltip").removeClass("active"):(t.preventDefault(),$(".tooltip").removeClass("active"),$(this).addClass("active"))}),$(document).on("click",function(t){var o=$(".tooltip");o.is(t.target)||0!==o.has(t.target).length||$(".tooltip").removeClass("active")}),$(document).keydown(function(t){t.preventDefault()})});