...
var swiper=new Swiper(".main-slider",{slidesPerView:1,watchOverflow:!0,loop:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}}),swiper=new Swiper(".news-slider",{slidesPerView:1,watchOverflow:!0,pagination:{el:".swiper-pagination",clickable:!0}}),swiper=new Swiper(".mySwiper",{spaceBetween:12,slidesPerView:4,freeMode:!0,watchSlidesProgress:!0,watchSlidesVisibility:!0,watchOverflow:!0,direction:"vertical",navigation:{nextEl:".card-thumbs .swiper-button-next",prevEl:".card-thumbs .swiper-button-prev"}}),swiper2=new Swiper(".mySwiper2",{slidesPerView:1,spaceBetween:10,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},thumbs:{swiper:swiper}}),swiper=new Swiper(".partners-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,navigation:{nextEl:".page-partners-top .swiper-button-next",prevEl:".page-partners-top .swiper-button-prev"},breakpoints:{10:{slidesPerView:1},581:{slidesPerView:"auto"}}});$(document).ready(function(){var e=new Swiper(".reviews-slider",{slidesPerView:"auto",freeMode:!0,watchOverflow:!0,spaceBetween:16,navigation:{nextEl:".reviews-top .swiper-button-next",prevEl:".reviews-top .swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}});if($(".header-bar-main,.menu-top .hb-ico").on("click",function(){$(".menu").toggleClass("active")}),$(".footer-subtitle").on("click",function(){$(this).toggleClass("active").next().slideToggle()}),$(".header-choice, .choice .close-ico, .choice-mob-tit, .menu-link").on("click",function(e){e.preventDefault(),$(this).toggleClass("active"),$(".choice").toggleClass("active"),$(".menu").removeClass("active")}),$(".header-mob .search-ico-white, .searchMd .close-ico").on("click",function(e){e.preventDefault(),$(".searchMd").toggleClass("active")}),$(window).scroll(function(){$(window).outerWidth()<=768&&($(this).scrollTop()>=72?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed"))}),$(".header-btn, .directory .close-ico").on("click",function(e){e.preventDefault(),$(".header-btn").toggleClass("active"),$(".directory").toggleClass("active").removeClass("directory-next")}),$(".directory-mob a").on("click",function(e){e.preventDefault(),$(".directory").toggleClass("directory-next")}),$(".input-search input").on("input",function(){""==$(this).val()?$(this).parents(".input-search").removeClass("active"):$(this).parents(".input-search").addClass("active")}),$(".filter-tit").on("click",function(){$(this).toggleClass("active").next().slideToggle()}),$(".filter-more").on("click",function(e){e.preventDefault(),$(this).toggleClass("active").prev().slideToggle()}),$(".filter-tags li").on("click",function(){$(this).toggleClass("active")}),$(".toggle").on("click",function(){$(this).toggleClass("active"),$(".catalog-all, .catalog-sidebar").toggleClass("active")}),$(".favorite-ico").on("click",function(e){e.preventDefault(),$(this).toggleClass("active")}),$(".catalog-sidebar .close-ico").on("click",function(){$(".catalog-all, .catalog-sidebar").toggleClass("active")}),$(".ordering-sidebar-title,.ordering-sidebar .close-ico").on("click",function(){$(window).outerWidth()<=940&&!$(".ordering").hasClass("ordering-second")&&$(".ordering-sidebar").toggleClass("active")}),$("select").select2({minimumResultsForSearch:-1}),$("select").hasClass("select-tag")&&$("select.select-tag").select2({minimumResultsForSearch:-1,escapeMarkup:function(e){return e=e.split("~"),'<span class="select-sub">'+e[0]+'</span><span class="select-txt">'+e[1]+"</span>"}}),$(".drop").on("click",function(){$(this).hasClass("active")?$(this).removeClass("active"):($(".drop").removeClass("active"),$(this).addClass("active"))}),$(document).on("click",function(e){var t=$(".drop");t.is(e.target)||0!==t.has(e.target).length||$(".drop").removeClass("active")}),$(".drop-list li").on("click",function(){$(this).parents(".drop").find(".drop-top").html($(this).html())}),$(".tab-list li a").on("click",function(t){t.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var i=$(t.target).attr("href");$(i).addClass("tab-active"),$(this).addClass("active"),$(this).parents(".lk-menu")&&($(".lk").addClass("active"),e.update(),$(window).outerWidth()<=940&&$(".lk-sec .section-title").html($(this).text()))}),$(".productsTabs-list li a").on("click",function(e){e.preventDefault()}),$(".lk-back").on("click",function(e){e.preventDefault(),$(".lk").removeClass("active"),$(".lk-menu li a").removeClass("active")}),$(".lk-list li a").on("click",function(t){t.preventDefault(),$(this).parents(".lk-list").find("a").removeClass("active"),$(this).parents(".lkTabs").find(".lkTab").removeClass("lkTab-active");var i=$(t.target).attr("href");$(i).addClass("lkTab-active"),$(this).addClass("active"),e.update()}),$(".i-ico").on("click",function(){$(this).parent().find(".sidebar").toggleClass("active")}),$(".input-fix input,.input-fix textarea").on("focusout",function(){$(this).val().length?$(this).parents(".input-fix").addClass("active"):$(this).parents(".input-fix").removeClass("active")}).on("focus",function(){$(this).parents(".input-fix").addClass("active")}),$(".password-ico").on("click",function(){$(this).hasClass("active")?$(this).removeClass("active").parent().find("input").attr("type","password"):$(this).addClass("active").parent().find("input").attr("type","text")}),$(".card-descr-mob").on("click",function(e){e.preventDefault(),$(this).toggleClass("active").next().slideToggle()}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".modal-btn").on("click",function(e){e.preventDefault();var t=$(this).attr("href");$(t).addClass("active"),$(".modal-overlay").addClass("active"),$("body").addClass("noscroll")}),$(".modal .close-ico,.modal-overlay").on("click",function(e){e.preventDefault(),$(".modal,.modal-overlay").removeClass("active"),$("body").removeClass("noscroll")}),$(".directory-sidebar ul li a").on("click",function(e){e.preventDefault(),$(this).parents(".directory-sidebar ul").find("a").removeClass("active"),$(this).parents(".directory").find(".directory-tab").removeClass("tab-active");var t=$(e.target).attr("href");$(t).addClass("tab-active"),$(this).addClass("active"),$(window).outerWidth()<=940&&$(".directory").addClass("directory-next")}),$("*").is(".ordering-sidebar")){w=$(window).width();var t=$(".ordering-sidebar-wrap"),i=$(t).offset().top-$(".header").outerHeight(),a=$(".ordering-top").outerHeight()+$(".ordering-all").outerHeight();console.log($(".header").outerHeight()+$(".ordering-top").outerHeight()),console.log(a),$(window).on("scroll",function(){console.log($(window).scrollTop()),$(window).scrollTop()>=i?$(window).scrollTop()>=a-$(t).outerHeight()?$(t).removeClass("sidebar-fixed").addClass("sidebar-absolute").css("right","0"):$(t).addClass("sidebar-fixed").removeClass("sidebar-absolute").css("right",($(window).innerWidth()-$(".ordering-all").innerWidth())/2+"px"):$(t).removeClass("sidebar-fixed").removeClass("sidebar-absolute").css("right","0")})}});