...
var swiper=new Swiper(".testimonials-slider",{slidesPerView:2,watchOverflow:!0,spaceBetween:30,navigation:{nextEl:".testimonials-all .swiper-button-next",prevEl:".testimonials-all .swiper-button-prev"},breakpoints:{10:{slidesPerView:1},768:{slidesPerView:2}}});AOS.init({startEvent:"load"}),AOS.refresh(),$(document).ready(function(){if(window.addEventListener("load",AOS.refresh),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".header-menu .drop-text").on("click",function(e){e.preventDefault(),$(window).width()<=920&&$(this).toggleClass("active").parents(".drop").find(".drop-list").slideToggle()}),$(".checkbox-toggle").on("click",function(){$(this).next(".input-tab").slideToggle()}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var a=$(this).attr("href");$(a).addClass("tab-active"),$(this).addClass("active")}),$(".wallet-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".wallet-list").find("a").removeClass("active"),$(this).parents(".wallet").find(".wallet-tab").removeClass("wallet-active");var a=$(this).attr("href");$(a).addClass("wallet-active"),$(this).addClass("active")}),$(".way-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".way-list").find("a").removeClass("active"),$(this).parents(".way").find(".way-tab").removeClass("way-active");var a=$(this).attr("href");$(a).addClass("way-active"),$(this).addClass("active")}),$(".facilities-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".facilities-list").find("a").removeClass("active"),$(this).parents(".facilities").find(".facilities-tab").removeClass("facilities-active");var a=$(this).attr("href");$(a).addClass("facilities-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".modal-bg, .formModal .close-ico,.modal-btn").on("click",function(){$(".modal-bg, .formModal").removeClass("modal-open")}),$(".modal-btn").on("click",function(e){e.preventDefault();var a=$(this).attr("href");$(a).addClass("modal-open"),$(".modal-bg").addClass("modal-open")}),$(".payment-wrap").length>0){$(".payment-wrap p").each(function(){var e=$(this).html();if(e.length>274){var a=e.substr(0,274),t=e.substr(274,e.length-274),s=a+'<span class="moreellipses">...&nbsp;</span><span class="morecontent"><span>'+t+'</span>&nbsp;&nbsp;<a href="" class="morelink">еще</a></span>';$(this).html(s)}}),$(".morelink").click(function(){return $(this).hasClass("less")?($(this).removeClass("less"),$(this).html("еще")):($(this).addClass("less"),$(this).html("cвернуть")),$(this).parent().prev().toggle(),$(this).prev().toggle(),!1})}});