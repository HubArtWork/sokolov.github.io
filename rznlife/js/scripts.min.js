...
var swiper=new Swiper(".main-story__wrapper",{slidesPerView:8,freeMode:!0,watchSlidesVisibility:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:"auto"},600:{slidesPerView:5},650:{slidesPerView:6},769:{slidesPerView:5},970:{slidesPerView:6},1100:{slidesPerView:8}}}),swiper=new Swiper(".categories-wrapper",{slidesPerView:"auto",freeMode:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),swiper=new Swiper(".news-slider",{slidesPerView:1,pagination:{el:".swiper-pagination",clickable:!0}}),swiper=new Swiper(".page-slider",{slidesPerView:1,pagination:{el:".swiper-pagination",clickable:!0}});$(document).ready(function(){$(".search-ico, .header-search .close-ico").on("click",function(){$(".header-search").toggleClass("active"),$(".header-search").hasClass("active")?$(".header-search").animate({width:"100%"},500):$(".header-search").animate({width:"60px"},500)}),$(".search-btn").on("click",function(){$(".header").toggleClass("search-active").removeClass("header-active")}),$(".drop-text").on("click",function(e){e.preventDefault(),$(this).parents(".drop").toggleClass("active")}),$(document).on("click",function(e){var a=$(".drop");a.is(e.target)||0!==a.has(e.target).length||$(".drop").removeClass("active")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active").removeClass("search-active")}),$(".input-block input").on("focusout",function(){""!=$(this).val()?$(this).parent().addClass("has-info active"):$(this).parent().removeClass("has-info active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$('[data-fancybox="images"]').fancybox({fitToView:!1,width:"auto",maxWidth:"100%",fullScreen:{requestOnStart:!0}}),$(".main-story__slide-wrap").fancybox({backFocus:!0,afterShow:function(e,a){e.$refs.stage.find(".fancybox-content").append(e.$refs.caption),$(".fancybox-button.fancybox-button--play").trigger("click")}})});