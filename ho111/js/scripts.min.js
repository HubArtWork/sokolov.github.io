...
$(document).ready(function(){$(".tab-list li a").on("click",function(a){a.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(a.target).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}})});