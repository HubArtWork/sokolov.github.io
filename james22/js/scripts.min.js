...
var swiper=new Swiper(".event-slider",{slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:35,navigation:{nextEl:".event-top .swiper-button-next",prevEl:".event-top .swiper-button-prev"}}),swiper=new Swiper(".event-slider2",{slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:35,navigation:{nextEl:".event-head .swiper-button-next",prevEl:".event-head .swiper-button-prev"}});if(document.getElementsByClassName("header-drop").length){var drop=document.querySelector(".header-drop");drop.onclick=function(e){e.target;this.classList.contains("active")?drop.classList.remove("active"):drop.classList.add("active")},document.addEventListener("click",function(e){drop.contains(e.target)||drop.classList.remove("active")})}if(document.getElementsByClassName("modal").length){for(var overlay=document.getElementById("overlay"),modal=document.getElementsByClassName("modal"),button=document.getElementsByClassName("button-modal"),close=document.getElementsByClassName("modal-close"),i=0;i<button.length;i++)button[i].addEventListener("click",function(e){e.preventDefault();var t=this.getAttribute("href"),o=document.getElementById(t);o.classList.add("open-modal"),overlay.classList.add("open-overlay"),overlay.addEventListener("click",function(){o.classList.remove("open-modal"),overlay.classList.remove("open-overlay")})});for(var j=0;j<close.length;j++)close[j].addEventListener("click",function(e){e.preventDefault(),document.getElementsByClassName("open-modal")[0].classList.remove("open-modal"),overlay.classList.remove("open-overlay")})}