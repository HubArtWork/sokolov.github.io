...
$(document).ready(function(){new Swiper(".main-slider",{slidesPerView:1,watchOverflow:!0,pagination:{el:".swiper-pagination",clickable:!0}}),new Swiper(".news-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:40,navigation:{nextEl:".news .swiper-button-next",prevEl:".news .swiper-button-prev"},breakpoints:{10:{slidesPerView:"auto",spaceBetween:16},769:{slidesPerView:"auto",spaceBetween:40}}}),new Swiper(".purpose-slider",{slidesPerView:4,watchOverflow:!0,spaceBetween:24,navigation:{nextEl:".purpose .swiper-button-next",prevEl:".purpose .swiper-button-prev"},breakpoints:{10:{slidesPerView:2,spaceBetween:16},400:{slidesPerView:2,spaceBetween:16},540:{slidesPerView:3,spaceBetween:16},769:{slidesPerView:4,spaceBetween:24}}}),new Swiper(".buy-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:40,navigation:{nextEl:".buy .swiper-button-next",prevEl:".buy .swiper-button-prev"},breakpoints:{10:{slidesPerView:"auto",spaceBetween:16},769:{slidesPerView:"auto",spaceBetween:40}}}),new Swiper(".partners-slider",{slidesPerView:4,watchOverflow:!0,spaceBetween:40,navigation:{nextEl:".partners .swiper-button-next",prevEl:".partners .swiper-button-prev"},breakpoints:{10:{slidesPerView:2},400:{slidesPerView:2},540:{slidesPerView:3},769:{slidesPerView:4}}}),new Swiper(".event-slider",{slidesPerView:1,watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}});$(".header-bar,.header-bg").on("click",function(){$("body").toggleClass("header-active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(e.target).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".about-img-main-img").on("click",function(){$(".about-md").removeClass("active"),$("#"+$(this).attr("data-md")).addClass("active")}),$(".about-md .close-ico").on("click",function(){$(this).parents(".about-md").removeClass("active")}),$(document).on("click",function(e){var t=$(".about-img");t.is(e.target)||0!==t.has(e.target).length||$(".about-md").removeClass("active")}),$(".direction-item-img-1").on("click",function(){$(".direction-item").removeClass("active"),$(this).parents(".direction-item").addClass("active")}),$(".direction-item-info .close-ico").on("click",function(){$(this).parents(".direction-item").toggleClass("active")}),$(document).on("click",function(e){var t=$(".direction-item");t.is(e.target)||0!==t.has(e.target).length||$(".direction-item").removeClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}})});