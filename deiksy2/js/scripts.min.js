...
var swiper=new Swiper(".main-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:10,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0}}),swiper=new Swiper(".categories-slider",{slidesPerView:"auto",watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:8,navigation:{nextEl:".categories-all .swiper-button-next",prevEl:".categories-all .swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:"auto",spaceBetween:16},769:{spaceBetween:8}}}),swiper=new Swiper(".sales-slider-1",{slidesPerView:"auto",watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:11,navigation:{nextEl:".sales-1 .sales-all .swiper-button-next",prevEl:".sales-1 .sales-all .swiper-button-prev"}}),swiper=new Swiper(".sales-block-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:11,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),swiper=new Swiper(".sales-slider-2",{slidesPerView:"auto",watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:11,navigation:{nextEl:".sales-2 .sales-all .swiper-button-next",prevEl:".sales-2 .sales-all .swiper-button-prev"}}),swiper=new Swiper(".events-slider",{slidesPerView:"auto",watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:8,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:"auto",spaceBetween:16},769:{spaceBetween:8}}}),swiper=new Swiper(".testimonials-slider",{slidesPerView:"auto",watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:40,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:"auto",spaceBetween:16},769:{spaceBetween:40}}}),swiper=new Swiper(".card-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,spaceBetween:0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:"auto",spaceBetween:16},981:{slidesPerView:0}}});$(document).ready(function(){if($(".header-bar").on("click",function(){$(".header").toggleClass("header-active"),$(".mobile").toggleClass("active")}),$(".header-drop-top").on("click",function(){$(".header-drop").toggleClass("active")}),$(document).on("click",function(e){var i=$(".header-drop");i.is(e.target)||0!==i.has(e.target).length||$(".header-drop").removeClass("active")}),$(".search,.search-close").on("click",function(){$(".search").toggleClass("active")}),$(".catalog-filter-btn,.catalog-sidebar-head-mob .page-title").on("click",function(e){e.preventDefault(),$(".catalog-sidebar").toggleClass("active")}),$(".catalog-sidebar-tit").on("click",function(e){e.preventDefault(),$(this).parents(".catalog-sidebar-block").toggleClass("active").find(".catalog-sidebar-drop").slideToggle()}),0!=$("#slider-range-1").length&&($("#slider-range-1").slider({range:!0,min:0,max:3e3,values:[0,1e3],slide:function(e,i){$("#search-price-1").val(i.values[0]),$("#search-price-2").val(i.values[1])}}),$("#search-price-1").val($("#slider-range-1").slider("values",0)),$("#search-price-2").val($("#slider-range-1").slider("values",1))),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-main")?$(this).parents(".accordeon").removeClass("accordeon-main"):($(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents())}),$("*").is(".card-content-wrap")){var e=$(".card-content-wrap"),i=$(e).offset().top-$(".header").height()-10,a=$(".card-all").height()+130;$(window).on("scroll",function(){$(window).scrollTop()>=i?$(window).scrollTop()>=a-$(e).height()?$(e).removeClass("sidebar-fixed").addClass("sidebar-absolute").css("right","0"):$(e).addClass("sidebar-fixed").removeClass("sidebar-absolute").css("right",($(window).innerWidth()-$(".card .wrapper").innerWidth())/2+($(".card .wrapper").innerWidth()-$(".card .wrapper").width())/2+"px").css("width",$(".card-content").width()):$(e).removeClass("sidebar-fixed").removeClass("sidebar-absolute").css("right","0")})}$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}}),$.fancybox.defaults.closeExisting=!0});