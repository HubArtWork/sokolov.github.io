...
var swiper=new Swiper(".actions-slider",{slidesPerView:3,watchOverflow:!0,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},641:{slidesPerView:2},769:{slidesPerView:2},970:{slidesPerView:3}}});$(document).ready(function(){$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1})});