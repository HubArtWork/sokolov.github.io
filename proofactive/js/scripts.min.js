...
var swiper=new Swiper(".main-slider",{slidesPerView:1,watchOverflow:!0,effect:"fade",navigation:{nextEl:".main .swiper-button-next",prevEl:".main .swiper-button-prev"}});AOS.init({startEvent:"load"}),AOS.refresh(),$(document).ready(function(){window.addEventListener("load",AOS.refresh),$(".header .header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".personalArea .header-bar").on("click",function(){$(".sidebar,.personalArea-bar").toggleClass("active")}),$(".payment-item").on("click",function(){$(this).parents(".payment-block").hasClass("active")?$(".payment-item").parents(".payment-block").removeClass("active").find(".payment-drop").slideUp():($(".payment-item").parents(".payment-block").removeClass("active").find(".payment-drop").slideUp(),$(this).parents(".payment-block").addClass("active").find(".payment-drop").slideDown())}),$(".add-link").on("click",function(e){e.preventDefault(),$(this).hasClass("active")?($(".add-link").removeClass("active").text("Add new point"),$(".template-drop").slideUp()):($(".add-link").addClass("active").text("Cancel"),$(".template-drop").slideDown())}),$(".advantages-top").on("click",function(){$(this).parents(".advantages-block").toggleClass("active").find(".advantages-drop").slideToggle()}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var a=$(e.target).attr("href");$(a).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".drop-top").on("click",function(e){e.preventDefault(),$(this).parents(".drop").hasClass("active")?$(".drop").removeClass("active"):($(".drop").removeClass("active"),$(this).parents(".drop").addClass("active"))}),$(document).on("click",function(e){var a=$(".drop");a.is(e.target)||0!==a.has(e.target).length||$(".drop").removeClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}})});