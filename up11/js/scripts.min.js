...
$(document).ready(function(){function e(e){return e.id?$('<span class="'+e.element.value+'">'+e.text+"</span>"):e.text}$(".drop-top").on("click",function(e){e.preventDefault(),$(this).parents(".drop").hasClass("active")?$(".drop").removeClass("active"):($(".drop").removeClass("active"),$(this).parents(".drop").addClass("active"))}),$(document).on("click",function(e){var t=$(".drop");t.is(e.target)||0!==t.has(e.target).length||$(".drop").removeClass("active")}),$(".header-bar,.sidebar-mob").on("click",function(){$(".page").toggleClass("sidebar-active")}),$(".content-top .pencil-ico").on("click",function(e){e.preventDefault(),$(".content-top").toggleClass("active"),setTimeout(function(){$(".content-top .pencil-input input").focus()},200)}),$(document).on("click",function(e){var t=$(".pencil-input,.content-top .pencil-ico");t.is(e.target)||0!==t.has(e.target).length||$(".content-top").removeClass("active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(e.target).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".payment-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".payment-list").find("a").removeClass("active"),$(this).parents(".payment").find(".payment-block").removeClass("active");var t=$(this).attr("href");$(t).addClass("active"),$(this).addClass("active")}),$(".recipients-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".recipients-list").find("a").removeClass("active"),$(this).parents(".recipients").find(".recipients-block").removeClass("active");var t=$(this).attr("href");$(t).addClass("active"),$(this).addClass("active")}),$(".modal-bg, .formModal .close-ico,.modal-btn").on("click",function(){$(".modal-bg, .formModal").removeClass("modal-open")}),$(".modal-btn").on("click",function(e){e.preventDefault();var t=$(this).attr("href");$(t).addClass("modal-open"),$(".modal-bg").addClass("modal-open")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".select").on("click",function(e){if(!$(this).hasClass("select-hid"))if($(this).hasClass("active")){var t=e.target,a=$(this).find(".select-text"),i=$(this).find(".select-value");"LI"==t.tagName?($(a).text($(t).text()),$(i).val($(t).text())):"A"==t.tagName&&(e.preventDefault(),$(a).html($(t).html()),$(i).val($(t).text())),$(this).removeClass("active")}else $(".select").removeClass("active"),$(this).addClass("active")}),$(document).on("click",function(e){var t=$(".select");t.is(e.target)||0!==t.has(e.target).length||$(".select").removeClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1});var t=$(".select-second").html();if($(".pricing-wrap-1 .select-main,.pricing-wrap-1 .select-second,.pricing-wrap-2 .select-main,.pricing-wrap-2 .select-second").on("change",function(){"product-1"==$(this).val()&&$(this).parents(".pricing-wrap").removeClass("range-notActive")}),$(".pricing-selects .select-main").on("change",function(){var e=this.value,a=$(this).parents(".pricing-selects").find(".select-second");$(a).html(t),$(a).find("option[value="+e+"]").remove()}),$(".pricing-selects .select-second").on("change",function(){if(!$(this).parents(".pricing-wrap").hasClass("priceChange")){var e=$(this).parents(".pricing-wrap"),t=$(e).find(".pricing-price b"),a=parseInt($(t).text());$(t).text(a+19),$(e).addClass("priceChange")}}),0!=$("#range-1").length){var a=($("#range-1-text"),parseInt($("#range-1").parents(".pricing-range").attr("data-step"))),i=parseInt($("#range-1-text").text());$("#range-1").slider({range:"min",value:1e4,min:1e4,step:a,max:1e5,slide:function(e,t){$("#range-1").parents(".pricing-wrap").hasClass("priceChange")?$("#range-1-text").text(i+19+(t.value-1e4)/a*10):$("#range-1-text").text(i+(t.value-1e4)/a*10),$(this).parents(".pricing-range").find("p").find("span").text(t.value.toLocaleString())}}),$(this).parents(".pricing-range").find("p").find("span").text($("#range-1").slider("value"))}if(0!=$("#range-2").length){var n=$("#range-2-text"),s=parseInt($("#range-2").parents(".pricing-range").attr("data-step")),c=parseInt($(n).text());$("#range-2").slider({range:"min",value:1e4,min:1e4,step:s,max:1e5,slide:function(e,t){$("#range-2-text").text(c+(t.value-1e4)/a*10),$(this).parents(".pricing-range").find("p").find("span").text(t.value.toLocaleString())}}),$(this).parents(".pricing-range").find("p").find("span").text($("#range-2").slider("value"))}0!=$(".select-second").length&&$(".select-second").select2({placeholder:"Additional products (optional)"}),0!=$(".js-example-basic-multiple").length&&$(".js-example-basic-multiple").select2({placeholder:"Select services (optional)"}),0!=$(".select-category").length&&$(".select-category").select2({placeholder:"Category"}),0!=$(".js-example-basic-single").length&&$(".js-example-basic-single").select2({placeholder:"Rate"}),0!=$(".blockFix-select").length&&$(".blockFix-select").select2({placeholder:"Save"}),$(".sidebar").mouseover(function(){$(window).outerWidth()<=1600&&$(".content").addClass("pad-active")}).mouseout(function(){$(window).outerWidth()<=1600&&$(".content").removeClass("pad-active")}),$("table thead th .checkbox input").on("click",function(){var e=$(this).parents(".table-wrap");$(this).is(":checked")?(e.find(".checkbox input").prop("checked",!0),e.find(".sort").addClass("active"),setTimeout(function(){e.find(".sort").addClass("animate")},100)):(e.find(".checkbox input").prop("checked",!1),e.find(".sort").removeClass("active animate"))}),$("table tbody td .checkbox input").on("click",function(){$(this).parents("table").find("thead th input").prop("checked",!1),$(this).parents("tbody").find("input").each(function(){if($(this).parents("tbody").find("input:checked").length>1){var e=$(this);$(this).parents(".table-wrap").find(".sort").addClass("active"),setTimeout(function(){e.parents(".table-wrap").find(".sort").addClass("animate")},100)}else $(this).parents(".table-wrap").find(".sort").removeClass("active animate")})}),$(".animation-btn").on("click",function(e){e.preventDefault(),$(".emailCustomer-img").addClass("active")}),$(".pipeline-history__add").on("click",function(){$(".pipeline-history__form").slideToggle()}),$(".pipeline-history__item").on("click",function(){$(this).toggleClass("active")}),$(".select").length>0&&$(".select-color select").select2({minimumResultsForSearch:1/0,placeholder:"Color",templateResult:e,templateSelection:e}),0!=$(".droppable-area1").length&&function(){$(".droppable-area1, .droppable-area2").sortable({connectWith:".pipeline-content",stack:".pipeline-content .pipeline-content"}).disableSelection()}(),$(".steps-item .steps-btn").on("click",function(e){e.preventDefault(),$(this).parent(".steps-item").toggleClass("active")}),$(document).on("input",".addCategory-input",function(){$(this).val().length>2?$(".addCategory").addClass("addCategory-active"):$(".addCategory").removeClass("addCategory-active")}),$(".addCategory-btn .second-btn").on("click",function(e){return e.preventDefault(),$(".addCategory-block").append("<div class='addCategory-item'><div class='input-block'><input class='addCategory-input' type='text' name='text' placeholder='Category'></div><div class='input-block'><select name='text'><option value=''>Select services (optional)</option><option value=''>Select services (optional)</option></select></div><div class='txt-btn'><a href='#'>cancel</a></div></div>"),!1}),$(".addCategory-item .primary-btn").on("click",function(e){e.preventDefault(),$(this).parent().remove()}),$(".libraryAdd-ico").on("click",function(){var e=$(this).parents(".invoices-profile__table-row").clone();return $(this).parents(".invoices-profile__table-row").clone(e).appendTo(".invoices-profile__table"),!1}),$(".invoices-profile__btn .primary-btn").on("click",function(e){return e.preventDefault(),$(".invoices-profile__table").append("<div class='invoices-profile__table-row'><div class='invoices-profile__table-col col-1'><input type='text' name='text' placeholder='Item Name/description'></div><div class='invoices-profile__table-col col-2'><input type='number' name='number' placeholder='$0.00'></div><div class='invoices-profile__table-col col-3'><input type='number' name='number' placeholder='$0.00'></div><div class='invoices-profile__table-col col-4'><div class='checkbox'><input type='checkbox'><i class='checkbox-ico'></i></div></div><div class='invoices-profile__table-col col-5'><div class='invoices-profile__table-amount'>$0.00</div></div><i class='hb-ico delete-ico'></i><i class='hb-ico libraryAdd-ico'></i></div>"),!1}),$(".invoices-profile__table .delete-ico").on("click",function(){$(this).parents(".invoices-profile__table-row").remove()}),$(".invoices-profile__table .col-2 input, .invoices-profile__table .col-3 input").on("input",function(){$(this).val().length>0?$(this).parents(".invoices-profile__table-col").addClass("active"):$(this).parents(".invoices-profile__table-col").removeClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1,beforeShow:function(){$("html").css({"overflow-y":"hidden"})},afterClose:function(){$("html").css({"overflow-y":"visible"})}}),0!=$(".dataTable").length&&$(".dataTable").DataTable(),$(".checkbox-partial input").on("click",function(){var e=$(this).parents(".blockFix");$(this).is(":checked")?e.addClass("active"):e.removeClass("active")}),$(".nameYou").on("click",function(e){e.preventDefault(),$(".invoices-profile__change").toggleClass("active")})});