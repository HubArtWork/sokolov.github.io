...
$(document).ready(function(){$(".header-list").on("click","a",function(e){e.preventDefault();var i=$(this).attr("href"),t=$(i).offset().top;$("html, body").animate({scrollTop:t-$(".header").outerHeight()},900),$(".header").removeClass("header-active")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".services-item__top").on("click",function(){$(window).width()<=768&&($(this).parents(".services-item").hasClass("active")?$(".services-item").removeClass("active").find(".services-item__info").slideUp():($(".services-item").removeClass("active").find(".services-item__info").slideUp(),$(this).parents(".services-item").addClass("active").find(".services-item__info").slideDown()))}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1})});