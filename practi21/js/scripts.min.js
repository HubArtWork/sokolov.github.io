...
AOS.init({startEvent:"load"}),AOS.refresh();var swiper=new Swiper(".products-slider",{slidesPerView:4,spaceBetween:30,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:1},576:{slidesPerView:2},768:{slidesPerView:3},992:{slidesPerView:4}}}),galleryThumbs=new Swiper(".book-images .gallery-thumbs",{spaceBetween:30,slidesPerView:3,loop:!0,freeMode:!0,watchSlidesVisibility:!0,watchSlidesProgress:!0}),galleryTop=new Swiper(".book-slider",{loop:!0,loopedSlides:3,thumbs:{swiper:galleryThumbs}});$(document).ready(function(){if(window.addEventListener("load",AOS.refresh),$(".header-link__top,.header-link .close-ico").on("click",function(e){e.preventDefault(),$(this).parents(".header-link").hasClass("active")?$(".header-link").removeClass("active"):($(".header-link").removeClass("active"),$(this).parents(".header-link").addClass("active"))}),$(document).on("click",function(e){var t=$(".header-link");t.is(e.target)||0!==t.has(e.target).length||$(".header-link").removeClass("active")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".drop-text").on("click",function(e){e.preventDefault(),$(window).width()<=870&&$(this).parents(".drop").toggleClass("active").find(".drop-list").slideToggle()}),$(".tab-list a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var t=$(this).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".select").on("click",function(e){if(!$(this).hasClass("select-hid"))if($(this).hasClass("active")){var t=e.target,a=$(this).find(".select-text"),s=$(this).find(".select-value");"LI"==t.tagName?($(a).text($(t).text()),$(s).val($(t).text())):"A"==t.tagName&&(e.preventDefault(),$(a).html($(t).html()),$(s).val($(t).text()),"Child"==$(t).text()?$(this).parents(".form").addClass("form-age"):$(this).parents(".form").removeClass("form-age")),$(this).removeClass("active")}else $(".select").removeClass("active"),$(this).addClass("active")}),$(document).on("click",function(e){var t=$(".select");t.is(e.target)||0!==t.has(e.target).length||$(".select").removeClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".scrollbar-outer").scrollbar(),$(".modal-bg, .formModal .close-ico,.modal-btn").on("click",function(){$(".modal-bg, .formModal").removeClass("modal-open"),0!=$(".catalog-sidebar").length&&$(".catalog-sidebar").removeClass("active")}),$(".modal-btn").on("click",function(e){e.preventDefault();var t=$(this).attr("href");$(t).addClass("modal-open"),$(".modal-bg").addClass("modal-open")}),$(".sidebar-btn,.sidebar-mob,.filter-btn").on("click",function(e){e.preventDefault(),$(".catalog-sidebar").toggleClass("active"),$(".modal-bg").toggleClass("modal-open")}),$(".sidebar-top").on("click",function(){$(this).parents(".sidebar-block").toggleClass("active").find(".sidebar-content").slideToggle()}),$(".sidebar-block.active").find(".sidebar-content").slideDown(),$(".question-modal .question-close").on("click",function(){$(".question-modal").toggleClass("active")}),0!=$(".input-fullName").length&&$(".input-fullName").keyup(function(){var e=$(this).val().split(" ")[0];""==e?$(".label-fullName").text(""):$(".label-fullName").text(", "+e)}),$(".time-input").mask("99  :  99"),$(".animation-btn").on("click",function(e){e.preventDefault();var t=$(this).attr("href");$(t).addClass("open"),setTimeout(function(){$(".modalAnimation").removeClass("open")},1e3)}),$(".book-like").on("click",function(e){e.preventDefault(),$(this).toggleClass("active")}),$(".donate-checkbox input").change(function(){$(".donate-block").slideToggle()}),$(".modalFixed .close-ico").on("click",function(){$(".modalFixed").css("display","none"),$(".receipt").addClass("receipt-close")}),$(".book-star").on("click",function(){$(this).toggleClass("active")}),0!=$(".catalog").length&&$(window).on("scroll",function(){var e=$(".catalog").position().top;$(this).scrollTop()>=e?$(".catalog").addClass("filterFixed"):$(".catalog").removeClass("filterFixed")}),$(".profile-sidebar__mob .primary-btn, .profile-sidebar__info .close-ico").on("click",function(e){e.preventDefault(),$(".profile-sidebar__info").toggleClass("active")}),$(".open-sidebar, .sitemap-sidebar .close-ico").on("click",function(e){e.preventDefault(),$(".sitemap-sidebar").toggleClass("active")}),$(".sitemap-drop .sitemap-link").on("click",function(e){e.preventDefault(),$(this).parents(".sitemap-block").toggleClass("active").find(".sitemap-list").slideToggle()}),$(".chooseDate-col").on("click",function(){$(this).toggleClass("active")}),$(".link-add").on("click",function(e){e.preventDefault(),$(this).addClass("active")}),$("*").is(".book-sidebar")){w=$(window).width();var e=$(".book-sidebar"),t=$(e).offset().top-20,a=$(".page-book").height()+$(".review").height();$(window).on("scroll",function(){$(window).scrollTop()>=t?$(window).scrollTop()>=a-$(e).height()?$(e).removeClass("sidebar-fixed").addClass("sidebar-absolute").css("right","0"):$(e).addClass("sidebar-fixed").removeClass("sidebar-absolute").css("right",($(window).innerWidth()-$(".book").innerWidth())/2+($(".book").innerWidth()-$(".book").width())/2+"px"):$(e).removeClass("sidebar-fixed").removeClass("sidebar-absolute").css("right","0")})}$(".book-more").on("click",function(e){e.preventDefault();var t=$(this).text().toUpperCase();"SHOW MORE"===t?(t="Show less",$(this).addClass("active").prev().removeClass("hideContent").addClass("showContent")):(t="Show more",$(this).removeClass("active").prev().removeClass("showContent").addClass("hideContent")),$(this).text(t)})});