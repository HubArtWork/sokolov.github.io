...
var swiper=new Swiper(".cost-slider",{slidesPerView:3,watchSlidesVisibility:!0,allowTouchMove:!1,pagination:{el:".cost .swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1,autoHeight:!0},600:{slidesPerView:1},650:{slidesPerView:2},768:{slidesPerView:2,autoHeight:!1},1100:{slidesPerView:3}}}),swiper=new Swiper(".testimonials-slider",{slidesPerView:3,watchSlidesVisibility:!0,pagination:{el:".testimonials .swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1,autoHeight:!0},600:{slidesPerView:1},650:{slidesPerView:2},768:{slidesPerView:2,autoHeight:!1},1100:{slidesPerView:3}}});AOS.init({startEvent:"load"}),new TypeIt("#main-text",{strings:"управления бизнесом",speed:80,waitUntilVisible:!0}).go();var scene=document.getElementById("scene"),parallax=new Parallax(scene);$(document).ready(function(){window.addEventListener("load",AOS.refresh),$(window).on("scroll",function(){$(window).scrollTop()>200?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed")}),$(".pagePagination").on("click","a",function(e){e.preventDefault();var a=$(this).attr("href"),i=$(a).offset().top;$("html, body").animate({scrollTop:i-$(".header").outerHeight()},900)}),$("*").is(".pagePagination")&&$(window).scroll(function(){$(".section-scroll").each(function(e,a){var i=$(a).offset().top-100,t=i+$(a).height(),n=$(window).scrollTop(),s=$(a).attr("id");n>i&&n<t&&($(".pagePagination li a.active").removeClass("active"),$('.pagePagination li a[href="#'+s+'"]').addClass("active"),"about"==s||"advantages"==s||"functionality"==s||"personalAccount"==s||"testimonials"==s?$(".pagePagination").addClass("pagePagination-dark"):$(".pagePagination").removeClass("pagePagination-dark"))})}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var a=$(e.target).attr("href");$(a).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".accordeon-active").find(".accordeon-block").slideDown(),$(".input-tel").mask("+9 (999) 999-99-99"),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}}),$(".scrollbar-outer").scrollbar(),0!=$("#range-1").length&&$("#range-1").slider({min:1,max:10,step:1,value:5,range:"min",slide:function(e,a){var i=a.value;$(this).parents(".cost-range").find(".cost-range__num").text(i)}}),0!=$("#range-2").length&&$("#range-2").slider({min:1,max:18,step:1,value:12,range:"min",slide:function(e,a){var i=a.value;$(this).parents(".cost-range").find(".cost-range__num").text(i)}}),0!=$("#range-3").length&&$("#range-3").slider({min:1,max:10,step:1,value:5,range:"min",slide:function(e,a){var i=a.value;$(this).parents(".cost-range").find(".cost-range__num").text(i)}})});