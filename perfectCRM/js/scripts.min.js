...
var swiper=new Swiper(".cost-slider",{slidesPerView:3,watchSlidesVisibility:!0,allowTouchMove:!1,pagination:{el:".cost .swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1,autoHeight:!0},600:{slidesPerView:1},700:{slidesPerView:2},768:{slidesPerView:2,autoHeight:!1},1100:{slidesPerView:3}}}),swiper=new Swiper(".testimonials-slider",{slidesPerView:3,watchSlidesVisibility:!0,pagination:{el:".testimonials .swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1,autoHeight:!0},600:{slidesPerView:1},650:{slidesPerView:2},768:{slidesPerView:2,autoHeight:!1},1100:{slidesPerView:3}}});if(AOS.init({startEvent:"load"}),0!=$("#main-text").length&&new TypeIt("#main-text",{strings:"управления производством",speed:140,waitUntilVisible:!0}).delete(24).type("управления бизнесом").go(),0!=$("#scene").length)var scene=document.getElementById("scene"),parallax=new Parallax(scene);$(document).ready(function(){function e(e){e+="",x=e.split("."),x1=x[0],x2=x.length>1?"."+x[1]:"";for(var a=/(\d+)(\d{3})/;a.test(x1);)x1=x1.replace(a,"$1 $2");return x1+x2}function a(){var a=0;$(".cost-first .checkbox input").is(":checked")&&(a=2e4);var t=parseInt($("#numberOfUsers").text()),i=parseInt($("#numberOfMonths").text()),n=Math.floor(i/12*(18e3+a)*t+3e4);$(".cost-first .cost-num").text(e(n)+" р")}function t(){var a=0;$(".cost-second .checkbox input").is(":checked")&&(a=15e4);var t=parseInt($("#numberOfUsers2").text()),i=Math.floor(12e4+12e3*t+a);$(".cost-second .cost-num").text(e(i)+" р")}window.addEventListener("load",AOS.refresh),setTimeout(function(){0!=$("video").length&&($("video").get(0).play(),$("video").length>2&&($("video").get(1).play(),$("video").get(2).play()))},1e3),$(window).on("scroll",function(){$(".header").removeClass("header-active"),$(window).scrollTop()>2?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed")}),$(".pagePagination").on("click","a",function(e){e.preventDefault();var a=$(this).attr("href"),t=$(a).offset().top;$("html, body").animate({scrollTop:t-$(".header").outerHeight()},900)}),$("*").is(".pagePagination")&&$(window).scroll(function(){$(".section-scroll").each(function(e,a){var t=$(a).offset().top-100,i=t+$(a).height(),n=$(window).scrollTop(),s=$(a).attr("id");n>t&&n<i&&($(".pagePagination li a.active").removeClass("active"),$('.pagePagination li a[href="#'+s+'"]').addClass("active"),"about"==s||"advantages"==s||"functionality"==s||"personalAccount"==s||"testimonials"==s?$(".pagePagination").addClass("pagePagination-dark"):$(".pagePagination").removeClass("pagePagination-dark"))})}),$(".header-bar, .header-link").on("click",function(e){e.preventDefault(),$(this).hasClass("header-bar")&&$(".header").removeClass("header-open-menu").toggleClass("header-open-btn header-active"),$(this).hasClass("header-link")&&$(".header").removeClass("header-open-btn").toggleClass("header-open-menu header-active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var a=$(e.target).attr("href");$(a).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".accordeon-active").find(".accordeon-block").slideDown(),$(".input-tel").mask("+9 (999) 999-99-99"),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}}),$(".cost-slide .primary-btn, .cost-slide .second-btn").on("click",function(){var e=$(this).parents(".cost-wrap").find(".cost-title").text();$("#modal-input").val(e),console.log($("#modal-input").val())}),0!=$("#range-1").length&&$("#range-1").slider({min:3,max:50,step:1,value:5,range:"min",slide:function(e,t){var i=t.value;$(this).parents(".cost-range").find(".cost-range__num").text(i),a()}}),0!=$("#range-2").length&&$("#range-2").slider({min:12,max:60,step:12,value:12,range:"min",slide:function(e,t){var i=t.value;$(this).parents(".cost-range").find(".cost-range__num").text(i),a()}}),0!=$("#range-3").length&&$("#range-3").slider({min:1,max:100,step:1,value:5,range:"min",slide:function(e,a){var i=a.value;$(this).parents(".cost-range").find(".cost-range__num").text(i),t()}}),$(".cost .checkbox input").change(function(){a(),t()}),$(".cookie .primary-btn").on("click",function(e){e.preventDefault(),$(".cookie").remove()})});