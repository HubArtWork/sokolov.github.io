...
var swiper=new Swiper(".job-slider",{slidesPerView:"auto",freeMode:!1,watchSlidesVisibility:!0,spaceBetween:10}),swiper=new Swiper(".card-slider",{slidesPerView:4,freeMode:!1,watchSlidesVisibility:!0,spaceBetween:20,breakpoints:{10:{slidesPerView:1,spaceBetween:10},570:{slidesPerView:2,spaceBetween:10},720:{slidesPerView:3,spaceBetween:10},1025:{slidesPerView:3,spaceBetween:10},1240:{slidesPerView:4,spaceBetween:10},1440:{slidesPerView:4,spaceBetween:20}}}),swiper=new Swiper(".vacancies-slider",{slidesPerView:"auto",freeMode:!1,watchSlidesVisibility:!0,spaceBetween:10,freeMode:!0,centeredSlides:!0,loop:!0,breakpoints:{10:{spaceBetween:10},769:{spaceBetween:20}}}),swiper=new Swiper(".space-slider",{slidesPerView:"auto",freeMode:!1,watchSlidesVisibility:!0,spaceBetween:10,freeMode:!0,centeredSlides:!0,loop:!0,breakpoints:{10:{spaceBetween:10},769:{spaceBetween:20}}});$(document).ready(function(){function e(){var e=$(".blog-block").eq(0).height();$(".blog-all").css("min-height",e)}$(".blog-all").length&&(e(),$(window).on("resize",function(){e()})),$(window).on("scroll",function(){$(this).scrollTop()>$(this).height()?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed")}),$(".header-bar,.header-br").on("click",function(){$(this).hasClass("header-bar")&&$(window).outerWidth()<=720?$(".menu,.header").toggleClass("active"):$(".header-all").toggleClass("active")}),$(".menu-link").on("click",function(e){e.preventDefault();var a=$(this).attr("href");$(".menu-block").removeClass("active"),$(a).addClass("active"),$(".menu-main").addClass("close")}),$(".menu-back").on("click",function(e){e.preventDefault(),$(this).parents().hasClass("menu-block-main")?($(".menu-block").removeClass("active"),$(".menu-main").removeClass("close")):($(".menu-block").removeClass("active"),$(".menu-block").eq(0).addClass("active"))}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var a=$(e.target).attr("href");$(a).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}})});