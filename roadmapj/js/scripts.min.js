...
var swiper=new Swiper(".mySwiper",{direction:"vertical",autoHeight:!0,spaceBetween:10,effect:"fade",loop:!1,grabCursor:!0,speed:500,fadeEffect:{crossFade:!0},on:{slideChange:function(e){$(".roadmap-item").removeClass("active"),$("#date-"+(e.activeIndex+1)).parents(".roadmap-item").addClass("active")}}});$(".roadmap-item-wrap").on("click",swiper,function(){var e=$(this).attr("id").replace(/[^+\d]/g,"");swiper.slideTo(e-1),$(".roadmap-item").removeClass("active"),$(this).parents(".roadmap-item").addClass("active")});