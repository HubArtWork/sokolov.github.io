...
var swiper=new Swiper(".objects-slider",{slidesPerView:"auto",watchOverflow:!0,watchSlidesVisibility:!0,spaceBetween:25,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{10:{slidesPerView:"auto",spaceBetween:10},900:{spaceBetween:25}}}),swiper=new Swiper(".mySwiper",{spaceBetween:10,slidesPerView:"auto",watchSlidesProgress:!0,loop:!0,centeredSlides:!0,navigation:{nextEl:".card-top-wrap .swiper-button-next",prevEl:".card-top-wrap .swiper-button-prev"},pagination:{el:".card-top-wrap .swiper-pagination",type:"bullets"}});$(document).ready(function(){$(window).on("scroll",function(){$(this).scrollTop()>20?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed")}),$(".header-menu").on("click","a",function(e){if(0!=!$(".header-second").length){e.preventDefault();var a=$(this).attr("href"),t=$(a).offset().top;$("html, body").animate({scrollTop:t-$(".header").outerHeight()},900),$(".header").removeClass("header-active")}}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".input-block input").focus(function(){$(this).parents(".input-block").addClass("focused")}),$(".input-block input").blur(function(){""==$(this).val()?($(this).removeClass("filled"),$(this).parents(".input-block").removeClass("focused")):$(this).addClass("filled")}),$(".partners-mob .primary-btn").on("click",function(e){e.preventDefault(),$(".partners-block").toggleClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}}),$(".modal-button .primary-btn").click(function(e){e.preventDefault(),$.fancybox.close()}),$(".modal-btn .primary-btn").on("click",function(e){e.preventDefault(),$(this).parents(".modal-step").removeClass("active").next().addClass("active"),$(".modal-step.active").hasClass("modal-step-last")&&$(".modal-passed").parents(".modal").addClass("modal-act")})});