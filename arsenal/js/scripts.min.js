...
function loadAfterTime(){var e=new Swiper(".main-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,effect:"fade",noSwiping:!0,allowTouchMove:!1,speed:1e3,pagination:{el:".swiper-pagination",clickable:!0},autoplay:{delay:3e3,disableOnInteraction:!0}});e.el.addEventListener("mouseenter",function(t){e.autoplay.stop()},!1),e.el.addEventListener("mouseleave",function(t){e.autoplay.start()},!1);var t=document.querySelector("#main-name-1"),n=document.querySelector("#main-name-2"),i=document.querySelector("#main-name-3");t.addEventListener("click",function(t){"click"==t.type&&e.slideNext()}),n.addEventListener("click",function(t){"click"==t.type&&e.slideNext()}),i.addEventListener("click",function(t){"click"==t.type&&e.slideTo(0,0)})}function menuOpen(e){"click"==e.type&&header.classList.toggle("header-active")}setTimeout(loadAfterTime,1900);var bar=document.querySelector(".header-bar"),header=document.querySelector("body");bar.addEventListener("click",menuOpen);var allPanels=document.querySelectorAll(".header-menu ul");document.querySelector(".header-menu").addEventListener("click",function(e){if(e.target.classList.contains("header-subtitle")){var t=e.target.nextElementSibling;slideToggle(t,200),allPanels.forEach(function(e){"none"!==e.style.display&&e!==t&&slideUp(e,200)})}});