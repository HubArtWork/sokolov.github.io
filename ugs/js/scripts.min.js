...
$(function(){AOS.init()}),$(document).ready(function(){if(window.addEventListener("load",AOS.refresh),$(window).on("scroll",function(){$(this).scrollTop()>0?$(".header").addClass("header-fixed"):$(".header").removeClass("header-fixed")}),$(".modal-btn").on("click",function(e){e.preventDefault(),$(".forms,.forms-bg,.forms-tab").removeClass("open");var t=$(this).attr("href");$(t).addClass("open"),$(".forms,.forms-bg").addClass("open")}),$(".forms-bg,.forms-back").on("click",function(){$(".forms,.forms-bg,.forms-tab").removeClass("open")}),$("#range").length&&(noUiSlider.create(range,{start:0,step:1,animate:!1,connect:"lower",range:{min:1,max:7},decimals:0}),range.noUiSlider.on("update",function(e,t){$(".owl-carousel").trigger("to.owl.carousel",e[t]/100*100)})),$(".owl-carousel").owlCarousel({margin:10,loop:!0,autoWidth:!0,items:4,center:!0,onInitialized:function(e){console.log("we1")}}),$(".owl-carousel").on("changed.owl.carousel",function(e){console.log(e.item.index)}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active"),$(".forms,.forms-bg,.forms-tab").removeClass("open")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(".tab-list li a").removeClass("active"),$(".tab").removeClass("tab-active");var t=$(e.target).attr("href");$(t).addClass("tab-active"),$(this).addClass("active")}),$(".profile-accordeon__subtitle").on("click",function(e){$(this).parents(".profile-accordeon").hasClass("active")?$(".profile-accordeon").removeClass("active").find(".profile-tab").slideUp():($(".profile-accordeon").removeClass("active").find(".profile-tab").slideUp(),$(this).parents(".profile-accordeon").addClass("active").find(".profile-tab").slideDown())}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".form-btn").on("click",function(e){e.preventDefault(),$(".main-form").toggleClass("active")}),$(document).on("click",function(e){var t=$(".main-form");t.is(e.target)||0!==t.has(e.target).length||$(".form-btn").is(e.target)||$(".main-form").removeClass("active")}),$(".header-bell__top").on("click",function(){$(".header-bell__drop").toggleClass("active"),$(".header-drop").removeClass("active")}),$(document).on("click",function(e){var t=$(".header-user");t.is(e.target)||0!==t.has(e.target).length||$(".header-drop").removeClass("active")}),$(document).on("click",function(e){var t=$(".header-bell");t.is(e.target)||0!==t.has(e.target).length||$(".header-bell__drop").removeClass("active")}),$(".header-user__top").on("click",function(){$(".header-bell__drop").removeClass("active"),$(".header-drop").toggleClass("active"),$(window).width()<=1e3&&$(".personalArea-sidebar").length&&$(".personalArea-sidebar").toggleClass("active")}),0==!$(".datepicker").length&&$(".datepicker").datepicker({dateFormat:"dd.mm.yy",language:"ru",locale:"ru",changeMonth:!0,changeYear:!0,changeDay:!0,showButtonPanel:!1,monthNames:["Январь","Февраль","Март","Апрель","Май","Июнь","Июль","Август","Сентябрь","Октябрь","Ноябрь","Декабрь"],dayNamesMin:["Вс","Пн","Вт","Ср","Чт","Пт","Сб"],onClose:function(e,t){var a=$("#ui-datepicker-div .ui-datepicker-month :selected").val(),o=$("#ui-datepicker-div .ui-datepicker-year :selected").val();$(this).val($.datepicker.formatDate("dd.mm.yy",new Date(o,a,t.selectedDay)))}},$.datepicker.regional.ru),$(window).resize(function(){0==!$(".datepicker").length&&$(".datepicker").datepicker("hide")}),$(".private-btn").on("click",function(e){e.preventDefault(),$(".lkCard").slideUp(0),$(".score .private").slideToggle(200)}),$(".card-btn").on("click",function(e){e.preventDefault(),$(".score .private").slideUp(0),$(".lkCard").slideToggle(200)}),$(".bid-btn").on("click",function(e){e.preventDefault(),$(".register-bid").slideToggle(200)}),$("#statistics1").length){var e=new ProgressBar.Circle(statistics1,{color:"#fff",strokeWidth:4,trailWidth:4,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#F99422",width:4},to:{color:"#F99422",width:4},step:function(e,t){t.path.setAttribute("stroke",e.color),t.path.setAttribute("stroke-width",e.width);var a=Math.round(t.value()*$("#statistics1-1").text());0===a?t.setText(a+"<b>Рублей</b>"):t.setText(a+"<span>Год</span>")}});e.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',e.text.style.fontSize="34px",e.animate($("#procent-1").text(),{duration:2200})}if($("#statistics2").length){var t=new ProgressBar.Circle(statistics2,{color:"#fff",strokeWidth:4,trailWidth:4,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#F99422",width:4},to:{color:"#F99422",width:4},step:function(e,t){t.path.setAttribute("stroke",e.color),t.path.setAttribute("stroke-width",e.width);var a=Math.round(t.value()*$("#statistics2-2").text());0===a?t.setText(a+"<b>Рублей</b>"):t.setText(a)}});t.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',t.text.style.fontSize="34px",t.animate($("#procent-2").text(),{duration:2200})}if($("#statistics3").length){var a=new ProgressBar.Circle(statistics3,{color:"#fff",strokeWidth:4,trailWidth:4,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#F99422",width:4},to:{color:"#F99422",width:4},step:function(e,t){t.path.setAttribute("stroke",e.color),t.path.setAttribute("stroke-width",e.width);var a=Math.round(t.value()*$("#statistics3-3").text());0===a?t.setText(a+"<b>Рублей</b>"):t.setText(a+"<span>Рублей</span>")}});a.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',a.text.style.fontSize="28px",a.animate($("#procent-3").text(),{duration:2200})}if($("#statistics4").length){var o=new ProgressBar.Circle(statistics4,{color:"#fff",strokeWidth:4,trailWidth:4,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#F99422",width:4},to:{color:"#F99422",width:4},step:function(e,t){t.path.setAttribute("stroke",e.color),t.path.setAttribute("stroke-width",e.width);var a=Math.round(t.value()*$("#statistics4-4").text());0===a?t.setText(a+"<b>Рублей</b>"):t.setText(a+"<b>%</b>")}});o.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',o.text.style.fontSize="34px",o.animate($("#procent-4").text(),{duration:2200})}if($("#statistics5").length){var i=new ProgressBar.Circle(statistics5,{color:"#fff",strokeWidth:4,trailWidth:4,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#fff",width:4},to:{color:"#F99422",width:4},step:function(e,t){t.path.setAttribute("stroke",e.color),t.path.setAttribute("stroke-width",e.width);var a=Math.round(t.value()*$("#statistics5-5").text());t.setText(a+"<b>Рублей</b>")}});i.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',i.text.style.fontSize="34px",i.animate($("#procent-5").text(),{duration:2200})}var r=$(".modal");if($(".button-modal").on("click",function(e){e.preventDefault();var t=$(this).attr("href");$(t).addClass("open"),$(".modal-overlay").addClass("open-overlay"),$("html,body").addClass("scroll-hidden")}),$(".modal-close, .modal-overlay").on("click",function(){$(r).removeClass("open"),$(".modal-overlay").removeClass("open-overlay"),$("html,body").removeClass("scroll-hidden")}),$(".drop-buttons").on("click",function(e){e.preventDefault(),$(this).hasClass("active")?$(".drop-buttons").removeClass("active"):($(".drop-buttons").removeClass("active"),$(this).addClass("active")),$(this).hasClass("main-btn")?($(".modal-col__drop-1").slideToggle(200),$(".modal-col__drop-2").slideUp(200)):($(".modal-col__drop-1").slideUp(200),$(".modal-col__drop-2").slideToggle(200))}),$("#slider1").length&&(noUiSlider.create(slider1,{start:500,step:100,animate:!1,connect:"lower",range:{min:500,max:5e5},decimals:0}),slider1.noUiSlider.on("update",function(e,t){slider1Value.innerHTML=(e[t]/100*100).toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g,","),e[t]<1e4?(cashback.innerHTML=(e[t]/100*10).toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g,","),percent.innerHTML=10):e[t]>=1e4&&e[t]<5e4?(cashback.innerHTML=(e[t]/100*20).toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g,","),percent.innerHTML=20):e[t]>=5e4&&e[t]<1e5?(cashback.innerHTML=(e[t]/100*30).toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g,","),percent.innerHTML=30):e[t]>=1e5&&(cashback.innerHTML=(e[t]/100*40).toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g,","),percent.innerHTML=40)})),$("input[name=tel]").mask("+9(999) 999-99-99"),$(".input-card").attr("type","text").mask("9999 9999 9999 9999",{reverse:!0}),$(".input-valid").attr("type","text").mask("99/99",{reverse:!0}),$(".input-CVC").attr("type","text").mask("999",{reverse:!0}),$(".select").on("click",function(e){if($(this).hasClass("active")){var t=e.target,a=$(this).find(".select-text"),o=$(this).find(".select-value");"LI"==t.tagName?($(a).text($(t).text()),$(o).val($(t).attr("data-value"))):"A"==t.tagName&&($(a).html($(t).html()),$(o).val($(t).attr("data-value"))),$(this).removeClass("active")}else $(".select").removeClass("active"),$(this).addClass("active")}),$(document).on("click",function(e){var t=$(".select");t.is(e.target)||0!==t.has(e.target).length||$(".select").removeClass("active")}),$(".blog-filter").length){var s=$(".grid").isotope({itemSelector:".blog-col",masonry:{itemSelector:".blog-col",columnWidth:".persent-size",percentPosition:!0},getSortData:{category:"[data-filter]"}}),n={numberGreaterThan50:function(){var e=$(this).find(".number").text();return parseInt(e,10)>50},ium:function(){return $(this).find(".name").text().match(/ium$/)}},l=s.find(".blog-col");s.addClass("is-showing-items").isotope("revealItemElements",l),$(".blog-filter").on("click","li",function(){var e=$(this).attr("data-filter");e=n[e]||e,$(".grid").isotope({filter:e})}),$(".blog-filter").each(function(e,t){var a=$(t);a.on("click","li",function(){a.find(".active").removeClass("active"),$(this).addClass("active")})})}$(".mode-btn").on("click",function(){$("body").toggleClass("white-mode")})});