...
function menuOpen(e){"click"==e.type&&header.classList.toggle("header-active"),items.classList.toggle("active")}function forRemove(e){for(var t=0;t<e.length;t++)e[t].classList.remove("active")}var swiper=new Swiper(".main-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,effect:"fade",fadeEffect:{crossFade:!0},pagination:{el:".main .swiper-pagination",clickable:!0}});if(document.getElementsByClassName("header-bar").length){var bar=document.querySelector(".header-bar"),header=document.querySelector(".header"),items=document.querySelector(".items");bar.addEventListener("click",menuOpen)}if(document.getElementsByClassName("course-accordion").length){var acc=document.getElementsByClassName("course-accordion"),i;for(i=0;i<acc.length;i++)acc[i].onclick=function(){var e=this.nextElementSibling,t=document.getElementsByClassName("course-panel"),a=(document.getElementsByClassName("course-accordion"),document.getElementsByClassName("course-accordion active"));if(e.style.maxHeight)e.style.maxHeight=null,this.classList.remove("active");else{for(var s=0;s<a.length;s++)a[s].classList.remove("active");for(var l=0;l<t.length;l++)this.classList.remove("active"),t[l].style.maxHeight=null;e.style.maxHeight=e.scrollHeight+"px",this.classList.add("active")}}}if(document.getElementsByClassName("tabbed").length){var tabsWrap=document.querySelector(".tabs-list"),tabsItem=document.getElementsByClassName("tabs-item"),tabbed=document.getElementsByClassName("tabbed");tabsWrap.addEventListener("click",function(e){var t=e.target;"LI"==t.tagName&&(forRemove(tabsItem),forRemove(tabbed),t.classList.add("active"),document.getElementById(t.getAttribute("data-tabs")).classList.add("active"))})}if(document.getElementsByClassName("order-type").length)for(var order=document.getElementsByClassName("order-wrap"),i=0;i<order.length;i++)order[i].addEventListener("click",function(e){e.preventDefault(),order[0].classList.remove("active"),order[1].classList.remove("active"),this.classList.add("active");var t=this.getAttribute("id");document.getElementsByClassName("order-item")[0].classList.remove("active"),"type-2"==t&&document.getElementsByClassName("order-item")[0].classList.add("active")});if(document.getElementsByClassName("modal").length){for(var overlay=document.getElementById("overlay"),modal=document.getElementsByClassName("modal"),button=document.getElementsByClassName("button-modal"),close=document.getElementsByClassName("modal-close"),i=0;i<button.length;i++)button[i].addEventListener("click",function(e){e.preventDefault();var t=this.getAttribute("href"),a=document.getElementById(t);a.classList.add("open-modal"),overlay.classList.add("open-overlay"),overlay.addEventListener("click",function(){a.classList.remove("open-modal"),overlay.classList.remove("open-overlay")})});for(var j=0;j<close.length;j++)close[j].addEventListener("click",function(e){e.preventDefault(),document.getElementsByClassName("open-modal")[0].classList.remove("open-modal"),overlay.classList.remove("open-overlay")})}