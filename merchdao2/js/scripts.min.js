...
var swiper=new Swiper(".category-slider",{slidesPerView:3,spaceBetween:23,pagination:{el:".category .swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},500:{slidesPerView:2},769:{slidesPerView:3}}}),swiper=new Swiper(".collections-slider",{slidesPerView:1,navigation:{nextEl:".collections .swiper-button-next",prevEl:".collections .swiper-button-prev"}}),swiper=new Swiper(".collectibles-slider",{slidesPerView:"auto",centeredSlides:!0,loop:!0,pagination:{el:".collectibles .swiper-pagination",clickable:!0}}),swiper=new Swiper(".card-slider",{slidesPerView:1,pagination:{el:".card-slider .swiper-pagination",clickable:!0}});document.querySelector(".header-bar").addEventListener("click",function(){document.querySelector(".header").classList.toggle("header-active")});