...
var swiper=new Swiper(".features-slider",{slidesPerView:3,watchSlidesVisibility:!0,watchOverflow:!0,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},600:{slidesPerView:2},870:{slidesPerView:3}}}),swiper=new Swiper(".steps-slider",{slidesPerView:4,watchSlidesVisibility:!0,watchOverflow:!0,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},500:{slidesPerView:2},769:{slidesPerView:3},970:{slidesPerView:4}}}),swiper=new Swiper(".toBook-slider",{slidesPerView:3,watchSlidesVisibility:!0,watchOverflow:!0,pagination:{el:".swiper-pagination",clickable:!0},breakpoints:{10:{slidesPerView:1},600:{slidesPerView:2},870:{slidesPerView:3}}}),swiper=new Swiper(".testimonials-slider",{slidesPerView:1,watchSlidesVisibility:!0,watchOverflow:!0,pagination:{el:".swiper-pagination",clickable:!0}});$(document).ready(function(){$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".drop-text").on("click",function(e){e.preventDefault(),$(window).width()<=767&&$(this).parents(".drop").toggleClass("active").find(".drop-list").slideToggle()}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var a=$(e.target).attr("href");$(a).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".select").on("click",function(e){if(!$(this).hasClass("select-hid"))if($(this).hasClass("active")){var a=e.target,i=$(this).find(".select-text"),t=$(this).find(".select-value");"LI"==a.tagName?($(i).text($(a).text()),$(t).val($(a).text())):"A"==a.tagName&&(e.preventDefault(),$(i).html($(a).html()),$(t).val($(a).text())),$(this).removeClass("active")}else $(".select").removeClass("active"),$(this).addClass("active")}),$(document).on("click",function(e){var a=$(".select");a.is(e.target)||0!==a.has(e.target).length||$(".select").removeClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".modal-btn").on("click",function(e){e.preventDefault();var a=$(this).attr("href");$(a).addClass("modal-open"),$(".modal-bg").addClass("modal-open")}),$(".modal-bg, .formModal .close-ico").on("click",function(){$(".modal-bg, .formModal").removeClass("modal-open"),0!=$(".catalog-sidebar").length&&$(".catalog-sidebar").removeClass("active")});var e=$(".select-second").html();if($(".pricing-wrap-1 .select-main,.pricing-wrap-1 .select-second,.pricing-wrap-2 .select-main,.pricing-wrap-2 .select-second").on("change",function(){"product-1"==$(this).val()&&$(this).parents(".pricing-wrap").removeClass("range-notActive")}),$(".pricing-selects .select-main").on("change",function(){var a=this.value,i=$(this).parents(".pricing-selects").find(".select-second");$(i).html(e),$(i).find("option[value="+a+"]").remove()}),$(".pricing-selects .select-second").on("change",function(){if(!$(this).parents(".pricing-wrap").hasClass("priceChange")){var e=$(this).parents(".pricing-wrap"),a=$(e).find(".pricing-price b"),i=parseInt($(a).text());$(a).text(i+19),$(e).addClass("priceChange")}}),0!=$("#range-1").length){var a=($("#range-1-text"),parseInt($("#range-1").parents(".pricing-range").attr("data-step"))),i=parseInt($("#range-1-text").text());$("#range-1").slider({range:"min",value:1e4,min:1e4,step:a,max:1e5,slide:function(e,t){$("#range-1").parents(".pricing-wrap").hasClass("priceChange")?$("#range-1-text").text(i+19+(t.value-1e4)/a*10):$("#range-1-text").text(i+(t.value-1e4)/a*10),$(this).parents(".pricing-range").find("p").find("span").text(t.value.toLocaleString())}}),$(this).parents(".pricing-range").find("p").find("span").text($("#range-1").slider("value"))}if(0!=$("#range-2").length){var t=$("#range-2-text"),s=parseInt($("#range-2").parents(".pricing-range").attr("data-step")),n=parseInt($(t).text());$("#range-2").slider({range:"min",value:1e4,min:1e4,step:s,max:1e5,slide:function(e,i){$("#range-2-text").text(n+(i.value-1e4)/a*10),$(this).parents(".pricing-range").find("p").find("span").text(i.value.toLocaleString())}}),$(this).parents(".pricing-range").find("p").find("span").text($("#range-2").slider("value"))}0!=$(".select-second").length&&$(".select-second").select2({placeholder:"Additional products (optional)"})});